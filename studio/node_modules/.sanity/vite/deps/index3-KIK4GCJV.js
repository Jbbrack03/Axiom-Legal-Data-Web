...
import "./chunk-4PU5SJ4D.js";
import "./chunk-QF6NTPRQ.js";
import {
  require_jsx_runtime
...
function PaneRouterProvider(props) {
  ...
  let t8;
  const t9 = routerPaneGroups[groupIndex] ? routerPaneGroups[groupIndex].length > 1 : false, t10 = routerPaneGroups[groupIndex] ? routerPaneGroups[groupIndex].length : 0, t11 = flatIndex ? BackLink : void 0;
  let t12, t13;
  ...
  const ctx = t8;
  let t18;
  return $[57] !== children || $[58] !== ctx ? (t18 = (0, import_jsx_runtime.jsx)(PaneRouterContext.Provider, { value: ctx, children }), $[57] = children, $[58] = ctx, $[59] = t18) : t18 = $[59], t18;
}
...
function useRouterPanesStream() {
  const $ = (0, import_react_compiler_runtime.c)(6), [routerStateSubject] = (0, import_react.useState)(_temp$5);
  let t0, t1;
  ...
  }, t3 = [routerState, routerStateSubject], $[2] = routerState, $[3] = routerStateSubject, $[4] = t2, $[5] = t3) : (t2 = $[4], t3 = $[5]), (0, import_react.useEffect)(t2, t3), routerPanes$;
}
...
function useResolvedPanes() {
  const $ = (0, import_react_compiler_runtime.c)(6), [error, setError] = (0, import_react.useState)();
  if (error)
    throw error;
  const {
    structureContext,
  ...
  }, t2 = [rootPaneNode, routerPanesStream, structureContext], $[1] = rootPaneNode, $[2] = routerPanesStream, $[3] = structureContext, $[4] = t1, $[5] = t2) : (t1 = $[4], t2 = $[5]), (0, import_react.useEffect)(t1, t2), data;
}
...
function StructureError(t0) {
  ...
  const {
    ...
    t
  } = useTranslation(structureLocaleNamespace), stack = (cause == null ? void 0 : cause.stack) || error.stack, showStack = stack && !(cause instanceof SerializeError) && !error.message.includes("Module build failed:");
  let t1;
  ...
  let t3;
  $[4] !== t2 ? (t3 = (0, import_jsx_runtime.jsx)(Heading, { as: "h2", children: t2 }), $[4] = t2, $[5] = t3) : t3 = $[5];
  let t4;
  $[6] !== path || $[7] !== t ? (t4 = path.length > 0 && (0, import_jsx_runtime.jsxs)(Stack, { space: 2, children: [
  ...
  let t6;
  $[11] !== t5 ? (t6 = (0, import_jsx_runtime.jsx)(Text, { size: 1, weight: "medium", children: t5 }), $[11] = t5, $[12] = t6) : t6 = $[12];
  let t7;
  ...
  let t8;
  $[17] !== t7 ? (t8 = (0, import_jsx_runtime.jsx)(Code, { children: t7 }), $[17] = t7, $[18] = t8) : t8 = $[18];
  let t9;
  $[19] !== t6 || $[20] !== t8 ? (t9 = (0, import_jsx_runtime.jsxs)(Stack, { marginTop: 4, space: 2, children: [
    t6,
    t8
  ] }), $[19] = t6, $[20] = t8, $[21] = t9) : t9 = $[21];
  let t10;
  $[22] !== helpId || $[23] !== t ? (t10 = helpId && (0, import_jsx_runtime.jsx)(Box, { marginTop: 4, children: (0, import_jsx_runtime.jsx)(Text, { children: (0, import_jsx_runtime.jsx)("a", { href: generateHelpUrl(helpId), rel: "noopener noreferrer", target: "_blank", children: t("structure-error.docs-link.text") }) }) }), $[22] = helpId, $[23] = t, $[24] = t10) : t10 = $[24];
  let t11;
  $[25] !== t ? (t11 = t("structure-error.reload-button.text"), $[25] = t, $[26] = t11) : t11 = $[26];
  let t12;
  $[27] !== t11 ? (t12 = (0, import_jsx_runtime.jsx)(Box, { marginTop: 4, children: (0, import_jsx_runtime.jsx)(Button, { text: t11, icon: SyncIcon, tone: "primary", onClick: handleReload }) }), $[27] = t11, $[28] = t12) : t12 = $[28];
  let t13;
  $[29] !== t10 || $[30] !== t12 || $[31] !== t4 || $[32] !== t9 ? (t13 = (0, import_jsx_runtime.jsxs)(Card, { marginTop: 4, padding: 4, radius: 2, overflow: "auto", shadow: 1, tone: "inherit", children: [
    t4,
    t9,
    t10,
    t12
  ...
  let t14;
  return $[34] !== t13 || $[35] !== t3 ? (t14 = (0, import_jsx_runtime.jsx)(Card, { height: "fill", overflow: "auto", padding: 4, sizing: "border", tone: "critical", children: (0, import_jsx_runtime.jsxs)(Container, { children: [
    t3,
    t13
...
function UnknownPane(props) {
  ...
  let t0;
  $[0] !== pane ? (t0 = isRecord$4(pane) && pane.type || null, $[0] = pane, $[1] = t0) : t0 = $[1];
  const type = t0, {
    t
  ...
  let t2;
  $[4] !== t1 ? (t2 = (0, import_jsx_runtime.jsx)(PaneHeader$1, { title: t1 }), $[4] = t1, $[5] = t2) : t2 = $[5];
  let t3;
  $[6] !== t || $[7] !== type ? (t3 = (0, import_jsx_runtime.jsx)(PaneContent, { children: (0, import_jsx_runtime.jsx)(Box, { padding: 4, children: typeof type == "string" ? (0, import_jsx_runtime.jsx)(Text, { as: "p", muted: true, children: (0, import_jsx_runtime.jsx)(Translate, { t, i18nKey: "panes.unknown-pane-type.unknown-type.text", values: {
    type
  } }) }) : (0, import_jsx_runtime.jsx)(Text, { as: "p", muted: true, children: (0, import_jsx_runtime.jsx)(Translate, { t, i18nKey: "panes.unknown-pane-type.missing-type.text" }) }) }) }), $[6] = t, $[7] = type, $[8] = t3) : t3 = $[8];
  let t4;
  return $[9] !== isSelected || $[10] !== paneKey || $[11] !== t2 || $[12] !== t3 ? (t4 = (0, import_jsx_runtime.jsxs)(Pane, { id: paneKey, selected: isSelected, children: [
    t2,
    t3
  ] }), $[9] = isSelected, $[10] = paneKey, $[11] = t2, $[12] = t3, $[13] = t4) : t4 = $[13], t4;
}
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-WOTIJ5FO.js")),
  document: (0, import_react.lazy)(() => import("./pane-DNX2V2HF.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-DNX2V2HF.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-F4VSOEXQ.js"))
};
var StructureToolPane = (0, import_react.memo)(function(props) {
  ...
  let t0;
  $[0] !== paneKey || $[1] !== path || $[2] !== selected ? (t0 = (0, import_jsx_runtime.jsx)(LoadingPane, { paneKey, path, selected }), $[0] = paneKey, $[1] = path, $[2] = selected, $[3] = t0) : t0 = $[3];
  const t1 = childItemId || "";
  let t2;
  $[4] !== PaneComponent || $[5] !== active || $[6] !== index || $[7] !== itemId || $[8] !== pane || $[9] !== paneKey || $[10] !== selected || $[11] !== t1 ? (t2 = (0, import_jsx_runtime.jsx)(PaneComponent, { childItemId: t1, index, itemId, isActive: active, isSelected: selected, paneKey, pane }), $[4] = PaneComponent, $[5] = active, $[6] = index, $[7] = itemId, $[8] = pane, $[9] = paneKey, $[10] = selected, $[11] = t1, $[12] = t2) : t2 = $[12];
  let t3;
  $[13] !== t0 || $[14] !== t2 ? (t3 = (0, import_jsx_runtime.jsx)(import_react.Suspense, { fallback: t0, children: t2 }), $[13] = t0, $[14] = t2, $[15] = t3) : t3 = $[15];
  let t4;
  return $[16] !== groupIndex || $[17] !== index || $[18] !== params || $[19] !== payload || $[20] !== siblingIndex || $[21] !== t3 ? (t4 = (0, import_jsx_runtime.jsx)(PaneRouterProvider, { flatIndex: index, index: groupIndex, params, payload, siblingIndex, children: t3 }), $[16] = groupIndex, $[17] = index, $[18] = params, $[19] = payload, $[20] = siblingIndex, $[21] = t3, $[22] = t4) : t4 = $[22], t4;
}, ({
  params: prevParams = {},
  ...
  if (!(0, import_isEqual.default)(prevParams, nextParams) || !(0, import_isEqual.default)(prevPayload, nextPayload)) return false;
...
function NoDocumentTypesScreen() {
  ...
  let t0;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime.jsx)(Box, { children: (0, import_jsx_runtime.jsx)(Text, { size: 1, children: (0, import_jsx_runtime.jsx)(WarningOutlineIcon, {}) }) }), $[0] = t0) : t0 = $[0];
  let t1;
...
var DocumentTitle = (props) => {
  const $ = (0, import_react_compiler_runtime.c)(7), {
    ...
    t
  } = useTranslation(structureLocaleNamespace), isNewDocument = !(editState == null ? void 0 : editState.published) && !(editState == null ? void 0 : editState.draft), documentValue = (editState == null ? void 0 : editState.version) || (editState == null ? void 0 : editState.draft) || (editState == null ? void 0 : editState.published), schemaType = schema.get(documentType), {
    value,
...
var StructureTitle = (props) => {
  ...
  if (isLoadingPane(lastPane)) {
    let t02;
    return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime.jsx)(PassthroughTitle, {}), $[0] = t02) : t02 = $[0], t02;
  }
...
function useConstructDocumentTitle(activeTitle) {
  const $ = (0, import_react_compiler_runtime.c)(3), structureToolBaseTitle = useStructureTool().structureContext.title;
  let t0;
...
var StructureTool = (0, import_react.memo)(function(t0) {
  var _a;
  const $ = (0, import_react_compiler_runtime.c)(31), {
    onPaneChange
  } = t0, {
    push: pushToast
  ...
  }, t5 = [onPaneChange, resolvedPanes], $[4] = onPaneChange, $[5] = resolvedPanes, $[6] = t4, $[7] = t5) : (t4 = $[6], t5 = $[7]), (0, import_react.useEffect)(t4, t5);
  let t6, t7;
  if ($[8] !== pushToast ? (t6 = () => {
  ...
  }, t7 = [pushToast], $[8] = pushToast, $[9] = t6, $[10] = t7) : (t6 = $[9], t7 = $[10]), (0, import_react.useEffect)(t6, t7), !((_a = schema._original) == null ? void 0 : _a.types.some(_isCustomDocumentTypeDefinition))) {
    let t82;
    return $[11] === Symbol.for("react.memo_cache_sentinel") ? (t82 = (0, import_jsx_runtime.jsx)(NoDocumentTypesScreen, {}), $[11] = t82) : t82 = $[11], t82;
  }
  ...
  let t12;
  $[14] !== isResolvingIntent || $[15] !== paneDataItems.length ? (t12 = paneDataItems.length <= 1 && isResolvingIntent && (0, import_jsx_runtime.jsx)(LoadingPane, { paneKey: "intent-resolver" }), $[14] = isResolvingIntent, $[15] = paneDataItems.length, $[16] = t12) : t12 = $[16];
  let t13;
  $[17] !== handleRootCollapse || $[18] !== handleRootExpand || $[19] !== media[1] || $[20] !== t11 || $[21] !== t12 || $[22] !== t9 ? (t13 = (0, import_jsx_runtime.jsxs)(StyledPaneLayout, { flex: 1, height: t9, minWidth: t10, onCollapse: handleRootCollapse, onExpand: handleRootExpand, children: [
    t11,
    t12
  ] }), $[17] = handleRootCollapse, $[18] = handleRootExpand, $[19] = media[1], $[20] = t11, $[21] = t12, $[22] = t9, $[23] = t13) : t13 = $[23];
  let t14;
  $[24] !== resolvedPanes ? (t14 = (0, import_jsx_runtime.jsx)(StructureTitle, { resolvedPanes }), $[24] = resolvedPanes, $[25] = t14) : t14 = $[25];
  let t15;
  $[26] === Symbol.for("react.memo_cache_sentinel") ? (t15 = (0, import_jsx_runtime.jsx)("div", { "data-portal": "", ref: setPortalElement }), $[26] = t15) : t15 = $[26];
  let t16;
  return $[27] !== t13 || $[28] !== t14 || $[29] !== t8 ? (t16 = (0, import_jsx_runtime.jsxs)(PortalProvider, { element: t8, children: [
    t13,
    t14,
    t15
...
function _temp2$1(t0) {
  ...
  return (0, import_jsx_runtime.jsx)(import_react.Fragment, { children: pane === LOADING_PANE ? (0, import_jsx_runtime.jsx)(LoadingPane, { paneKey, path, selected }) : (0, import_jsx_runtime.jsx)(StructureToolPane, { active, groupIndex, index: paneIndex, pane, childItemId, itemId, paneKey, params: paneParams, payload, path, selected, siblingIndex }) }, `${pane === LOADING_PANE ? "loading" : pane.type}-${paneIndex}`);
}
function StructureToolBoundary(t0) {
  ...
  let t3;
  $[2] === Symbol.for("react.memo_cache_sentinel") ? (t3 = [], $[2] = t3) : t3 = $[2], (0, import_react.useEffect)(_temp2, t3);
  let t4;
  ...
  let t7, t8;
  $[6] === Symbol.for("react.memo_cache_sentinel") ? (t7 = (0, import_jsx_runtime.jsx)(StructureTool, { onPaneChange: setActivePanes }), t8 = (0, import_jsx_runtime.jsx)(IntentResolver, {}), $[6] = t7, $[7] = t8) : (t7 = $[6], t8 = $[7]);
  let t9;
...
//# sourceMappingURL=index3-KIK4GCJV.js.map
