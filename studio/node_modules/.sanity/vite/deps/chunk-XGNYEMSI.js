...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources6-JYNYNPSR.js")
});
...
var DocumentBuilder = class _DocumentBuilder {
  ...
  serialize({
    ...
    const views2 = (this.spec.views && this.spec.views.length > 0 ? this.spec.views : [form()]).map((item, i) => maybeSerializeView(item, i, path)), viewIds = views2.map((view) => view.id), dupes = (0, import_uniq.default)(viewIds.filter((viewId, i) => viewIds.includes(viewId, i + 1)));
    if (dupes.length > 0)
...
var InitialValueTemplateItemBuilder = class _InitialValueTemplateItemBuilder {
  ...
  serialize({
    ...
    const template = templates.find((t2) => t2.id === spec.templateId);
    if (!template)
      throw new SerializeError("template id (`templateId`) is required for initial value template item nodes", path, spec.id, hint).withHelpUrl(HELP_URL.ID_REQUIRED);
    return {
      id: spec.id,
...
function menuItemsFromInitialValueTemplateItems(context, templateItems) {
  ...
  return templateItems.map((item) => {
    const template = templates.find((t2) => t2.id === item.templateId), title = item.title || (template == null ? void 0 : template.title) || "Create", params = {};
    ...
    let builder = new MenuItemBuilder(context).title(title).icon(template && template.icon || (schemaType == null ? void 0 : schemaType.icon) || AddIcon).intent({
      type: "create",
      params: intentParams
    });
...
var GenericListBuilder = class {
  constructor() {
    ...
    __publicField(this, "initialValueTemplatesSpecified", false);
...
var createDocumentChildResolverForItem = (context) => (itemId, options) => {
  var _a;
  const parentItem = options.parent, template = ((_a = options.params) == null ? void 0 : _a.template) ? context.templates.find((tpl) => tpl.id === options.params.template) : void 0, type = template ? template.schemaType : parentItem.schemaTypeName || resolveTypeForDocument(context.getClient, itemId);
...
var DocumentListBuilder = class _DocumentListBuilder extends GenericListBuilder {
  ...
  constructor(_context, spec) {
    super(), this._context = _context, this.spec = spec || {}, this.initialValueTemplatesSpecified = !!(spec == null ? void 0 : spec.initialValueTemplates);
  }
  /** Set API version
...
var ListBuilder = class _ListBuilder extends GenericListBuilder {
  ...
  serialize(options = {
    ...
    const path = (options.path || []).concat(id), serializedItems = items.map((item, index) => maybeSerializeListItem(item, index, path)), dupes = serializedItems.filter((val, i) => (0, import_find.default)(serializedItems, {
      id: val.id
    }, i + 1));
    if (dupes.length > 0) {
...
function StructureToolProvider({
  ...
  const [layoutCollapsed, setLayoutCollapsed] = (0, import_react.useState)(false), source = useSource(), configContext = useConfigContextFromSource(source), documentStore = useDocumentStore(), {
    perspectiveStack
  } = usePerspective(), S = (0, import_react.useMemo)(() => createStructureBuilder({
    defaultDocumentNode,
    source,
    perspectiveStack
  }), [defaultDocumentNode, source, perspectiveStack]), rootPaneNode = (0, import_react.useMemo)(() => resolveStructure ? resolveStructure(S, {
    ...configContext,
    documentStore,
    perspectiveStack
  }) : S.defaults(), [resolveStructure, S, configContext, documentStore, perspectiveStack]), features = (0, import_react.useMemo)(() => ({
    backButton: layoutCollapsed,
    resizablePanes: !layoutCollapsed,
    reviewChanges: !layoutCollapsed,
    splitPanes: !layoutCollapsed,
    splitViews: !layoutCollapsed
  }), [layoutCollapsed]), structureTool2 = (0, import_react.useMemo)(() => ({
    features,
    layoutCollapsed,
    setLayoutCollapsed,
    rootPaneNode,
...
var import_toPairs = __toESM(require_toPairs(), 1);
...
var s = class {
  constructor(l2, s2 = {}) {
    ...
    this.elements = void 0, this.defaults = { vertical: true, horizontal: true, debug: true }, this.options = void 0, this.paused = false, this.logger = void 0, this.handleScroll = async function(t2) {
      ...
      const o2 = c2.getScrollContainer(t2.currentTarget);
      await e(), c2.mirrorScrollPositions(r(o2), o2);
...
// node_modules/sanity/lib/_chunks-es/pane.mjs
var import_noop = __toESM(require_noop(), 1);
...
function DocTitle(props) {
  ...
  const {
    error,
    value
  } = useDocumentPreview(t1);
  if (!schemaType) {
    let t222;
    $[6] !== documentValue._type || $[7] !== t2 ? (t222 = t2("doc-title.unknown-schema-type.text", {
      schemaType: documentValue._type
    }), $[6] = documentValue._type, $[7] = t2, $[8] = t222) : t222 = $[8];
    let t32;
    return $[9] !== t222 ? (t32 = (0, import_jsx_runtime2.jsx)("code", { children: t222 }), $[9] = t222, $[10] = t32) : t32 = $[10], t32;
  }
  if (error) {
    let t222;
    $[11] !== error.message || $[12] !== t2 ? (t222 = t2("doc-title.error.text", {
      errorMessage: error.message
    }), $[11] = error.message, $[12] = t2, $[13] = t222) : t222 = $[13];
    let t32;
    return $[14] !== t222 ? (t32 = (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: t222 }), $[14] = t222, $[15] = t32) : t32 = $[15], t32;
  }
  let t22;
  $[16] !== t2 || $[17] !== (value == null ? void 0 : value.title) ? (t22 = (value == null ? void 0 : value.title) || (0, import_jsx_runtime2.jsx)("span", { style: {
    color: "var(--card-muted-fg-color)"
  }, children: t2("doc-title.fallback.text") }), $[16] = t2, $[17] = value == null ? void 0 : value.title, $[18] = t22) : t22 = $[18];
  let t3;
  return $[19] !== t22 ? (t3 = (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: t22 }), $[19] = t22, $[20] = t3) : t3 = $[20], t3;
}
...
var OtherReferenceCount = (props) => {
  ...
  let t3;
  $[7] === Symbol.for("react.memo_cache_sentinel") ? (t3 = (0, import_jsx_runtime2.jsx)(Text, { size: 1, muted: true, children: (0, import_jsx_runtime2.jsx)(InfoOutlineIcon, {}) }), $[7] = t3) : t3 = $[7];
  let t4;
...
function PaneItemPreview(props) {
  ...
  let t0, t1;
  $[0] !== perspectiveStack || $[1] !== props.documentPreviewStore || $[2] !== schemaType || $[3] !== value._id ? (t1 = getPreviewStateObservable$1(props.documentPreviewStore, schemaType, value._id, perspectiveStack), $[0] = perspectiveStack, $[1] = props.documentPreviewStore, $[2] = schemaType, $[3] = value._id, $[4] = t1) : t1 = $[4], t0 = t1;
  ...
  let t3;
  $[6] !== isLoading || $[7] !== presence || $[8] !== versionsInfo.draft || $[9] !== versionsInfo.published || $[10] !== versionsInfo.versions ? (t3 = isLoading ? null : (0, import_jsx_runtime2.jsx)(TooltipDelayGroupProvider, { children: (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", gap: 3, children: [
  ...
  const status = t3;
  let t4;
  $[12] !== versionsInfo.draft || $[13] !== versionsInfo.published || $[14] !== versionsInfo.versions ? (t4 = (0, import_jsx_runtime2.jsx)(DocumentStatus, { draft: versionsInfo.draft, published: versionsInfo.published, versions: versionsInfo.versions }), $[12] = versionsInfo.draft, $[13] = versionsInfo.published, $[14] = versionsInfo.versions, $[15] = t4) : t4 = $[15];
  const tooltip = t4;
  let t5;
  ...
  let t6;
  return $[20] !== icon || $[21] !== isLoading || $[22] !== layout || $[23] !== status || $[24] !== t5 || $[25] !== tooltip ? (t6 = (0, import_jsx_runtime2.jsx)(SanityDefaultPreview, { ...t5, isPlaceholder: isLoading, icon, layout, status, tooltip }), $[20] = icon, $[21] = isLoading, $[22] = layout, $[23] = status, $[24] = t5, $[25] = tooltip, $[26] = t6) : t6 = $[26], t6;
}
var BackLink = (0, import_react2.forwardRef)(function(props, ref) {
  ...
  const state2 = t2;
  let t4;
  return $[5] !== props || $[6] !== ref || $[7] !== state2 ? (t4 = (0, import_jsx_runtime2.jsx)(StateLink, { ...props, ref, state: state2 }), $[5] = props, $[6] = ref, $[7] = state2, $[8] = t4) : t4 = $[8], t4;
});
...
var ParameterizedLink = (0, import_react2.forwardRef)(function(props, ref) {
  ...
  const nextState = t0;
  let t7;
  return $[18] !== nextState || $[19] !== ref || $[20] !== rest ? (t7 = (0, import_jsx_runtime2.jsx)(StateLink, { ref, ...rest, state: nextState }), $[18] = nextState, $[19] = ref, $[20] = rest, $[21] = t7) : t7 = $[21], t7;
});
var ReferenceChildLink = (0, import_react2.forwardRef)(function(t0, ref) {
  ...
  const t1 = template == null ? void 0 : template.params;
  let t2;
  ...
  let t5;
  return $[15] !== children || $[16] !== documentId || $[17] !== ref || $[18] !== rest || $[19] !== t1 || $[20] !== t4 ? (t5 = (0, import_jsx_runtime2.jsx)(ChildLink, { ...rest, ref, childId: documentId, childPayload: t1, childParameters: t4, children }), $[15] = children, $[16] = documentId, $[17] = ref, $[18] = rest, $[19] = t1, $[20] = t4, $[21] = t5) : t5 = $[21], t5;
});
...
function ReferencePreviewLink(props) {
  const $ = (0, import_react_compiler_runtime.c)(16), {
    ...
    type,
    value
  } = props, t0 = value == null ? void 0 : value._id;
  let t1;
  ...
  let t2;
  $[2] !== ReferenceChildLink2 || $[3] !== (type == null ? void 0 : type.name) || $[4] !== (value == null ? void 0 : value._id) ? (t2 = function(linkProps) {
    return (0, import_jsx_runtime2.jsx)(ReferenceChildLink2, { documentId: value == null ? void 0 : value._id, documentType: type == null ? void 0 : type.name, parentRefPath: EMPTY_ARRAY$1, ...linkProps });
  }, $[2] = ReferenceChildLink2, $[3] = type == null ? void 0 : type.name, $[4] = value == null ? void 0 : value._id, $[5] = t2) : t2 = $[5];
  const t3 = t2, t4 = type == null ? void 0 : type.icon, t5 = (documentPresence == null ? void 0 : documentPresence.length) > 0 ? documentPresence : EMPTY_ARRAY$1;
  let t6;
...
function ConfirmDeleteDialogBody(t0) {
  const $ = (0, import_react_compiler_runtime.c)(78), {
  ...
  if ((internalReferences == null ? void 0 : internalReferences.totalCount) === 0 && (crossDatasetReferences == null ? void 0 : crossDatasetReferences.totalCount) === 0) {
    let t222;
    $[4] !== documentTitle ? (t222 = {
      DocumentTitle: () => (0, import_jsx_runtime2.jsx)("strong", { children: documentTitle })
    }, $[4] = documentTitle, $[5] = t222) : t222 = $[5];
    let t32;
    return $[6] !== action || $[7] !== t2 || $[8] !== t222 ? (t32 = (0, import_jsx_runtime2.jsx)(Text, { as: "p", size: 1, children: (0, import_jsx_runtime2.jsx)(Translate, { t: t2, i18nKey: "confirm-delete-dialog.confirmation.text", context: action, components: t222 }) }), $[6] = action, $[7] = t2, $[8] = t222, $[9] = t32) : t32 = $[9], t32;
  }
  let T0, T1, T2, t10, t11, t12, t22, t3, t4, t5, t6, t7, t8, t9;
  if ($[10] !== action || $[11] !== crossDatasetReferences || $[12] !== datasetNames || $[13] !== documentTitle || $[14] !== hasUnknownDatasetNames || $[15] !== internalReferences || $[16] !== renderPreviewItem || $[17] !== t2 || $[18] !== toast || $[19] !== totalCount) {
    const normalizedDatasetNames = [...datasetNames, ...hasUnknownDatasetNames ? ["unavailable"] : []], datasetSubtitle = t2("confirm-delete-dialog.cdr-summary.subtitle", {
    ...
    let t132;
    $[34] === Symbol.for("react.memo_cache_sentinel") ? (t132 = (0, import_jsx_runtime2.jsx)(Text, { "aria-hidden": "true", size: 1, children: (0, import_jsx_runtime2.jsx)(WarningOutlineIcon, {}) }), $[34] = t132) : t132 = $[34];
    let t142;
    ...
    $[37] !== totalCount ? (t152 = {
      count: totalCount
    }, $[37] = totalCount, $[38] = t152) : t152 = $[38], $[39] !== t2 || $[40] !== t142 || $[41] !== t152 ? (t11 = (0, import_jsx_runtime2.jsx)(Card, { padding: 3, radius: 2, tone: "caution", flex: "none", children: (0, import_jsx_runtime2.jsxs)(Flex, { children: [
      t132,
      (0, import_jsx_runtime2.jsx)(Box, { flex: 1, marginLeft: 3, children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(Translate, { i18nKey: "confirm-delete-dialog.referring-document-count.text", components: t142, t: t2, values: t152 }) }) })
    ] }) }), $[39] = t2, $[40] = t142, $[41] = t152, $[42] = t11) : t11 = $[42];
    let t162;
    $[43] !== documentTitle ? (t162 = {
      DocumentTitle: () => documentTitle
    }, $[43] = documentTitle, $[44] = t162) : t162 = $[44], $[45] !== action || $[46] !== t2 || $[47] !== t162 ? (t12 = (0, import_jsx_runtime2.jsx)(Box, { flex: "none", children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(Translate, { i18nKey: "confirm-delete-dialog.referring-documents-descriptor.text", t: t2, context: action, components: t162 }) }) }), $[45] = action, $[46] = t2, $[47] = t162, $[48] = t12) : t12 = $[48], T1 = Card, t5 = 2, t6 = 1, t7 = "auto", t8 = 2, T0 = Flex, t22 = "column", $[49] !== internalReferences || $[50] !== renderPreviewItem ? (t3 = internalReferences.totalCount > 0 && (0, import_jsx_runtime2.jsxs)(Stack, { as: "ul", marginBottom: 2, space: 2, "data-testid": "internal-references", children: [
      internalReferences == null ? void 0 : internalReferences.references.map((item_0) => (0, import_jsx_runtime2.jsx)(Box, { as: "li", children: renderPreviewItem(item_0) }, item_0._id)),
    ...
    ] }), $[49] = internalReferences, $[50] = renderPreviewItem, $[51] = t3) : t3 = $[51], t4 = crossDatasetReferences.totalCount > 0 && (0, import_jsx_runtime2.jsxs)(CrossDatasetReferencesDetails, { "data-testid": "cross-dataset-references", style: {
      ...
      (0, import_jsx_runtime2.jsxs)(Box, { overflow: "auto", paddingTop: 2, children: [
        (0, import_jsx_runtime2.jsxs)(Table$1, { children: [
          ...
          (0, import_jsx_runtime2.jsx)("tbody", { children: crossDatasetReferences.references.filter(_temp$q).map((t172, index) => {
            const {
              projectId,
              datasetName,
              documentId
            ...
            return (0, import_jsx_runtime2.jsxs)("tr", { children: [
              ...
              (0, import_jsx_runtime2.jsx)("td", { children: (0, import_jsx_runtime2.jsxs)(DocumentIdFlex, { align: "center", gap: 2, justify: "flex-end", children: [
                (0, import_jsx_runtime2.jsx)(Text, { textOverflow: "ellipsis", size: 1, children: documentId || "unavailable" }),
                documentId && (0, import_jsx_runtime2.jsx)(Button2, { mode: "bleed", icon: CopyIcon, tooltipProps: {
    ...
    ] }), $[10] = action, $[11] = crossDatasetReferences, $[12] = datasetNames, $[13] = documentTitle, $[14] = hasUnknownDatasetNames, $[15] = internalReferences, $[16] = renderPreviewItem, $[17] = t2, $[18] = toast, $[19] = totalCount, $[20] = T0, $[21] = T1, $[22] = T2, $[23] = t10, $[24] = t11, $[25] = t12, $[26] = t22, $[27] = t3, $[28] = t4, $[29] = t5, $[30] = t6, $[31] = t7, $[32] = t8, $[33] = t9;
  } else
    T0 = $[20], T1 = $[21], T2 = $[22], t10 = $[23], t11 = $[24], t12 = $[25], t22 = $[26], t3 = $[27], t4 = $[28], t5 = $[29], t6 = $[30], t7 = $[31], t8 = $[32], t9 = $[33];
  let t13;
  $[52] !== T0 || $[53] !== t22 || $[54] !== t3 || $[55] !== t4 ? (t13 = (0, import_jsx_runtime2.jsxs)(T0, { direction: t22, children: [
    t3,
    t4
  ] }), $[52] = T0, $[53] = t22, $[54] = t3, $[55] = t4, $[56] = t13) : t13 = $[56];
  let t14;
  $[57] !== T1 || $[58] !== t13 || $[59] !== t5 || $[60] !== t6 || $[61] !== t7 || $[62] !== t8 ? (t14 = (0, import_jsx_runtime2.jsx)(T1, { radius: t5, shadow: t6, flex: t7, padding: t8, children: t13 }), $[57] = T1, $[58] = t13, $[59] = t5, $[60] = t6, $[61] = t7, $[62] = t8, $[63] = t14) : t14 = $[63];
  let t15;
  $[64] !== documentTitle ? (t15 = {
    DocumentTitle: () => documentTitle
  }, $[64] = documentTitle, $[65] = t15) : t15 = $[65];
  let t16;
  $[66] !== action || $[67] !== t2 || $[68] !== t15 ? (t16 = (0, import_jsx_runtime2.jsx)(Box, { flex: "none", children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(Translate, { i18nKey: "confirm-delete-dialog.referential-integrity-disclaimer.text", t: t2, context: action, components: t15 }) }) }), $[66] = action, $[67] = t2, $[68] = t15, $[69] = t16) : t16 = $[69];
  let t17;
  return $[70] !== T2 || $[71] !== t10 || $[72] !== t11 || $[73] !== t12 || $[74] !== t14 || $[75] !== t16 || $[76] !== t9 ? (t17 = (0, import_jsx_runtime2.jsxs)(T2, { direction: t9, gap: t10, children: [
    t11,
    t12,
    t14,
    t16
...
function useReferringDocuments(documentId) {
  const $ = (0, import_react_compiler_runtime.c)(24), versionedClient = useClient(DEFAULT_STUDIO_CLIENT_OPTIONS), documentStore = useDocumentStore();
  let t0;
  ...
  let t5;
  $[8] !== (crossDatasetReferences == null ? void 0 : crossDatasetReferences.references) ? (t5 = () => Array.from(new Set(crossDatasetReferences == null ? void 0 : crossDatasetReferences.references.map(_temp$p).filter(Boolean))).sort(), $[8] = crossDatasetReferences == null ? void 0 : crossDatasetReferences.references, $[9] = t5) : t5 = $[9];
  let t6;
  $[10] !== t5 ? (t6 = t5(), $[10] = t5, $[11] = t6) : t6 = $[11];
  const projectIds = t6;
  let t7, t8;
  $[12] !== (crossDatasetReferences == null ? void 0 : crossDatasetReferences.references) ? (t8 = Array.from(new Set(crossDatasetReferences == null ? void 0 : crossDatasetReferences.references.map(_temp2$9).filter(_temp3$2))).sort(), $[12] = crossDatasetReferences == null ? void 0 : crossDatasetReferences.references, $[13] = t8) : t8 = $[13], t7 = t8;
  const datasetNames = t7;
  let t9;
  $[14] !== (crossDatasetReferences == null ? void 0 : crossDatasetReferences.references) ? (t9 = () => !!(crossDatasetReferences == null ? void 0 : crossDatasetReferences.references.some(_temp4$2)), $[14] = crossDatasetReferences == null ? void 0 : crossDatasetReferences.references, $[15] = t9) : t9 = $[15];
  const hasUnknownDatasetNames = t9(), t10 = ((internalReferences == null ? void 0 : internalReferences.totalCount) || 0) + ((crossDatasetReferences == null ? void 0 : crossDatasetReferences.totalCount) || 0), t11 = isInternalReferencesLoading || isCrossDatasetReferencesLoading;
  let t12;
...
function _temp2$9(crossDatasetReference_0) {
  return (crossDatasetReference_0 == null ? void 0 : crossDatasetReference_0.datasetName) || "";
}
...
function ConfirmDeleteDialog(t0) {
  ...
  $[0] !== id || $[1] !== type ? (t3 = {
    _id: id,
    _type: type
  }, $[0] = id, $[1] = type, $[2] = t3) : t3 = $[2], t22 = t3;
  let t4;
  $[3] !== t22 ? (t4 = (0, import_jsx_runtime2.jsx)(DocTitle, { document: t22 }), $[3] = t22, $[4] = t4) : t4 = $[4];
  const documentTitle = t4, showConfirmButton = !isLoading;
  let t5;
  $[5] !== action || $[6] !== t2 ? (t5 = t2("confirm-delete-dialog.header.text", {
    context: action
  }), $[5] = action, $[6] = t2, $[7] = t5) : t5 = $[7];
  let t6;
  $[8] !== t2 ? (t6 = t2("confirm-delete-dialog.cancel-button.text"), $[8] = t2, $[9] = t6) : t6 = $[9];
  let t7;
  ...
  let t8;
  $[13] !== action || $[14] !== onConfirm || $[15] !== showConfirmButton || $[16] !== t2 || $[17] !== totalCount ? (t8 = showConfirmButton ? {
    ...
    onClick: onConfirm
  } : void 0, $[13] = action, $[14] = onConfirm, $[15] = showConfirmButton, $[16] = t2, $[17] = totalCount, $[18] = t8) : t8 = $[18];
  let t9;
  $[19] !== t7 || $[20] !== t8 ? (t9 = {
    cancelButton: t7,
    confirmButton: t8
...
function Delay(t0) {
  ...
  if ($[0] !== ms ? (t2 = () => {
    ...
    let t42;
    return $[3] === Symbol.for("react.memo_cache_sentinel") ? (t42 = (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, {}), $[3] = t42) : t42 = $[3], t42;
  }
  let t4;
...
var Pane = (0, import_react2.forwardRef)(function(props, forwardedRef) {
  ...
  if ($[10] !== panes || $[11] !== rootElement) {
    ...
    pane2 = $[12], t2 = $[13];
  const paneIndex = t2, nextPane = typeof paneIndex == "number" ? panes[paneIndex + 1] : void 0, isLast = paneIndex === panes.length - 1, expanded = expandedElement === rootElement, collapsed = layoutCollapsed ? false : (pane2 == null ? void 0 : pane2.collapsed) || false, nextCollapsed = (nextPane == null ? void 0 : nextPane.collapsed) || false, ref = (0, import_react2.useRef)(null), flex = (pane2 == null ? void 0 : pane2.flex) ?? flexProp, currentMinWidth = (pane2 == null ? void 0 : pane2.currentMinWidth) ?? currentMinWidthProp, currentMaxWidth = (pane2 == null ? void 0 : pane2.currentMaxWidth) ?? currentMaxWidthProp;
  let t3;
  $[16] === Symbol.for("react.memo_cache_sentinel") ? (t3 = () => ref.current, $[16] = t3) : t3 = $[16], (0, import_react2.useImperativeHandle)(forwardedRef, t3);
  let t4;
  ...
  let t9;
  const t10 = layoutCollapsed ? false : collapsed;
  let t11;
  ...
  let t23;
  $[60] !== children || $[61] !== hidden ? (t23 = !hidden && (0, import_jsx_runtime2.jsx)(Flex, { direction: "column", height: "fill", children }), $[60] = children, $[61] = hidden, $[62] = t23) : t23 = $[62];
  let t24;
  $[63] !== rootElement || $[64] !== t23 ? (t24 = (0, import_jsx_runtime2.jsx)(BoundaryElementProvider, { element: rootElement, children: t23 }), $[63] = rootElement, $[64] = t23, $[65] = t24) : t24 = $[65];
  let t25;
  $[66] !== hidden || $[67] !== id || $[68] !== paneIndex || $[69] !== restProps || $[70] !== style || $[71] !== t19 || $[72] !== t20 || $[73] !== t21 || $[74] !== t22 || $[75] !== t24 ? (t25 = (0, import_jsx_runtime2.jsxs)(Root$8, { "data-testid": "pane", "data-ui": "Pane", tone: "inherit", hidden, id, overflow: t19, ...restProps, "data-pane-collapsed": t20, "data-pane-index": paneIndex, "data-pane-selected": t21, ref: setRef, style, children: [
    t22,
    t24
  ] }), $[66] = hidden, $[67] = id, $[68] = paneIndex, $[69] = restProps, $[70] = style, $[71] = t19, $[72] = t20, $[73] = t21, $[74] = t22, $[75] = t24, $[76] = t25) : t25 = $[76];
  let t26;
  $[77] !== isLast || $[78] !== t25 ? (t26 = (0, import_jsx_runtime2.jsx)(IsLastPaneProvider, { isLastPane: isLast, children: t25 }), $[77] = isLast, $[78] = t25, $[79] = t26) : t26 = $[79];
  let t27;
  $[80] !== contextValue || $[81] !== t26 ? (t27 = (0, import_jsx_runtime2.jsx)(LegacyLayerProvider, { zOffset: "pane", children: (0, import_jsx_runtime2.jsx)(PaneContext.Provider, { value: contextValue, children: t26 }) }), $[80] = contextValue, $[81] = t26, $[82] = t27) : t27 = $[82];
  let t28;
  return $[83] !== divider || $[84] !== t27 ? (t28 = (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    t27,
    divider
...
function PaneMenuButtonItem(props) {
  ...
  if (node.type === "divider") {
    let t02;
    return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime2.jsx)(MenuDivider, {}), $[0] = t02) : t02 = $[0], t02;
  }
  let t0;
  ...
  if (node.type === "group") {
    ...
    if (node.expanded) {
      ...
      let t23;
      $[6] !== disabled || $[7] !== node.children || $[8] !== node.disabled ? (t23 = node.children.map((child, childIndex) => {
        var _a;
        return (0, import_jsx_runtime2.jsx)(PaneMenuButtonItem, { disabled: disabled || !!node.disabled, isAfterGroup: ((_a = node.children[childIndex - 1]) == null ? void 0 : _a.type) === "group", node: child }, child.key);
      }), $[6] = disabled, $[7] = node.children, $[8] = node.disabled, $[9] = t23) : t23 = $[9];
      let t33;
    ...
    const t22 = node.icon;
    let t32;
    $[15] !== disabled || $[16] !== node.children || $[17] !== node.disabled ? (t32 = node.children.map((child_0, childIndex_0) => {
      var _a;
      return (0, import_jsx_runtime2.jsx)(PaneMenuButtonItem, { disabled: disabled || !!node.disabled, isAfterGroup: ((_a = node.children[childIndex_0 - 1]) == null ? void 0 : _a.type) === "group", node: child_0 }, child_0.key);
    }), $[15] = disabled, $[16] = node.children, $[17] = node.disabled, $[18] = t32) : t32 = $[18];
    let t4;
...
function PaneContextMenuItem(props) {
  ...
  let t2;
  $[2] !== node.hotkey ? (t2 = (_a = node.hotkey) == null ? void 0 : _a.split("+"), $[2] = node.hotkey, $[3] = t2) : t2 = $[3];
  const t3 = node.iconRight || node.selected && CheckmarkIcon, t4 = `action-${toLowerCaseNoSpaces(node.title)}`;
  let t5;
  $[4] !== node.icon || $[5] !== node.onAction || $[6] !== node.selected || $[7] !== node.tone || $[8] !== t1 || $[9] !== t2 || $[10] !== t3 || $[11] !== t4 || $[12] !== title ? (t5 = (0, import_jsx_runtime2.jsx)(MenuItem2, { disabled: t1, hotkeys: t2, icon: node.icon, iconRight: t3, onClick: node.onAction, pressed: node.selected, text: title, tone: node.tone, "data-testid": t4 }), $[4] = node.icon, $[5] = node.onAction, $[6] = node.selected, $[7] = node.tone, $[8] = t1, $[9] = t2, $[10] = t3, $[11] = t4, $[12] = title, $[13] = t5) : t5 = $[13];
  let t6;
  return $[14] !== t5 || $[15] !== tooltipContent ? (t6 = (0, import_jsx_runtime2.jsx)(TooltipOfDisabled, { content: tooltipContent, placement: "left", children: t5 }), $[14] = t5, $[15] = tooltipContent, $[16] = t6) : t6 = $[16], t6;
}
function PaneContextIntentMenuItem(props) {
  ...
  let t4;
  $[8] !== node.hotkey ? (t4 = (_a = node.hotkey) == null ? void 0 : _a.split("+"), $[8] = node.hotkey, $[9] = t4) : t4 = $[9];
...
var PaneHeader$1 = (0, import_react2.forwardRef)(function(props, ref) {
  ...
  let t0;
  const t1 = collapsed ? (paneRect == null ? void 0 : paneRect.height) || window.innerHeight : void 0;
  let t2;
  $[0] !== t1 ? (t2 = {
    width: t1
  ...
  let t7;
  $[8] !== backButton ? (t7 = backButton && (0, import_jsx_runtime2.jsx)(Box, { flex: "none", children: backButton }), $[8] = backButton, $[9] = t7) : t7 = $[9];
  const t8 = backButton ? 1 : 2;
  let t9;
  $[10] !== loading ? (t9 = loading && (0, import_jsx_runtime2.jsx)(Box, { children: (0, import_jsx_runtime2.jsx)(TitleTextSkeleton, { animated: true, radius: 1, size: 1 }) }), $[10] = loading, $[11] = t9) : t9 = $[11];
  let t10;
  $[12] !== appendTitle || $[13] !== loading || $[14] !== title ? (t10 = !loading && (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", gap: 1, children: [
  ...
  let t11;
  $[16] !== handleTitleClick || $[17] !== t10 || $[18] !== t8 || $[19] !== t9 || $[20] !== tabIndex ? (t11 = (0, import_jsx_runtime2.jsxs)(TitleCard, { __unstable_focusRing: true, flex: 1, onClick: handleTitleClick, paddingLeft: t8, padding: 2, tabIndex, children: [
    t9,
    t10
  ] }), $[16] = handleTitleClick, $[17] = t10, $[18] = t8, $[19] = t9, $[20] = tabIndex, $[21] = t11) : t11 = $[21];
  let t12;
  $[22] !== actions || $[23] !== collapsed ? (t12 = actions && (0, import_jsx_runtime2.jsx)(Box, { hidden: collapsed, children: (0, import_jsx_runtime2.jsx)(LegacyLayerProvider, { zOffset: "paneHeader", children: actions }) }), $[22] = actions, $[23] = collapsed, $[24] = t12) : t12 = $[24];
  let t13;
  $[25] !== t11 || $[26] !== t12 || $[27] !== t7 ? (t13 = (0, import_jsx_runtime2.jsxs)(Flex, { align: "flex-start", gap: 3, children: [
    t7,
    t11,
    t12
  ] }), $[25] = t11, $[26] = t12, $[27] = t7, $[28] = t13) : t13 = $[28];
  let t14;
  $[29] !== collapsed || $[30] !== showTabsOrSubActions || $[31] !== subActions || $[32] !== tabs ? (t14 = showTabsOrSubActions && (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", hidden: collapsed, overflow: "auto", children: [
  ...
  let t15;
  $[34] !== handleLayoutClick || $[35] !== layoutStyle || $[36] !== t13 || $[37] !== t14 ? (t15 = (0, import_jsx_runtime2.jsxs)(Layout, { direction: "column", gap: 3, onClick: handleLayoutClick, padding: 3, sizing: "border", style: layoutStyle, children: [
    t13,
    t14
  ] }), $[34] = handleLayoutClick, $[35] = layoutStyle, $[36] = t13, $[37] = t14, $[38] = t15) : t15 = $[38];
  const t16 = !collapsed && contentAfter;
  let t17;
  $[39] !== t15 || $[40] !== t16 || $[41] !== t6 ? (t17 = (0, import_jsx_runtime2.jsx)(LegacyLayerProvider, { zOffset: "paneHeader", children: (0, import_jsx_runtime2.jsxs)(Card, { "data-collapsed": t6, tone: "inherit", children: [
    t15,
    t16
  ] }) }), $[39] = t15, $[40] = t16, $[41] = t6, $[42] = t17) : t17 = $[42];
  let t18;
  return $[43] !== border || $[44] !== ref || $[45] !== t17 || $[46] !== t5 ? (t18 = (0, import_jsx_runtime2.jsx)(LayerProvider, { zOffset: 100, children: (0, import_jsx_runtime2.jsx)(Root$5, { $border: border, "data-collapsed": t5, "data-testid": "pane-header", ref, children: t17 }) }), $[43] = border, $[44] = ref, $[45] = t17, $[46] = t5, $[47] = t18) : t18 = $[47], t18;
});
...
function PaneHeaderMenuGroupActionButton(props) {
  ...
  let t5;
  $[7] !== node.children || $[8] !== node.disabled ? (t5 = node.children.map((child, idx) => {
    var _a;
    return (0, import_jsx_runtime2.jsx)(PaneMenuButtonItem, { disabled: !!node.disabled, isAfterGroup: ((_a = node.children[idx - 1]) == null ? void 0 : _a.type) === "group", node: child }, child.key);
  }), $[7] = node.children, $[8] = node.disabled, $[9] = t5) : t5 = $[9];
  let t6;
    ...
    if (rightOptions) {
      ...
      if (type === "end") {
        ...
        optionsMap.set(leftElement, {
          ...
          flex: (leftResizeData == null ? void 0 : leftResizeData.flex) ?? leftOptions.flex
        }), optionsMap.set(rightElement, {
          ...rightOptions,
          currentMinWidth: 0,
          currentMaxWidth: leftOptions.maxWidth ?? 1 / 0,
          flex: (rightResizeData == null ? void 0 : rightResizeData.flex) ?? rightOptions.flex
  ...
  function _notifyObservers() {
    ...
    for (const element of _elements) {
      ...
      dataMap.set(element, {
        element,
        collapsed,
        currentMinWidth: (resizeData == null ? void 0 : resizeData.width) ?? options.currentMinWidth,
        currentMaxWidth: (resizeData == null ? void 0 : resizeData.width) ?? options.currentMaxWidth,
        flex: (resizeData == null ? void 0 : resizeData.flex) ?? options.flex ?? 1
...
function PaneLayout(props) {
  var _a;
  const $ = (0, import_react_compiler_runtime.c)(41);
  ...
  const [controller] = (0, import_react2.useState)(_temp$o), [rootElement, setRootElement] = (0, import_react2.useState)(null), width = ((_a = useElementRect(rootElement)) == null ? void 0 : _a.width) || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
  ...
  let t14;
  $[32] !== children || $[33] !== restProps || $[34] !== t11 || $[35] !== t12 || $[36] !== t13 ? (t14 = (0, import_jsx_runtime2.jsx)(Root$4, { "data-ui": "PaneLayout", ...restProps, "data-collapsed": t11, "data-resizing": t12, "data-mounted": t13, ref: setRootElement, children }), $[32] = children, $[33] = restProps, $[34] = t11, $[35] = t12, $[36] = t13, $[37] = t14) : t14 = $[37];
  let t15;
  return $[38] !== paneLayout || $[39] !== t14 ? (t15 = (0, import_jsx_runtime2.jsx)(PaneLayoutContext.Provider, { value: paneLayout, children: t14 }), $[38] = paneLayout, $[39] = t14, $[40] = t15) : t15 = $[40], t15;
}
function _temp$o() {
...
var IntentButton = (0, import_react2.forwardRef)(function(props, ref) {
  ...
  let t0, t1;
  $[3] !== intent ? (t1 = (0, import_react2.forwardRef)(function(linkProps, linkRef) {
  ...
  const Link2 = t0;
  let t2;
  return $[5] !== Link2 || $[6] !== props.disabled || $[7] !== ref || $[8] !== restProps ? (t2 = props.disabled ? (0, import_jsx_runtime2.jsx)(Button2, { ...restProps, as: "a", role: "link", "aria-disabled": "true" }) : (0, import_jsx_runtime2.jsx)(Button2, { ...restProps, as: Link2, "data-as": "a", ref }), $[5] = Link2, $[6] = props.disabled, $[7] = ref, $[8] = restProps, $[9] = t2) : t2 = $[9], t2;
});
...
var getIntent = (templates, item, version) => {
  var _a;
  const typeName = (_a = templates.find((t2) => t2.id === item.templateId)) == null ? void 0 : _a.schemaType;
...
function PaneHeaderCreateButton(t0) {
  var _a;
  const $ = (0, import_react_compiler_runtime.c)(60), {
    templateItems
  ...
  const [templatePermissions, isTemplatePermissionsLoading] = useTemplatePermissions(t22);
  let t3;
  t3 = !isTemplatePermissionsLoading && (templatePermissions == null ? void 0 : templatePermissions.length) !== 0 && (templatePermissions == null ? void 0 : templatePermissions.every(_temp$n));
  ...
  if (nothingGranted) {
    let t52;
    $[8] !== t2 ? (t52 = t2("pane-header.disabled-created-button.aria-label"), $[8] = t2, $[9] = t52) : t52 = $[9];
    let t62;
    $[10] !== t52 ? (t62 = (0, import_jsx_runtime2.jsx)(Button2, { "aria-label": t52, icon: AddIcon, "data-testid": "action-intent-button", disabled: true, mode: "bleed", tooltipProps: null }), $[10] = t52, $[11] = t62) : t62 = $[11];
    let t72;
    return $[12] !== isTemplatePermissionsLoading || $[13] !== t62 ? (t72 = (0, import_jsx_runtime2.jsx)(InsufficientPermissionsMessageTooltip, { context: "create-document-type", reveal: true, loading: isTemplatePermissionsLoading, children: t62 }), $[12] = isTemplatePermissionsLoading, $[13] = t62, $[14] = t72) : t72 = $[14], t72;
  }
  if (templateItems.length === 1) {
    const firstItem = templateItems[0], disabled = !((_a = permissionsById[firstItem.id]) == null ? void 0 : _a.granted);
    let t52;
    ...
    let t92;
    $[22] !== t2 ? (t92 = t2("pane-header.create-new-button.tooltip"), $[22] = t2, $[23] = t92) : t92 = $[23];
    let t10;
    $[24] !== t92 ? (t10 = {
      content: t92
    }, $[24] = t92, $[25] = t10) : t10 = $[25];
    let t11;
    $[26] !== disabled || $[27] !== intent || $[28] !== t10 || $[29] !== t62.title || $[30] !== t82 ? (t11 = (0, import_jsx_runtime2.jsx)(IntentButton, { "aria-label": t72, icon: t82, intent, mode: "bleed", disabled, "data-testid": "action-intent-button", tooltipProps: t10 }), $[26] = disabled, $[27] = intent, $[28] = t10, $[29] = t62.title, $[30] = t82, $[31] = t11) : t11 = $[31];
    let t12;
    return $[32] !== disabled || $[33] !== isTemplatePermissionsLoading || $[34] !== t11 ? (t12 = (0, import_jsx_runtime2.jsx)(InsufficientPermissionsMessageTooltip, { reveal: disabled, loading: isTemplatePermissionsLoading, context: "create-document-type", children: t11 }), $[32] = disabled, $[33] = isTemplatePermissionsLoading, $[34] = t11, $[35] = t12) : t12 = $[35], t12;
  }
  let t5;
  $[36] !== t2 ? (t5 = t2("pane-header.create-new-button.tooltip"), $[36] = t2, $[37] = t5) : t5 = $[37];
  let t6;
  $[38] !== t5 ? (t6 = (0, import_jsx_runtime2.jsx)(Button2, { icon: AddIcon, mode: "bleed", "data-testid": "multi-action-intent-button", tooltipProps: {
    content: t5
  } }), $[38] = t5, $[39] = t6) : t6 = $[39];
  let t7;
  if ($[40] !== getI18nText || $[41] !== isTemplatePermissionsLoading || $[42] !== permissionsById || $[43] !== selectedReleaseId || $[44] !== t2 || $[45] !== templateItems || $[46] !== templates) {
    let t82;
    $[48] !== getI18nText || $[49] !== isTemplatePermissionsLoading || $[50] !== permissionsById || $[51] !== selectedReleaseId || $[52] !== t2 || $[53] !== templates ? (t82 = (item, itemIndex) => {
      var _a2;
      const disabled_0 = !((_a2 = permissionsById[item.id]) == null ? void 0 : _a2.granted), intent_0 = getIntent(templates, item, selectedReleaseId), template = templates.find((i) => i.id === item.templateId);
    ...
    }, $[48] = getI18nText, $[49] = isTemplatePermissionsLoading, $[50] = permissionsById, $[51] = selectedReleaseId, $[52] = t2, $[53] = templates, $[54] = t82) : t82 = $[54], t7 = templateItems.map(t82), $[40] = getI18nText, $[41] = isTemplatePermissionsLoading, $[42] = permissionsById, $[43] = selectedReleaseId, $[44] = t2, $[45] = templateItems, $[46] = templates, $[47] = t7;
  } else
    t7 = $[47];
  let t8;
  $[55] !== t7 ? (t8 = (0, import_jsx_runtime2.jsx)(Menu, { children: t7 }), $[55] = t7, $[56] = t8) : t8 = $[56];
  let t9;
  return $[57] !== t6 || $[58] !== t8 ? (t9 = (0, import_jsx_runtime2.jsx)(MenuButton, { button: t6, id: "create-menu", menu: t8, popover: POPOVER_PROPS }), $[57] = t6, $[58] = t8, $[59] = t9) : t9 = $[59], t9;
}
...
var PaneHeaderActions = (0, import_react2.memo)(function(props) {
  ...
  } = props, templates = useTemplates(), handleAction = (0, import_react2.useCallback)((item) => {
  ...
  }, [actionHandlers]), menuNodes = (0, import_react2.useMemo)(() => resolveMenuNodes({
    actionHandler: handleAction,
    menuItemGroups,
    menuItems: menuItems.filter((item_0) => {
      var _a;
      return ((_a = item_0.intent) == null ? void 0 : _a.type) !== "create";
    })
  }), [handleAction, menuItemGroups, menuItems]), actionNodes = (0, import_react2.useMemo)(() => menuNodes.filter(isMenuNodeButton), [menuNodes]), contextMenuNodes = (0, import_react2.useMemo)(() => menuNodes.filter(isNotMenuNodeButton), [menuNodes]), initialValueTemplateItemFromMenuItems = (0, import_react2.useMemo)(() => menuItems.map((item_1, menuItemIndex) => {
    var _a;
    if (((_a = item_1.intent) == null ? void 0 : _a.type) !== "create") return null;
    const {
      params
    } = item_1.intent;
  ...
  })), [menuItems, templates]), combinedInitialValueTemplates = (0, import_react2.useMemo)(() => (0, import_uniqBy.default)([...initialValueTemplateItemFromMenuItems, ...initialValueTemplateItemsFromStructure], (item_3) => hashObject([item_3.initialDocumentId, item_3.templateId, item_3.parameters])), [initialValueTemplateItemFromMenuItems, initialValueTemplateItemsFromStructure]);
  return (0, import_jsx_runtime2.jsxs)(Flex, { gap: 1, children: [
    (0, import_jsx_runtime2.jsx)(PaneHeaderCreateButton, { templateItems: combinedInitialValueTemplates }),
    actionNodes.map((node) => (0, import_jsx_runtime2.jsx)(PaneHeaderActionButton, { node }, node.key)),
    contextMenuNodes.length > 0 && (0, import_jsx_runtime2.jsx)(PaneContextMenuButton, { nodes: contextMenuNodes })
  ] });
});
function MissingSchemaType(props) {
  ...
  let t6;
  return $[12] !== layout || $[13] !== t22 || $[14] !== t5 ? (t6 = (0, import_jsx_runtime2.jsx)(SanityDefaultPreview, { title: t22, subtitle: t5, media: _temp$m, layout }), $[12] = layout, $[13] = t22, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
}
function _temp$m() {
...
function PaneItem(props) {
  ...
  bb0: {
    ...
    let t32;
    $[13] === Symbol.for("react.memo_cache_sentinel") ? (t32 = (0, import_jsx_runtime2.jsx)(Box, { style: t22, children: (0, import_jsx_runtime2.jsx)(Text, { muted: true, size: 1, children: (0, import_jsx_runtime2.jsx)(ChevronRightIcon, {}) }) }), $[13] = t32) : t32 = $[13];
    let t42;
  ...
  const preview = t1;
  let t2;
  $[20] === Symbol.for("react.memo_cache_sentinel") ? (t2 = (e2) => {
    if (e2.metaKey) {
      setClicked(false);
      return;
    }
  ...
  const handleClick = t2;
  let t3;
  $[21] === Symbol.for("react.memo_cache_sentinel") ? (t3 = () => setClicked(false), $[21] = t3) : t3 = $[21];
  let t4;
  ...
  let t10;
  $[26] !== id || $[27] !== preloading || $[28] !== schemaType || $[29] !== value ? (t10 = preloading && (schemaType == null ? void 0 : schemaType.name) && value && isSanityDocument(value) && (0, import_jsx_runtime2.jsx)(PreloadDocumentPane, { documentId: id, documentType: schemaType.name }), $[26] = id, $[27] = preloading, $[28] = schemaType, $[29] = value, $[30] = t10) : t10 = $[30];
  let t11;
...
var RenderActionCollectionState = (0, import_react2.memo)((props) => {
  ...
  $[0] !== actionProps.id || $[1] !== actionProps.liveEditSchemaType || $[2] !== children ? (t0 = (t12) => {
    ...
    return (0, import_jsx_runtime2.jsx)(ActionsGuardWrapper, { states, documentId: actionProps.liveEditSchemaType ? getPublishedId(actionProps.id) : getDraftId(actionProps.id), children });
  }, $[0] = actionProps.id, $[1] = actionProps.liveEditSchemaType, $[2] = children, $[3] = t0) : t0 = $[3];
  let t1;
  return $[4] !== actionProps || $[5] !== actions || $[6] !== group || $[7] !== onActionComplete || $[8] !== t0 ? (t1 = (0, import_jsx_runtime2.jsx)(GetHookCollectionState, { onReset: onActionComplete, hooks: actions, args: actionProps, group, children: t0 }), $[4] = actionProps, $[5] = actions, $[6] = group, $[7] = onActionComplete, $[8] = t0, $[9] = t1) : t1 = $[9], t1;
});
RenderActionCollectionState.displayName = "Memo(RenderActionCollectionState)";
var SUPPORTED_LINKED_TO_CANVAS_ACTIONS = ["delete", "duplicate", "publish", "unpublish", "unlinkFromCanvas", "editInCanvas", "linkToCanvas", "schedule"];
var ActionsGuardWrapper = (props) => {
  const $ = (0, import_react_compiler_runtime.c)(9), {
    states,
    children,
    documentId
  ...
  bb0: {
    if (isLinked) {
      let t12;
      if ($[0] !== children || $[1] !== states || $[2] !== t2) {
        let t22;
        $[4] !== t2 ? (t22 = (s2) => !s2.action || !SUPPORTED_LINKED_TO_CANVAS_ACTIONS.includes(s2.action) ? {
          ...s2,
          disabled: true,
          title: t2("action.disabled-by-canvas.tooltip")
        } : s2, $[4] = t2, $[5] = t22) : t22 = $[5], t12 = children({
          states: states.map(t22)
        }), $[0] = children, $[1] = states, $[2] = t2, $[3] = t12;
      } else
        t12 = $[3];
      t0 = t12;
      break bb0;
...
function useDiffViewRouter() {
  ...
  $[0] !== navigate || $[1] !== routerState ? (t0 = (t12) => {
    const {
      ...
      ...(0, import_fromPairs.default)(routerState._searchParams),
      ...mode ? {
    ...
    navigate({
      ...routerState,
      _searchParams: (0, import_toPairs.default)(next)
    });
...
var VersionModeHeader = ({
  ...
  const {
    ...
    documents
  } = useDiffViewState(), activeReleases = useActiveReleases(), releasesIds = documentVersions.flatMap((id) => getVersionFromId(id) ?? []), releases = (0, import_react2.useMemo)(() => activeReleases.data.filter((release) => {
    const releaseId = getReleaseIdFromReleaseDocumentId(release._id);
    return typeof releaseId < "u" && releasesIds.includes(releaseId);
  }), [activeReleases.data, releasesIds]), onSelectPreviousRelease = (0, import_react2.useCallback)((selectedDocumentId) => {
    typeof (documents == null ? void 0 : documents.previous) < "u" && navigateDiffView({
      previousDocument: {
        ...documents.previous,
        id: selectedDocumentId
      }
    });
  }, [documents == null ? void 0 : documents.previous, navigateDiffView]), onSelectNextRelease = (0, import_react2.useCallback)((selectedDocumentId_0) => {
    typeof (documents == null ? void 0 : documents.next) < "u" && navigateDiffView({
      nextDocument: {
        ...documents.next,
        id: selectedDocumentId_0
      }
    });
  }, [documents == null ? void 0 : documents.next, navigateDiffView]);
  return (0, import_jsx_runtime2.jsxs)(VersionModeHeaderLayout, { children: [
    (0, import_jsx_runtime2.jsxs)(VersionModeHeaderLayoutSection, { children: [
      (0, import_jsx_runtime2.jsx)(Box, { padding: 4, children: (0, import_jsx_runtime2.jsx)(Text, { as: "h1", size: 1, muted: true, children: t2("compare-versions.title") }) }),
      typeof (documents == null ? void 0 : documents.previous) < "u" && (0, import_jsx_runtime2.jsx)(VersionMenu, { releases, onSelectRelease: onSelectPreviousRelease, role: "previous", documentId, state: state2, document: documents.previous })
    ] }),
    (0, import_jsx_runtime2.jsx)(Flex, { align: "center", paddingX: 3, children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(TransferIcon, {}) }) }),
    (0, import_jsx_runtime2.jsxs)(VersionModeHeaderLayoutSection, { children: [
      typeof (documents == null ? void 0 : documents.next) < "u" && (0, import_jsx_runtime2.jsx)(VersionMenu, { releases, onSelectRelease: onSelectNextRelease, role: "next", documentId, state: state2, document: documents.next }),
      (0, import_jsx_runtime2.jsx)(Box, { padding: 3, style: {
        justifySelf: "end"
      }, children: (0, import_jsx_runtime2.jsx)(Button, { icon: CloseIcon, mode: "bleed", onClick: exitDiffView, padding: 2 }) })
    ] })
  ] });
};
var VersionMenu = ({
  ...
  const {
    published,
    draft
  } = useEditState(getPublishedId(document2.id), document2.type), selected = (0, import_react2.useMemo)(() => findRelease(document2.id, releases), [document2.id, releases]), {
    t: tStructure
  } = useTranslation(structureLocaleNamespace), {
    t: tCore
  } = useTranslation(), {
  ...
  return (0, import_jsx_runtime2.jsx)(MenuButton, { id: role, button: (0, import_jsx_runtime2.jsx)(Button, { type: "button", mode: "bleed", padding: 2, paddingRight: 3, radius: "full", selected: true, ...getMenuButtonProps({
    selected,
    tCore,
    tStructure
  }) }), menu: (0, import_jsx_runtime2.jsxs)(Menu, { children: [
    published && (0, import_jsx_runtime2.jsx)(VersionMenuItem, { type: "published", onSelect: onSelectRelease, isSelected: selected === "published", documentId }),
    isDraftModelEnabled && draft && (0, import_jsx_runtime2.jsx)(VersionMenuItem, { type: "draft", onSelect: onSelectRelease, isSelected: selected === "draft", documentId }),
    releases.map((release) => (0, import_jsx_runtime2.jsx)(VersionMenuItem, { release, onSelect: onSelectRelease, isSelected: typeof selected != "string" && (selected == null ? void 0 : selected._id) === release._id, documentId }, release._id))
  ] }) });
};
var VersionMenuItem = ({
  type,
  ...
  const {
    ...
    t: tStructure
  } = useTranslation(structureLocaleNamespace), onClick = (0, import_react2.useCallback)(() => {
    if (type === "draft") {
    ...
    typeof (release == null ? void 0 : release._id) < "u" && onSelect(getVersionId(documentId, getReleaseIdFromReleaseDocumentId(release._id)));
  }, [type, onSelect, documentId, release == null ? void 0 : release._id]);
  if (type)
    return (0, import_jsx_runtime2.jsx)(MenuItem, { padding: 1, paddingRight: 3, onClick, pressed: isSelected, children: (0, import_jsx_runtime2.jsxs)(Flex, { gap: 1, children: [
      (0, import_jsx_runtime2.jsx)(ReleaseAvatar, { padding: 2, tone: type === "published" ? "positive" : "caution" }),
      (0, import_jsx_runtime2.jsx)(Box, { paddingY: 2, children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, weight: "medium", children: tStructure(["compare-versions.status", type].join(".")) }) })
    ] }) });
  const tone_0 = release ? getReleaseTone(release) : "neutral";
  return (0, import_jsx_runtime2.jsx)(MenuItem, { padding: 1, paddingRight: 3, onClick, pressed: isSelected, children: (0, import_jsx_runtime2.jsxs)(Flex, { gap: 1, children: [
    (0, import_jsx_runtime2.jsx)(ReleaseAvatar, { padding: 2, tone: tone_0 }),
    (0, import_jsx_runtime2.jsxs)(Stack, { flex: 1, paddingY: 2, paddingRight: 2, space: 2, children: [
      (0, import_jsx_runtime2.jsx)(Text, { size: 1, weight: "medium", children: release.metadata.title || tCore("release.placeholder-untitled-release") }),
      ["asap", "undecided"].includes(release.metadata.releaseType) && (0, import_jsx_runtime2.jsx)(Text, { muted: true, size: 1, children: tCore(`release.type.${release.metadata.releaseType}`) }),
      release.metadata.releaseType === "scheduled" && (0, import_jsx_runtime2.jsx)(Text, { muted: true, size: 1, children: formatRelativeLocalePublishDate(release) })
    ] }),
    (0, import_jsx_runtime2.jsx)(Flex, { flex: "none", children: isReleaseScheduledOrScheduling(release) && (0, import_jsx_runtime2.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(LockIcon, {}) }) }) })
  ] }) });
};
function getMenuButtonProps({
  ...
  if (isReleaseDocument(selected)) {
    ...
    return {
      text: (selected == null ? void 0 : selected.metadata.title) || tCore("release.placeholder-untitled-release"),
...
function usePathSyncChannel(t0) {
  ...
  if ($[3] !== id || $[4] !== syncChannel) {
    ...
    $[6] !== id ? (t42 = (t5) => {
      ...
      return source !== id;
    }, $[6] = id, $[7] = t42) : t42 = $[7], t3 = syncChannel.pipe(distinctUntilChanged(_temp$j), filter(t42), map(_temp2$7)), $[3] = id, $[4] = syncChannel, $[5] = t3;
  } else
    t3 = $[5];
  t2 = t3;
  const path = t2;
...
var DiffViewPane = (0, import_react2.forwardRef)(function(t0, ref) {
  const $ = (0, import_react_compiler_runtime.c)(36), {
    role,
    documentType,
    documentId,
    scrollElement,
  ...
  $[9] === Symbol.for("react.memo_cache_sentinel") ? (t4 = {
    isInteractive: false,
    onOpenReviewChanges: import_noop.default,
    onSetFocus: import_noop.default,
  ...
  let t15;
  $[25] === Symbol.for("react.memo_cache_sentinel") ? (t15 = (0, import_jsx_runtime2.jsx)("div", { "data-testid": "diffView-document-panel-portal", ref: setPortalElement }), $[25] = t15) : t15 = $[25];
  let t16;
...
var DiffViewDocument = (t0) => {
  ...
  const compareValue = useCompareValue(t1), [patchChannel] = (0, import_react2.useState)(_temp$i);
  let t2;
  ...
  }, t10 = [onProgrammaticFocus, pathSyncChannel.path], $[36] = onProgrammaticFocus, $[37] = pathSyncChannel.path, $[38] = t10, $[39] = t9) : (t10 = $[38], t9 = $[39]), (0, import_react2.useEffect)(t9, t10);
  let t11;
  return $[40] !== collapsedFieldSets || $[41] !== collapsedPaths || $[42] !== formState || $[43] !== isLoading || $[44] !== onBlur || $[45] !== onChange || $[46] !== onFocus || $[47] !== onPathOpen || $[48] !== onSetActiveFieldGroup || $[49] !== onSetCollapsedFieldSet || $[50] !== onSetCollapsedPath || $[51] !== patchChannel || $[52] !== role || $[53] !== schemaType || $[54] !== value ? (t11 = isLoading ? (0, import_jsx_runtime2.jsx)(LoadingBlock, { showText: true }) : (0, import_jsx_runtime2.jsx)(CommentsEnabledContext.Provider, { value: {
    enabled: false,
    mode: null
...
var DiffView = (t0) => {
  ...
  let t4;
  $[5] !== documentId || $[6] !== mode || $[7] !== state2 ? (t4 = mode === "version" && (0, import_jsx_runtime2.jsx)(VersionModeHeader, { documentId, state: state2 }), $[5] = documentId, $[6] = mode, $[7] = state2, $[8] = t4) : t4 = $[8];
  let t5;
  $[9] !== documents || $[10] !== nextPaneElement || $[11] !== previousPaneElement || $[12] !== state2 || $[13] !== syncChannel ? (t5 = state2 === "ready" && (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
  ...
  let t6;
  $[15] !== t4 || $[16] !== t5 ? (t6 = (0, import_jsx_runtime2.jsxs)(DialogLayout, { children: [
    t4,
    t5
  ] }), $[15] = t4, $[16] = t5, $[17] = t6) : t6 = $[17];
  let t7;
  $[18] !== exitDiffView || $[19] !== t6 ? (t7 = (0, import_jsx_runtime2.jsx)(Dialog2, { id: "diffView", width: "auto", onClose: exitDiffView, padding: false, __unstable_hideCloseButton: true, children: t6 }), $[18] = exitDiffView, $[19] = t6, $[20] = t7) : t7 = $[20];
  let t8;
  return $[21] !== diffViewReferenceInputOptionsContext || $[22] !== t7 ? (t8 = (0, import_jsx_runtime2.jsx)(ReferenceInputOptionsContext.Provider, { value: diffViewReferenceInputOptionsContext, children: t7 }), $[21] = diffViewReferenceInputOptionsContext, $[22] = t7, $[23] = t8) : t8 = $[23], t8;
};
...
function CommentsProviderWrapper(props) {
  const $ = (0, import_react_compiler_runtime.c)(25), {
    ...
    studioUrl
  } = useStudioUrl(window.location.origin), selectedCommentId = params == null ? void 0 : params.comment, paramsRef = (0, import_react2.useRef)(params);
  let t0, t1;
  $[0] !== params ? (t0 = () => {
...
function useFilteredReleases({
  ...
  return (0, import_react2.useMemo)(() => {
    ...
    if (!(params == null ? void 0 : params.historyVersion)) return activeReleases;
    const archivedRelease = archivedReleases.find((r2) => getReleaseIdFromReleaseDocumentId(r2._id) === (params == null ? void 0 : params.historyVersion));
    return (archivedRelease == null ? void 0 : archivedRelease.state) === "archived" && activeReleases.currentReleases.push(archivedRelease), activeReleases;
  }, [archivedReleases, isCreatingDocument, displayed == null ? void 0 : displayed._id, documentVersions, params == null ? void 0 : params.historyVersion, releases, selectedReleaseId]);
}
function useDocumentIdStack({
  ...
  const {
    ...
    displayed,
    documentId
  }), systemStack = [(_a = editState == null ? void 0 : editState.published) == null ? void 0 : _a._id, isDraftModelEnabled ? (_b = editState == null ? void 0 : editState.draft) == null ? void 0 : _b._id : []].flat(), releaseStack = filteredReleases.currentReleases.map((release) => (editState == null ? void 0 : editState.id) && getVersionId(editState.id, getReleaseIdFromReleaseDocumentId(release._id))), stack = systemStack.concat(releaseStack).filter((id) => typeof id == "string"), position = (0, import_react2.useMemo)(() => stack.findIndex((id_0) => id_0 === (displayed == null ? void 0 : displayed._id)), [displayed == null ? void 0 : displayed._id, stack]), previousId = (0, import_react2.useMemo)(() => stack[position - 1] ?? void 0, [position, stack]), nextId = (0, import_react2.useMemo)(() => stack[position + 1] ?? void 0, [position, stack]);
  return {
    position,
    previousId,
    nextId,
...
function DocumentInspectorMenuItemsResolver(props) {
  const {
    ...
    onMenuItems
  } = props, len = inspectors2.length, [menuItems, setMenuItems] = (0, import_react2.useState)(() => Array.from(new Array(len)));
  ...
  const InspectorMenuItems = (0, import_react2.useMemo)(() => inspectors2.map((inspector, index_0) => inspector.useMenuItem ? [defineInspectorMenuItemComponent({
    documentId,
    documentType,
    index: index_0,
    setMenuItem,
  ...
  return (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: InspectorMenuItems.map(([InspectorMenuItem, key]) => key && (0, import_jsx_runtime2.jsx)(InspectorMenuItem, {}, key)) });
}
...
function useDocumentTitle() {
  ...
  if (!displayed) {
    const t12 = (schemaType == null ? void 0 : schemaType.title) || (schemaType == null ? void 0 : schemaType.name);
    let t222;
    $[7] !== t2 || $[8] !== t12 ? (t222 = t2("panes.document-header-title.new.text", {
      schemaType: t12
    }), $[7] = t2, $[8] = t12, $[9] = t222) : t222 = $[9];
    let t3;
    return $[10] !== t222 ? (t3 = {
      error: void 0,
      title: t222
    }, $[10] = t222, $[11] = t3) : t3 = $[11], t3;
  }
  if (error) {
    let t12;
    $[12] !== error.message || $[13] !== t2 ? (t12 = t2("panes.document-list-pane.error.text", {
      error: error.message
    }), $[12] = error.message, $[13] = t2, $[14] = t12) : t12 = $[14];
    let t222;
    return $[15] !== t12 ? (t222 = {
      error: t12,
      title: void 0
    }, $[15] = t12, $[16] = t222) : t222 = $[16], t222;
  }
  const t1 = value == null ? void 0 : value.title;
  let t22;
  return $[17] !== t1 ? (t22 = {
    error: void 0,
    title: t1
  }, $[17] = t1, $[18] = t22) : t22 = $[18], t22;
}
...
var DocumentOperationResults = (0, import_react2.memo)(function() {
  ...
  let t0;
  bb0: {
    if (!documentTitleInfo.title && !titleError && !IGNORE_OPS.includes(event == null ? void 0 : event.op) && typeof documentPaneValue.title == "string" && (event == null ? void 0 : event.type) === "success") {
  ...
  let t3, t4;
  return $[5] !== documentTitle || $[6] !== event || $[7] !== paneRouter || $[8] !== pushToast || $[9] !== t2 ? (t3 = () => {
  ...
  }, t4 = [event, paneRouter, pushToast, t2, documentTitle], $[5] = documentTitle, $[6] = event, $[7] = paneRouter, $[8] = pushToast, $[9] = t2, $[10] = t3, $[11] = t4) : (t3 = $[10], t4 = $[11]), (0, import_react2.useEffect)(t3, t4), null;
});
...
function hasObsoleteDraft({
  ...
  if (!(editState == null ? void 0 : editState.ready))
    return {
      result: void 0
    };
...
function useStructureToolSetting(namespace, key, defaultValue) {
  const $ = (0, import_react_compiler_runtime.c)(16), keyValueStore = useKeyValueStore();
  let t0;
...
function InspectDialog(props) {
  ...
  let t21;
  $[33] !== value || $[34] !== viewMode ? (t21 = viewMode === VIEW_MODE_RAW && (0, import_jsx_runtime2.jsx)(Code, { language: "json", tabIndex: 0, onKeyDown: maybeSelectAll, onDoubleClick: select, onFocus: select, size: 1, children: JSON.stringify(value, null, 2) }), $[33] = value, $[34] = viewMode, $[35] = t21) : t21 = $[35];
  let t22;
...
function DeletedDocumentBanners() {
  ...
  if (isDeleted && !isDeleting) {
    let t0;
    return $[2] === Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime2.jsx)(DeletedDocumentBanner, {}), $[2] = t0) : t0 = $[2], t0;
  }
}
...
var ArchivedReleaseBanner = (t0) => {
  ...
  let t1;
  $[0] !== ((_a = release.metadata) == null ? void 0 : _a.title) || $[1] !== t2 ? (t1 = ((_b = release.metadata) == null ? void 0 : _b.title) || t2("release.placeholder-untitled-release"), $[0] = (_c = release.metadata) == null ? void 0 : _c.title, $[1] = t2, $[2] = t1) : t1 = $[2];
  let t22;
  $[3] !== t1 ? (t22 = {
    title: t1
  }, $[3] = t1, $[4] = t22) : t22 = $[4];
...
function RequestPermissionDialog(t0) {
  const $ = (0, import_react_compiler_runtime.c)(56), {
    ...
    t: t2
  } = useTranslation(structureLocaleNamespace), telemtry = useTelemetry(), dialogId = `request-permissions-${(0, import_react2.useId)()}`, projectId = useProjectId$1();
  let t1;
  ...
  bb0: {
    ...
    if (!projectId || !client) {
      let t33;
      $[1] === Symbol.for("react.memo_cache_sentinel") ? (t33 = of(adminRole), $[1] = t33) : t33 = $[1], t22 = t33;
      break bb0;
    }
    let t32;
  ...
  $[7] !== client || $[8] !== note || $[9] !== onRequestSubmitted || $[10] !== projectId || $[11] !== requestedRole || $[12] !== telemtry || $[13] !== toast ? (t3 = () => {
    setIsSubmitting(true), client.request({
      ...
      body: {
        note,
        requestUrl: window == null ? void 0 : window.location.href,
        requestedRole,
        type: "role"
      }
    }).then((request) => {
      ...
      var _a, _b, _c;
      const statusCode = (_a = err == null ? void 0 : err.response) == null ? void 0 : _a.statusCode, errMessage = (_c = (_b = err == null ? void 0 : err.response) == null ? void 0 : _b.body) == null ? void 0 : _c.message;
  ...
  let t15;
  $[44] !== t13 || $[45] !== t14 ? (t15 = (0, import_jsx_runtime2.jsx)(DialogBody, { children: (0, import_jsx_runtime2.jsxs)(Stack, { space: 4, children: [
    t13,
    t14
...
function _temp$h(role) {
  return role == null ? void 0 : role.appliesToUsers;
}
var LOADING_STATE = {
  loading: true,
  error: false,
...
var useRoleRequestsStatus = () => {
  ...
  const client = useClient(t0), projectId = useProjectId$1();
  let t1;
  bb0: {
    if (!client || !projectId) {
      let t23;
...
function InsufficientPermissionBanner(t0) {
  ...
  } = useRoleRequestsStatus(), [requestSent, setRequestSent] = (0, import_react2.useState)(false);
  let t1;
  t1 = roleRequestStatus === "pending" || roleRequestStatus === "declined" || requestSent;
  const requestPending = t1;
  let t2;
  $[0] !== (currentUser == null ? void 0 : currentUser.roles) ? (t2 = (currentUser == null ? void 0 : currentUser.roles) || [], $[0] = currentUser == null ? void 0 : currentUser.roles, $[1] = t2) : t2 = $[1];
  const currentUserRoles = t2, isOnlyViewer = currentUserRoles.length === 1 && currentUserRoles[0].name === "viewer", [showRequestPermissionDialog, setShowRequestPermissionDialog] = (0, import_react2.useState)(false);
  let t3;
  ...
  let roleTitles, t42;
  $[3] !== currentUserRoles || $[4] !== listFormat ? (roleTitles = currentUserRoles.map(_temp$g), t42 = listFormat.formatToParts(roleTitles).map(_temp2$5), $[3] = currentUserRoles, $[4] = listFormat, $[5] = roleTitles, $[6] = t42) : (roleTitles = $[5], t42 = $[6]);
  const roles = t42;
  let t5;
  $[7] !== roles ? (t5 = {
  ...
  let t7;
  $[12] !== requiredPermission || $[13] !== t4 || $[14] !== t5 || $[15] !== t6 ? (t7 = (0, import_jsx_runtime2.jsx)(Text, { size: 1, weight: "medium", children: (0, import_jsx_runtime2.jsx)(Translate, { t: t4, i18nKey: "banners.permission-check-banner.missing-permission", components: t5, values: t6, context: requiredPermission }) }), $[12] = requiredPermission, $[13] = t4, $[14] = t5, $[15] = t6, $[16] = t7) : t7 = $[16];
  let t8;
  $[17] !== isOnlyViewer || $[18] !== requestPending || $[19] !== requestStatusError || $[20] !== requestStatusLoading || $[21] !== roleRequestStatus || $[22] !== t4 || $[23] !== telemetry ? (t8 = isOnlyViewer && roleRequestStatus && !requestStatusError && !requestStatusLoading ? {
    onClick: requestPending ? void 0 : () => {
      setShowRequestPermissionDialog(true), telemetry.log(AskToEditDialogOpened);
    },
    text: t4(requestPending ? "banners.permission-check-banner.request-permission-button.sent" : "banners.permission-check-banner.request-permission-button.text"),
    tone: requestPending ? "default" : "primary",
    disabled: requestPending,
    mode: requestPending ? "bleed" : void 0
  } : void 0, $[17] = isOnlyViewer, $[18] = requestPending, $[19] = requestStatusError, $[20] = requestStatusLoading, $[21] = roleRequestStatus, $[22] = t4, $[23] = telemetry, $[24] = t8) : t8 = $[24];
  let t9;
  $[25] !== t7 || $[26] !== t8 ? (t9 = (0, import_jsx_runtime2.jsx)(Banner, { content: t7, action: t8, "data-testid": "permission-check-banner", icon: ReadOnlyIcon }), $[25] = t7, $[26] = t8, $[27] = t9) : t9 = $[27];
  let t10;
  $[28] !== showRequestPermissionDialog ? (t10 = showRequestPermissionDialog && (0, import_jsx_runtime2.jsx)(RequestPermissionDialog, { onClose: () => setShowRequestPermissionDialog(false), onRequestSubmitted: () => {
    setRequestSent(true), setShowRequestPermissionDialog(false);
  } }), $[28] = showRequestPermissionDialog, $[29] = t10) : t10 = $[29];
  let t11;
  return $[30] !== t10 || $[31] !== t9 ? (t11 = (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    t9,
    t10
...
var ReferenceChangedBanner = (0, import_react2.memo)(() => {
  ...
  const documentPreviewStore = useDocumentPreviewStore(), {
    ...
    replaceCurrent,
    BackLink: BackLink2
  } = usePaneRouter(), routerReferenceId = (_a = routerPanesState[groupIndex]) == null ? void 0 : _a[0].id, parentSibling = (_b = routerPanesState[groupIndex - 1]) == null ? void 0 : _b[0], parentId = parentSibling == null ? void 0 : parentSibling.id, hasHistoryOpen = !!((_c = parentSibling == null ? void 0 : parentSibling.params) == null ? void 0 : _c.rev), parentRefPath = (0, import_react2.useMemo)(() => (params == null ? void 0 : params.parentRefPath) && fromString(params.parentRefPath) || null, [params == null ? void 0 : params.parentRefPath]), {
    t: t2
  } = useTranslation(structureLocaleNamespace), referenceInfoObservable = (0, import_react2.useMemo)(() => {
          ...
          return {
            ...
            result: {
              availability: {
                ...
                ...(version == null ? void 0 : version.availability) ? {
                  version: version.availability
                } : {}
              },
              refValue: (_a2 = get((version == null ? void 0 : version.snapshot) || draft.snapshot || published.snapshot, parentRefPath)) == null ? void 0 : _a2._ref
            }
          };
        })
      )
    ...
    var _a2;
    referenceInfo.loading || ((_a2 = referenceInfo.result) == null ? void 0 : _a2.refValue) && replaceCurrent({
  ...
  return (
    ...
    !((_d = referenceInfo.result) == null ? void 0 : _d.availability.draft.available) && !((_e = referenceInfo.result) == null ? void 0 : _e.availability.published.available) || // if the references are the same, then hide the reference changed banner
    ((_f = referenceInfo.result) == null ? void 0 : _f.refValue) === routerReferenceId ? null : (0, import_jsx_runtime2.jsx)(Banner, { action: ((_g = referenceInfo.result) == null ? void 0 : _g.refValue) ? {
    ...
    }, "data-testid": "reference-changed-banner", content: (0, import_jsx_runtime2.jsx)(Text, { size: 1, weight: "medium", children: ((_h = referenceInfo.result) == null ? void 0 : _h.refValue) ? t2("banners.reference-changed-banner.reason-changed.text") : t2("banners.reference-changed-banner.reason-removed.text") }), icon: WarningOutlineIcon, tone: "caution" })
  );
});
...
function ArchivedReleaseDocumentBanner() {
  const {
    ...
    setParams({
      ...params,
      rev: (params == null ? void 0 : params.historyEvent) || void 0,
      since: void 0,
      historyVersion: void 0
    });
  }, release = (0, import_react2.useMemo)(() => archivedReleases.find((r2) => getReleaseIdFromReleaseDocumentId(r2._id) === (params == null ? void 0 : params.historyVersion)), [archivedReleases, params == null ? void 0 : params.historyVersion]), description = (release == null ? void 0 : release.state) === "published" ? "banners.published-release.description" : "banners.archived-release.description", title = (release == null ? void 0 : release.metadata.title) || tCore("release.placeholder-untitled-release");
  return (0, import_jsx_runtime2.jsx)(Banner, { tone: "caution", content: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(Translate, { t: t2, i18nKey: description, values: {
    title
  }, components: {
    VersionBadge: getVersionInlineBadge(release)
  } }) }), action: (params == null ? void 0 : params.archivedRelease) ? void 0 : {
...
var CanvasPopoverContent = (t0) => {
  ...
  let t22;
  $[1] === Symbol.for("react.memo_cache_sentinel") ? (t22 = (0, import_jsx_runtime2.jsx)(Image, { src: CANVAS_IMAGE_URL, alt: "Canvas" }), $[1] = t22) : t22 = $[1];
  let t3;
  $[2] === Symbol.for("react.memo_cache_sentinel") ? (t3 = (0, import_jsx_runtime2.jsx)(Text, { size: 1, weight: "semibold", children: CANVAS_APP_NAME }), $[2] = t3) : t3 = $[2];
  let t4;
  $[3] === Symbol.for("react.memo_cache_sentinel") ? (t4 = (0, import_jsx_runtime2.jsxs)(Flex, { paddingY: 1, gap: 2, children: [
    t3,
    (0, import_jsx_runtime2.jsx)(Text, { size: 1, muted: true, children: (0, import_jsx_runtime2.jsx)(ComposeSparklesIcon, {}) })
  ] }), $[3] = t4) : t4 = $[3];
  let t5;
  $[4] !== t2 ? (t5 = t2("canvas.banner.popover-heading"), $[4] = t2, $[5] = t5) : t5 = $[5];
  let t6;
  $[6] !== t5 ? (t6 = (0, import_jsx_runtime2.jsx)(Box, { paddingTop: 3, children: (0, import_jsx_runtime2.jsx)(Heading, { size: 1, children: t5 }) }), $[6] = t5, $[7] = t6) : t6 = $[7];
  let t7;
  $[8] !== t2 ? (t7 = t2("canvas.banner.popover-description"), $[8] = t2, $[9] = t7) : t7 = $[9];
  let t8;
  $[10] !== t7 ? (t8 = (0, import_jsx_runtime2.jsx)(Box, { paddingTop: 4, children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: t7 }) }), $[10] = t7, $[11] = t8) : t8 = $[11];
  let t9;
  $[12] !== t6 || $[13] !== t8 ? (t9 = (0, import_jsx_runtime2.jsxs)(Flex, { paddingX: 4, paddingBottom: 4, paddingTop: 3, direction: "column", children: [
    t4,
    t6,
    t8
  ] }), $[12] = t6, $[13] = t8, $[14] = t9) : t9 = $[14];
  let t10;
  $[15] !== t2 ? (t10 = t2("canvas.banner.popover-button-text"), $[15] = t2, $[16] = t10) : t10 = $[16];
  let t11;
  $[17] !== t10 ? (t11 = (0, import_jsx_runtime2.jsx)(Flex, { width: "full", gap: 3, justify: "flex-end", paddingX: 4, paddingBottom: 4, children: (0, import_jsx_runtime2.jsx)(Button2, { mode: "bleed", text: t10, autoFocus: true, tone: "primary", href: "https://snty.link/canvas-docs", target: "_blank", rel: "noopener noreferrer", as: "a", iconRight: LaunchIcon }) }), $[17] = t10, $[18] = t11) : t11 = $[18];
  let t12;
  return $[19] !== t11 || $[20] !== t9 ? (t12 = (0, import_jsx_runtime2.jsx)(Card, { radius: 3, overflow: "hidden", width: 0, ref, children: (0, import_jsx_runtime2.jsxs)(Container, { width: 0, children: [
    t22,
    t9,
    t11
...
var CanvasLinkedBannerContent = (t0) => {
  ...
  bb0: {
    if (documentVariantType === "published") {
      let t23;
      $[0] !== t2 ? (t23 = t2("canvas.banner.linked-text.published"), $[0] = t2, $[1] = t23) : t23 = $[1], t1 = t23;
      break bb0;
    }
    if (documentVariantType === "draft") {
      let t23;
      $[2] !== t2 ? (t23 = t2("canvas.banner.linked-text.draft"), $[2] = t2, $[3] = t23) : t23 = $[3], t1 = t23;
      break bb0;
    }
    let t222;
    $[4] !== t2 ? (t222 = t2("canvas.banner.linked-text.version"), $[4] = t2, $[5] = t222) : t222 = $[5], t1 = t222;
  }
  const variantText = t1;
  let t22;
  $[6] === Symbol.for("react.memo_cache_sentinel") ? (t22 = () => setOpen(_temp$f), $[6] = t22) : t22 = $[6];
  const togglePopover = t22;
  let t3;
  $[7] === Symbol.for("react.memo_cache_sentinel") ? (t3 = () => setOpen(false), $[7] = t3) : t3 = $[7];
  const onClose = t3;
  let t4;
  $[8] !== variantText ? (t4 = (0, import_jsx_runtime2.jsx)(Text, { size: 1, weight: "medium", children: variantText }), $[8] = variantText, $[9] = t4) : t4 = $[9];
  let t5, t6;
  $[10] === Symbol.for("react.memo_cache_sentinel") ? (t5 = (0, import_jsx_runtime2.jsx)(CanvasPopoverContent, { onClose }), t6 = (0, import_jsx_runtime2.jsx)(Button2, { tooltipProps: null, mode: "bleed", tone: "default", icon: InfoOutlineIcon, onClick: togglePopover }), $[10] = t5, $[11] = t6) : (t5 = $[10], t6 = $[11]);
  let t7;
  $[12] !== open ? (t7 = (0, import_jsx_runtime2.jsx)(Popover2, { open, size: 0, tone: "default", portal: true, placement: "bottom-start", content: t5, children: t6 }), $[12] = open, $[13] = t7) : t7 = $[13];
  let t8;
  return $[14] !== t4 || $[15] !== t7 ? (t8 = (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", gap: 2, children: [
    t4,
    t7
...
function CanvasLinkedBanner() {
  const $ = (0, import_react_compiler_runtime.c)(10), {
    ...
    t: t2
  } = useTranslation(structureLocaleNamespace), id = (displayed == null ? void 0 : displayed._id) || documentId, {
    companionDoc
  } = useCanvasCompanionDoc(id), navigateToCanvas = useNavigateToCanvasDoc(companionDoc == null ? void 0 : companionDoc.canvasDocumentId, "banner");
  if (!companionDoc)
    return null;
  let t0;
...
function DocumentNotInReleaseBanner({
  ...
  const tone = getReleaseTone(currentRelease ?? LATEST), {
    ...
    createVersion
  } = useVersionOperations(), [versionCreateState, setVersionCreateState] = (0, import_react2.useState)(), toast = useToast(), handleAddToRelease = (0, import_react2.useCallback)(async () => {
    if (currentRelease._id) {
      ...
      try {
        ...
        toast.push({
          status: "error",
          closable: true,
          title: t2("banners.release.error.title"),
          description: t2("banners.release.error.description", {
            message: err.message
          })
        }), setVersionCreateState(void 0);
      }
    }
  }, [createVersion, currentRelease._id, documentId, t2, toast, value]), now = useCurrentTime(200);
  return useConditionalToast({
    status: "info",
    id: "add-document-to-release",
    enabled: (versionCreateState == null ? void 0 : versionCreateState.status) === "created" && now.getTime() - versionCreateState.lastUpdate.getTime() > TOAST_DELAY,
    closable: true,
    title: t2("banners.release.waiting.title"),
    description: t2("banners.release.waiting.description")
  }), (0, import_jsx_runtime2.jsx)(
    Banner,
    {
      tone,
      content: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(Translate, { i18nKey: "banners.release.not-in-release", t: t2, values: {
        title: ((_a = currentRelease == null ? void 0 : currentRelease.metadata) == null ? void 0 : _a.title) || tCore("release.placeholder-untitled-release")
      }, components: {
        VersionBadge: getVersionInlineBadge(currentRelease)
      } }) }),
      action: isScheduledRelease ? void 0 : {
        text: t2("banners.release.action.add-to-release"),
        tone,
...
var ObsoleteDraftBanner = (t0) => {
  const $ = (0, import_react_compiler_runtime.c)(47), {
    displayed,
    documentId,
    schemaType,
    i18nKey,
    ...
    publish,
    discardChanges
  } = useDocumentOperation(documentId, (displayed == null ? void 0 : displayed._type) || "");
  let t1;
  ...
  let t4;
  $[7] !== diffViewRouter || $[8] !== (displayed == null ? void 0 : displayed._id) || $[9] !== schemaType.name ? (t4 = () => {
    typeof (displayed == null ? void 0 : displayed._id) > "u" || diffViewRouter.navigateDiffView({
      mode: "version",
      previousDocument: {
        type: schemaType.name,
        id: getPublishedId(displayed == null ? void 0 : displayed._id)
      },
      nextDocument: {
        type: schemaType.name,
        id: getDraftId(displayed == null ? void 0 : displayed._id)
      }
    });
  }, $[7] = diffViewRouter, $[8] = displayed == null ? void 0 : displayed._id, $[9] = schemaType.name, $[10] = t4) : t4 = $[10];
...
function OpenReleaseToEditBannerInner({
  ...
  const {
    data: activeReleases
  } = useActiveReleases(), setPerspective = useSetPerspective(), releaseId = getVersionFromId(documentId) ?? "", currentVersion = (0, import_react2.useMemo)(() => activeReleases.find((version) => version._id.includes(releaseId)), [activeReleases, releaseId]), {
    t: tCore
  } = useTranslation(), {
    data: documentVersions
  } = useDocumentVersions({
    documentId
  }), documentVersionsTitleList = (0, import_react2.useMemo)(() => activeReleases.filter((version_0) => documentVersions.find((release) => {
    ...
    t: t2
  } = useTranslation(structureLocaleNamespace), handleGoToEdit = (0, import_react2.useCallback)(async () => {
    setPerspective(releaseId);
  }, [releaseId, setPerspective]);
  return (0, import_jsx_runtime2.jsx)(Banner, { tone, paddingY: 0, "data-testid": "open-release-to-edit-banner", content: (0, import_jsx_runtime2.jsxs)(Flex, { direction: "row", align: "center", justify: "space-between", flex: 1, children: [
    (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(Flex, { direction: "row", gap: 1, children: documentVersionsTitleList.length > 1 ? (0, import_jsx_runtime2.jsx)(Translate, { t: t2, i18nKey: "banners.release.navigate-to-edit-description-multiple", components: {
    ...
    } }) : (0, import_jsx_runtime2.jsx)(Translate, { t: t2, i18nKey: "banners.release.navigate-to-edit-description-single", components: {
      VersionBadge: () => (0, import_jsx_runtime2.jsxs)(VersionInlineBadge, { children: [
        " ",
        documentVersionsTitleList[0]
      ] })
    } }) }) }),
    (0, import_jsx_runtime2.jsx)(Button2, { text: t2("banners.release.action.open-to-edit"), tone, onClick: handleGoToEdit })
  ] }) });
}
...
function UnpublishedDocumentBanner() {
  ...
  if (isReleaseDocument(selectedPerspective) && willBeUnpublished) {
    let t0;
    $[0] !== ((_a = selectedPerspective.metadata) == null ? void 0 : _a.title) || $[1] !== tCore ? (t0 = ((_b = selectedPerspective.metadata) == null ? void 0 : _b.title) || tCore("release.placeholder-untitled-release"), $[0] = (_c = selectedPerspective.metadata) == null ? void 0 : _c.title, $[1] = tCore, $[2] = t0) : t0 = $[2];
    const title = t0;
    let t1;
    $[3] !== title ? (t1 = {
      title
    ...
    let t4;
    return $[9] !== t2 || $[10] !== t1 || $[11] !== t3 ? (t4 = (0, import_jsx_runtime2.jsx)(Banner, { tone: "critical", content: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(Translate, { t: t2, i18nKey: "banners.unpublished-release-banner.text", values: t1, components: t3 }) }), icon: UnpublishIcon }), $[9] = t2, $[10] = t1, $[11] = t3, $[12] = t4) : t4 = $[12], t4;
  }
  return null;
}
...
var FormView = (0, import_react2.forwardRef)(function(props, ref) {
  var _a;
  const $ = (0, import_react_compiler_runtime.c)(74), {
    hidden,
    margins
  } = props, {
    collapsedFieldSets,
    ...
    title
  } = useDocumentTitle(), [patchChannel] = (0, import_react2.useState)(_temp$e), isLocked = (_a = editState == null ? void 0 : editState.transactionSyncLock) == null ? void 0 : _a.enabled, {
    t: t2
  } = useTranslation(structureLocaleNamespace);
  let t0, t1;
  $[0] !== t2 ? (t1 = t2("document-view.form-view.sync-lock-toast.title"), $[0] = t2, $[1] = t1) : t1 = $[1];
  let t22;
  $[2] !== t2 ? (t22 = t2("document-view.form-view.sync-lock-toast.description"), $[2] = t2, $[3] = t22) : t22 = $[3];
  let t3;
  $[4] !== isLocked || $[5] !== t1 || $[6] !== t22 ? (t3 = {
    id: "sync-lock",
    status: "warning",
    enabled: isLocked,
    title: t1,
    description: t22,
    closable: true
  }, $[4] = isLocked, $[5] = t1, $[6] = t22, $[7] = t3) : t3 = $[7], t0 = t3, useConditionalToast(t0);
  let t4;
  ...
  let t5;
  $[14] !== documentId || $[15] !== documentStore || $[16] !== documentType || $[17] !== patchChannel || $[18] !== selectedReleaseId ? (t5 = [documentId, documentStore, documentType, patchChannel, selectedReleaseId], $[14] = documentId, $[15] = documentStore, $[16] = documentType, $[17] = patchChannel, $[18] = selectedReleaseId, $[19] = t5) : t5 = $[19], (0, import_react2.useEffect)(t4, t5);
  ...
  let t8;
  $[26] !== hasRev ? (t8 = [hasRev], $[26] = hasRev, $[27] = t8) : t8 = $[27], (0, import_react2.useEffect)(t7, t8);
  ...
  let t9;
  $[28] !== focusedFirstDescendant || $[29] !== formRef || $[30] !== (formState == null ? void 0 : formState.focusPath.length) || $[31] !== ready ? (t9 = () => {
    !focusedFirstDescendant && ready && !(formState == null ? void 0 : formState.focusPath.length) && formRef && (setFocusedFirstDescendant(true), focusFirstDescendant(formRef));
  }, $[28] = focusedFirstDescendant, $[29] = formRef, $[30] = formState == null ? void 0 : formState.focusPath.length, $[31] = ready, $[32] = t9) : t9 = $[32];
  const t10 = formState == null ? void 0 : formState.focusPath.length;
  let t11;
  $[33] !== focusedFirstDescendant || $[34] !== formRef || $[35] !== ready || $[36] !== t10 ? (t11 = [focusedFirstDescendant, formRef, t10, ready], $[33] = focusedFirstDescendant, $[34] = formRef, $[35] = ready, $[36] = t10, $[37] = t11) : t11 = $[37], (0, import_react2.useEffect)(t9, t11);
  let t12;
  $[38] !== ref ? (t12 = (node) => {
    setFormRef(node), typeof ref == "function" ? ref(node) : ref && (ref.current = node);
  }, $[38] = ref, $[39] = t12) : t12 = $[39];
  const setRef = t12, isReadOnly = connectionState === "reconnecting" || (formState == null ? void 0 : formState.readOnly) || !(editState == null ? void 0 : editState.ready), t13 = isReadOnly ? "true" : void 0;
  let t14;
  $[40] !== collapsedFieldSets || $[41] !== collapsedPaths || $[42] !== connectionState || $[43] !== documentId || $[44] !== (editState == null ? void 0 : editState.draft) || $[45] !== (editState == null ? void 0 : editState.published) || $[46] !== fieldActions || $[47] !== formState || $[48] !== hidden || $[49] !== isReadOnly || $[50] !== onBlur || $[51] !== onChange || $[52] !== onFocus || $[53] !== onPathOpen || $[54] !== onSetActiveFieldGroup || $[55] !== onSetCollapsedFieldSet || $[56] !== onSetCollapsedPath || $[57] !== openPath || $[58] !== patchChannel || $[59] !== presence || $[60] !== t2 || $[61] !== title || $[62] !== validation ? (t14 = connectionState === "connecting" && !(editState == null ? void 0 : editState.draft) && !(editState == null ? void 0 : editState.published) ? (0, import_jsx_runtime2.jsx)(Delay, { ms: 300, children: (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", direction: "column", height: "fill", justify: "center", children: [
  ...
  ] }), $[40] = collapsedFieldSets, $[41] = collapsedPaths, $[42] = connectionState, $[43] = documentId, $[44] = editState == null ? void 0 : editState.draft, $[45] = editState == null ? void 0 : editState.published, $[46] = fieldActions, $[47] = formState, $[48] = hidden, $[49] = isReadOnly, $[50] = onBlur, $[51] = onChange, $[52] = onFocus, $[53] = onPathOpen, $[54] = onSetActiveFieldGroup, $[55] = onSetCollapsedFieldSet, $[56] = onSetCollapsedPath, $[57] = openPath, $[58] = patchChannel, $[59] = presence, $[60] = t2, $[61] = title, $[62] = validation, $[63] = t14) : t14 = $[63];
  let t15;
  $[64] !== setRef || $[65] !== t13 || $[66] !== t14 ? (t15 = (0, import_jsx_runtime2.jsx)(Box, { as: "form", onSubmit: preventDefault, ref: setRef, "data-testid": "form-view", "data-read-only": t13, children: t14 }), $[64] = setRef, $[65] = t13, $[66] = t14, $[67] = t15) : t15 = $[67];
  let t16;
  $[68] !== margins || $[69] !== t15 ? (t16 = (0, import_jsx_runtime2.jsx)(PresenceOverlay, { margins, children: t15 }), $[68] = margins, $[69] = t15, $[70] = t16) : t16 = $[70];
  let t17;
  return $[71] !== hidden || $[72] !== t16 ? (t17 = (0, import_jsx_runtime2.jsx)(Container, { hidden, paddingX: 4, paddingTop: 5, paddingBottom: 9, sizing: "border", width: 1, children: t16 }), $[71] = hidden, $[72] = t16, $[73] = t17) : t17 = $[73], t17;
});
...
function DocumentHeaderTab(props) {
  ...
  const handleClick = t0, t1 = !ready && !(editState == null ? void 0 : editState.draft) && !(editState == null ? void 0 : editState.published);
  let t2;
...
function DocumentHeaderTitle() {
  ...
  if (connectionState === "connecting" && !subscribed) {
    let t12;
    return $[4] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, {}), $[4] = t12) : t12 = $[4], t12;
  }
  if (title) {
    let t12;
    return $[5] !== title ? (t12 = (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: title }), $[5] = title, $[6] = t12) : t12 = $[6], t12;
  }
  if (!documentValue) {
    const t12 = (schemaType == null ? void 0 : schemaType.title) || (schemaType == null ? void 0 : schemaType.name);
    let t222;
    ...
    let t3;
    return $[10] !== t222 ? (t3 = (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: t222 }), $[10] = t222, $[11] = t3) : t3 = $[11], t3;
  }
  if (error) {
    let t12;
    $[12] !== error.message || $[13] !== t2 ? (t12 = t2("panes.document-header-title.error.text", {
      error: error.message
    }), $[12] = error.message, $[13] = t2, $[14] = t12) : t12 = $[14];
    let t222;
    return $[15] !== t12 ? (t222 = (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: t12 }), $[15] = t12, $[16] = t222) : t222 = $[16], t222;
  }
  let t1;
  $[17] !== t2 || $[18] !== (value == null ? void 0 : value.title) ? (t1 = (value == null ? void 0 : value.title) || (0, import_jsx_runtime2.jsx)("span", { style: {
    color: "var(--card-muted-fg-color)"
  }, children: t2("panes.document-header-title.untitled.text") }), $[17] = t2, $[18] = value == null ? void 0 : value.title, $[19] = t1) : t1 = $[19];
  let t22;
  return $[20] !== t1 ? (t22 = (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: t1 }), $[20] = t1, $[21] = t22) : t22 = $[21], t22;
}
...
var DocumentPanelSubHeader = (0, import_react2.memo)(function() {
  ...
  let t0;
  $[0] !== documentId ? (t0 = getPublishedId(documentId), $[0] = documentId, $[1] = t0) : t0 = $[1];
  const publishedDocId = t0, showTabs = views2.length > 1, {
    collapsed,
    isLast
  ...
  let t1, t22;
  $[2] === Symbol.for("react.memo_cache_sentinel") ? (t22 = (0, import_jsx_runtime2.jsx)(DocumentHeaderTitle, {}), $[2] = t22) : t22 = $[2], t1 = t22;
  const title = t1;
  let t3, t4;
  $[3] !== showTabs ? (t4 = showTabs && (0, import_jsx_runtime2.jsx)(DocumentHeaderTabs, {}), $[3] = showTabs, $[4] = t4) : t4 = $[4], t3 = t4;
  const tabs = t3;
  let t5, t6;
  $[5] !== BackLink2 || $[6] !== showBackButton || $[7] !== t2 ? (t6 = showBackButton && (0, import_jsx_runtime2.jsx)(Button2, { as: BackLink2, "data-as": "a", icon: ArrowLeftIcon, mode: "bleed", tooltipProps: {
    content: t2("pane-header.back-button.text")
  } }), $[5] = BackLink2, $[6] = showBackButton, $[7] = t2, $[8] = t6) : t6 = $[8], t5 = t6;
  const backButton = t5, t7 = (displayed == null ? void 0 : displayed._type) ?? "";
  let t8;
  ...
  const t9 = t8.join("."), t10 = ((editState == null ? void 0 : editState.ready) && (editState.version ?? editState.draft ?? editState.published) !== null) ?? false;
  let t11;
  $[12] !== activeWorkspace.dataset || $[13] !== activeWorkspace.name || $[14] !== activeWorkspace.projectId || $[15] !== publishedDocId || $[16] !== t10 || $[17] !== t7 || $[18] !== t9 ? (t11 = (0, import_jsx_runtime2.jsx)(CapabilityGate, { capability: "comlink", condition: "available", children: (0, import_jsx_runtime2.jsx)(FavoriteToggle, { resourceType: "studio", documentId: publishedDocId, documentType: t7, resourceId: t9, schemaName: activeWorkspace.name, projectId: activeWorkspace.projectId, dataset: activeWorkspace.dataset, documentExists: t10 }) }), $[12] = activeWorkspace.dataset, $[13] = activeWorkspace.name, $[14] = activeWorkspace.projectId, $[15] = publishedDocId, $[16] = t10, $[17] = t7, $[18] = t9, $[19] = t11) : t11 = $[19];
  const favoriteToggle = t11, t12 = connectionState === "connecting" && !(editState == null ? void 0 : editState.draft) && !(editState == null ? void 0 : editState.published);
  let t13;
  return $[20] !== backButton || $[21] !== favoriteToggle || $[22] !== t12 || $[23] !== tabIndex || $[24] !== tabs ? (t13 = (0, import_jsx_runtime2.jsx)(PaneHeader$1, { loading: t12, title, tabs, tabIndex, backButton, appendTitle: favoriteToggle }), $[20] = backButton, $[21] = favoriteToggle, $[22] = t12, $[23] = tabIndex, $[24] = tabs, $[25] = t13) : t13 = $[25], t13;
});
...
var DocumentPanel = function(props) {
  ...
  let t1, t2;
  $[2] !== activeViewId || $[3] !== views2 ? (t2 = views2.find((view) => view.id === activeViewId) || views2[0] || {
    type: "form"
  }, $[2] = activeViewId, $[3] = views2, $[4] = t2) : t2 = $[4], t1 = t2;
  ...
  let t4;
  $[9] !== activeView.component || $[10] !== activeView.options || $[11] !== activeView.type || $[12] !== displayed || $[13] !== documentId || $[14] !== (editState == null ? void 0 : editState.draft) || $[15] !== (editState == null ? void 0 : editState.published) || $[16] !== schemaType || $[17] !== value ? (t4 = () => {
    ...
    return false;
  }, $[9] = activeView.component, $[10] = activeView.options, $[11] = activeView.type, $[12] = displayed, $[13] = documentId, $[14] = editState == null ? void 0 : editState.draft, $[15] = editState == null ? void 0 : editState.published, $[16] = schemaType, $[17] = value, $[18] = t4) : t4 = $[18];
  let t5;
  $[19] !== t4 ? (t5 = t4(), $[19] = t4, $[20] = t5) : t5 = $[20];
  const activeViewNode = t5;
  let t6;
  $[21] !== documentScrollElement ? (t6 = () => {
    (documentScrollElement == null ? void 0 : documentScrollElement.scrollTo) && documentScrollElement.scrollTo(0, 0);
  }, $[21] = documentScrollElement, $[22] = t6) : t6 = $[22];
  let t7;
  $[23] !== documentId || $[24] !== documentScrollElement ? (t7 = [documentId, documentScrollElement], $[23] = documentId, $[24] = documentScrollElement, $[25] = t7) : t7 = $[25], (0, import_react2.useEffect)(t6, t7);
  let t8, t9;
  $[26] !== portalElement || $[27] !== setDocumentPanelPortalElement ? (t8 = () => {
    portalElement && setDocumentPanelPortalElement(portalElement);
  }, t9 = [portalElement, setDocumentPanelPortalElement], $[26] = portalElement, $[27] = setDocumentPanelPortalElement, $[28] = t8, $[29] = t9) : (t8 = $[28], t9 = $[29]), (0, import_react2.useEffect)(t8, t9);
  let t10, t11;
  $[30] !== displayed || $[31] !== isInspectOpen || $[32] !== value ? (t11 = isInspectOpen ? (0, import_jsx_runtime2.jsx)(InspectDialog, { value: displayed || value }) : null, $[30] = displayed, $[31] = isInspectOpen, $[32] = value, $[33] = t11) : t11 = $[33], t10 = t11;
  ...
  let t12;
  bb1: {
    if (params == null ? void 0 : params.historyVersion) {
      let t133;
      $[34] === Symbol.for("react.memo_cache_sentinel") ? (t133 = (0, import_jsx_runtime2.jsx)(ArchivedReleaseDocumentBanner, {}), $[34] = t133) : t133 = $[34], t12 = t133;
      break bb1;
    }
    let t132;
    ...
    const isScheduledRelease = t132, documentInScheduledRelease = !!(isScheduledRelease && (displayed == null ? void 0 : displayed._id) && getVersionFromId(displayed == null ? void 0 : displayed._id) === selectedReleaseId);
    ...
    if (documentInScheduledRelease) {
      ...
      let t162;
      $[48] !== t153 ? (t162 = (0, import_jsx_runtime2.jsx)(ScheduledReleaseBanner, { currentRelease: t153 }), $[48] = t153, $[49] = t162) : t162 = $[49], t12 = t162;
      break bb1;
    }
    let t152;
    ...
    if ((displayed == null ? void 0 : displayed._id) && getVersionFromId(displayed._id) !== selectedReleaseId && ready && !isPinnedDraftOrPublish && isNewDocument(editState) === false) {
      const t162 = selectedPerspective, t172 = displayed || void 0;
      let t182;
      $[52] !== isScheduledRelease || $[53] !== t162 || $[54] !== t172 || $[55] !== value._id ? (t182 = (0, import_jsx_runtime2.jsx)(DocumentNotInReleaseBanner, { documentId: value._id, currentRelease: t162, value: t172, isScheduledRelease }), $[52] = isScheduledRelease, $[53] = t162, $[54] = t172, $[55] = value._id, $[56] = t182) : t182 = $[56], t12 = t182;
      break bb1;
    }
    ...
    if (activeView.type === "form" && !selectedReleaseId && displayedHasObsoleteDraft.result) {
      if (displayedHasObsoleteDraft.reason === "DRAFT_MODEL_INACTIVE") {
        let t162;
        $[57] !== displayed || $[58] !== documentId || $[59] !== schemaType ? (t162 = (0, import_jsx_runtime2.jsx)(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.obsolete-draft.draft-model-inactive.text" }), $[57] = displayed, $[58] = documentId, $[59] = schemaType, $[60] = t162) : t162 = $[60], t12 = t162;
        break bb1;
      }
      if (displayedHasObsoleteDraft.reason === "LIVE_EDIT_ACTIVE") {
        let t162;
        $[61] !== displayed || $[62] !== documentId || $[63] !== schemaType ? (t162 = (0, import_jsx_runtime2.jsx)(ObsoleteDraftBanner, { displayed, documentId, schemaType, i18nKey: "banners.live-edit-draft-banner.text", isEditBlocking: true }), $[61] = displayed, $[62] = documentId, $[63] = schemaType, $[64] = t162) : t162 = $[64], t12 = t162;
        break bb1;
      }
    }
    ...
    let t16;
    $[65] !== showCreateBanner ? (t16 = showCreateBanner && (0, import_jsx_runtime2.jsx)(CreateLinkedBanner, {}), $[65] = showCreateBanner, $[66] = t16) : t16 = $[66];
    let t17;
    $[67] !== (permissions == null ? void 0 : permissions.granted) || $[68] !== requiredPermission ? (t17 = !(permissions == null ? void 0 : permissions.granted) && (0, import_jsx_runtime2.jsx)(InsufficientPermissionBanner, { requiredPermission }), $[67] = permissions == null ? void 0 : permissions.granted, $[68] = requiredPermission, $[69] = t17) : t17 = $[69];
    let t18, t19, t20, t21, t22, t23;
    $[70] === Symbol.for("react.memo_cache_sentinel") ? (t18 = (0, import_jsx_runtime2.jsx)(RevisionNotFoundBanner, {}), t19 = (0, import_jsx_runtime2.jsx)(ReferenceChangedBanner, {}), t20 = (0, import_jsx_runtime2.jsx)(DeprecatedDocumentTypeBanner, {}), t21 = (0, import_jsx_runtime2.jsx)(CanvasLinkedBanner, {}), t22 = (0, import_jsx_runtime2.jsx)(DeletedDocumentBanners, {}), t23 = (0, import_jsx_runtime2.jsx)(UnpublishedDocumentBanner, {}), $[70] = t18, $[71] = t19, $[72] = t20, $[73] = t21, $[74] = t22, $[75] = t23) : (t18 = $[70], t19 = $[71], t20 = $[72], t21 = $[73], t22 = $[74], t23 = $[75]);
    const t24 = (displayed == null ? void 0 : displayed._id) ?? documentId;
    let t25;
    $[76] !== isPinnedDraftOrPublish || $[77] !== t24 ? (t25 = (0, import_jsx_runtime2.jsx)(OpenReleaseToEditBanner, { documentId: t24, isPinnedDraftOrPublished: isPinnedDraftOrPublish }), $[76] = isPinnedDraftOrPublish, $[77] = t24, $[78] = t25) : t25 = $[78];
    let t26;
    $[79] !== t16 || $[80] !== t17 || $[81] !== t25 ? (t26 = (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      t16,
      t17,
      t18,
      t19,
  ...
  let t13;
  $[83] !== activeViewNode || $[84] !== banners || $[85] !== documentScrollElement || $[86] !== footer || $[87] !== formViewHidden || $[88] !== inspectDialog || $[89] !== layoutCollapsed || $[90] !== margins || $[91] !== portalElement || $[92] !== showFormView ? (t13 = showFormView && (0, import_jsx_runtime2.jsxs)(Flex, { height: "fill", direction: "column", width: "fill", flex: 2, children: [
    ...
    (0, import_jsx_runtime2.jsx)(DocumentBox, { flex: 2, overflow: "hidden", children: (0, import_jsx_runtime2.jsx)(PortalProvider, { element: portalElement, __unstable_elements: {
      documentScrollElement
    }, children: (0, import_jsx_runtime2.jsx)(BoundaryElementProvider, { element: documentScrollElement, children: (0, import_jsx_runtime2.jsxs)(VirtualizerScrollInstanceProvider, { scrollElement: documentScrollElement, containerElement: formContainerElement, children: [
  ...
  let t14;
  $[94] !== documentId || $[95] !== rootElement || $[96] !== schemaType || $[97] !== showInspector ? (t14 = showInspector && (0, import_jsx_runtime2.jsx)(BoundaryElementProvider, { element: rootElement, children: (0, import_jsx_runtime2.jsx)(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[94] = documentId, $[95] = rootElement, $[96] = schemaType, $[97] = showInspector, $[98] = t14) : t14 = $[98];
  let t15;
  return $[99] !== t13 || $[100] !== t14 ? (t15 = (0, import_jsx_runtime2.jsx)(PaneContent, { children: (0, import_jsx_runtime2.jsxs)(Flex, { height: "fill", children: [
    t13,
    t14
...
function ConfirmDialog(props) {
  ...
  let t0;
  $[0] !== dialog ? (t0 = (0, import_jsx_runtime2.jsx)(ConfirmDialogContent, { dialog }), $[0] = dialog, $[1] = t0) : t0 = $[1];
  let t1;
...
function ConfirmDialogContent(props) {
  ...
  let t22;
  $[4] === Symbol.for("react.memo_cache_sentinel") ? (t22 = {
    minWidth: 304,
    maxWidth: 400
  }, $[4] = t22) : t22 = $[4];
  let t3;
  $[5] !== message ? (t3 = (0, import_jsx_runtime2.jsx)(Box, { flex: 1, overflow: "auto", padding: 4, children: (0, import_jsx_runtime2.jsx)(Text, { children: message }) }), $[5] = message, $[6] = t3) : t3 = $[6];
  let t4;
  $[7] === Symbol.for("react.memo_cache_sentinel") ? (t4 = {
    borderTop: "1px solid var(--card-border-color)"
  }, $[7] = t4) : t4 = $[7];
  let t5;
  $[8] !== cancelButtonText || $[9] !== t2 ? (t5 = cancelButtonText || t2("confirm-dialog.cancel-button.fallback-text"), $[8] = cancelButtonText, $[9] = t2, $[10] = t5) : t5 = $[10];
  let t6;
  $[11] !== cancelButtonIcon || $[12] !== onCancel || $[13] !== t5 ? (t6 = (0, import_jsx_runtime2.jsx)(Button, { "data-testid": "confirm-dialog-cancel-button", icon: cancelButtonIcon, onClick: onCancel, mode: "ghost", text: t5 }), $[11] = cancelButtonIcon, $[12] = onCancel, $[13] = t5, $[14] = t6) : t6 = $[14];
  let t7;
  $[15] !== confirmButtonText || $[16] !== t2 ? (t7 = confirmButtonText || t2("confirm-dialog.confirm-button.fallback-text"), $[15] = confirmButtonText, $[16] = t2, $[17] = t7) : t7 = $[17];
  let t8;
  $[18] !== confirmButtonIcon || $[19] !== onConfirm || $[20] !== t7 || $[21] !== tone ? (t8 = (0, import_jsx_runtime2.jsx)(Button, { "data-testid": "confirm-dialog-confirm-button", icon: confirmButtonIcon, onClick: onConfirm, text: t7, tone }), $[18] = confirmButtonIcon, $[19] = onConfirm, $[20] = t7, $[21] = tone, $[22] = t8) : t8 = $[22];
  let t9;
  $[23] !== t6 || $[24] !== t8 ? (t9 = (0, import_jsx_runtime2.jsx)(Box, { paddingX: 4, paddingY: 3, style: t4, children: (0, import_jsx_runtime2.jsxs)(Grid, { columns: 2, gap: 2, children: [
    t6,
    t8
  ] }) }), $[23] = t6, $[24] = t8, $[25] = t9) : t9 = $[25];
  let t10;
  return $[26] !== t3 || $[27] !== t9 ? (t10 = (0, import_jsx_runtime2.jsxs)(Flex, { direction: "column", ref, style: t22, children: [
    t3,
    t9
...
function DocumentActionPortalProvider(props) {
  const $ = (0, import_react_compiler_runtime.c)(3), {
    ...
    element,
    elements
  } = usePortal(), portalElement = (elements == null ? void 0 : elements[DOCUMENT_PANEL_PORTAL_ELEMENT]) || element;
  let t0;
...
function ActionStateDialog(props) {
  ...
  if (dialog.type === "custom") {
    const t12 = dialog == null ? void 0 : dialog.component;
    let t22;
...
var ActionDialogWrapper = (0, import_react2.memo)(function(t0) {
  const $ = (0, import_react_compiler_runtime.c)(9), {
    ...
    children,
    referenceElement
  } = t0, [actionIndex, setActionIndex] = (0, import_react2.useState)(-1);
  let t1;
  ...
  const result = t3;
  let t5;
  $[3] !== currentAction || $[4] !== referenceElement ? (t5 = currentAction && currentAction.dialog && (0, import_jsx_runtime2.jsx)(LegacyLayerProvider, { zOffset: "paneFooter", children: (0, import_jsx_runtime2.jsx)(ActionStateDialog, { dialog: currentAction.dialog, referenceElement }) }), $[3] = currentAction, $[4] = referenceElement, $[5] = t5) : t5 = $[5];
  let t6;
  return $[6] !== result || $[7] !== t5 ? (t6 = (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    t5,
    result
...
function ActionMenuButton(props) {
  ...
  let t22;
  $[1] !== actionStates || $[2] !== disabled || $[3] !== idPrefix || $[4] !== t2 ? (t22 = (t32) => {
    const {
      handleAction
    } = t32;
  ...
  }, $[1] = actionStates, $[2] = disabled, $[3] = idPrefix, $[4] = t2, $[5] = t22) : t22 = $[5];
  const renderActionDialog = t22;
  let t3;
  return $[6] !== actionStates || $[7] !== referenceElement || $[8] !== renderActionDialog ? (t3 = (0, import_jsx_runtime2.jsx)(ActionDialogWrapper, { actionStates, referenceElement, children: renderActionDialog }), $[6] = actionStates, $[7] = referenceElement, $[8] = renderActionDialog, $[9] = t3) : t3 = $[9], t3;
}
...
var DeleteAction = (t0) => {
  const $ = (0, import_react_compiler_runtime.c)(36), {
    ...
    delete: deleteOp
  } = useDocumentOperation(id, type, release), [isDeleting, setIsDeleting] = (0, import_react2.useState)(false), [isConfirmDialogOpen, setConfirmDialogOpen] = (0, import_react2.useState)(false), {
    t: t2
  } = useTranslation(structureLocaleNamespace);
  let t1;
  $[0] !== onComplete ? (t1 = () => {
  ...
  let t22;
  $[2] !== deleteOp || $[3] !== onComplete || $[4] !== paneSetIsDeleting ? (t22 = () => {
    setIsDeleting(true), setConfirmDialogOpen(false), paneSetIsDeleting(true), deleteOp.execute(), onComplete();
  }, $[2] = deleteOp, $[3] = onComplete, $[4] = paneSetIsDeleting, $[5] = t22) : t22 = $[5];
  const handleConfirm = t22;
  let t3;
  $[6] === Symbol.for("react.memo_cache_sentinel") ? (t3 = () => {
  ...
  bb0: {
    if (!isPermissionsLoading && !(permissions == null ? void 0 : permissions.granted)) {
      let t62;
      $[11] !== t2 ? (t62 = t2("action.delete.label"), $[11] = t2, $[12] = t62) : t62 = $[12];
      let t72;
      $[13] !== currentUser ? (t72 = (0, import_jsx_runtime2.jsx)(InsufficientPermissionsMessage, { context: "delete-document", currentUser }), $[13] = currentUser, $[14] = t72) : t72 = $[14];
      let t82;
      $[15] !== t62 || $[16] !== t72 ? (t82 = {
        tone: "critical",
        icon: TrashIcon,
    ...
    let t7;
    $[18] !== deleteOp.disabled || $[19] !== t2 ? (t7 = deleteOp.disabled && t2(DISABLED_REASON_TITLE_KEY$1[deleteOp.disabled]) || "", $[18] = deleteOp.disabled, $[19] = t2, $[20] = t7) : t7 = $[20];
    let t8;
    $[21] !== isDeleting || $[22] !== t2 ? (t8 = t2(isDeleting ? "action.delete.running.label" : "action.delete.label"), $[21] = isDeleting, $[22] = t2, $[23] = t8) : t8 = $[23];
    let t9;
    $[24] !== (draft == null ? void 0 : draft._id) || $[25] !== handleCancel || $[26] !== handleConfirm || $[27] !== id || $[28] !== isConfirmDialogOpen || $[29] !== type ? (t9 = isConfirmDialogOpen && {
      type: "custom",
      component: (0, import_jsx_runtime2.jsx)(ConfirmDeleteDialogContainer, { action: "delete", id: (draft == null ? void 0 : draft._id) || id, type, onCancel: handleCancel, onConfirm: handleConfirm })
    }, $[24] = draft == null ? void 0 : draft._id, $[25] = handleCancel, $[26] = handleConfirm, $[27] = id, $[28] = isConfirmDialogOpen, $[29] = type, $[30] = t9) : t9 = $[30];
    let t10;
...
var DiscardChangesAction = ({
  ...
  const {
    discardChanges
  } = useDocumentOperation(id, type, release), [isConfirmDialogOpen, setConfirmDialogOpen] = (0, import_react2.useState)(false), [permissions, isPermissionsLoading] = useDocumentPairPermissions({
    id,
    type,
    version: release,
    ...
    t: t2
  } = useTranslation(structureLocaleNamespace), isPublished = (displayed == null ? void 0 : displayed._id) && isPublishedId(displayed == null ? void 0 : displayed._id), handleConfirm = (0, import_react2.useCallback)(() => {
    ...
    message: t2("action.discard-changes.confirm-dialog.confirm-discard-changes")
  }, [handleConfirm, isConfirmDialogOpen, onComplete, t2]);
  return (0, import_react2.useMemo)(() => !published || liveEdit || isPublished ? null : !isPermissionsLoading && !(permissions == null ? void 0 : permissions.granted) ? {
    tone: "critical",
    icon: ResetIcon,
    disabled: true,
    label: t2("action.discard-changes.label"),
    title: (0, import_jsx_runtime2.jsx)(InsufficientPermissionsMessage, { context: "discard-changes", currentUser })
  } : {
    tone: "critical",
    icon: ResetIcon,
    disabled: !!discardChanges.disabled || isPermissionsLoading,
    title: t2(discardChanges.disabled && DISABLED_REASON_KEY$2[discardChanges.disabled] || ""),
    label: t2("action.discard-changes.label"),
    onHandle: handle,
    dialog
  }, [currentUser, dialog, discardChanges.disabled, handle, isPermissionsLoading, isPublished, liveEdit, permissions == null ? void 0 : permissions.granted, published, t2]);
};
...
var DuplicateAction = ({
  ...
  const documentStore = useDocumentStore(), {
    ...
    navigateIntent
  } = useRouter(), [isDuplicating, setDuplicating] = (0, import_react2.useState)(false), [permissions, isPermissionsLoading] = useDocumentPairPermissions({
    id,
    type,
    version: release,
    ...
    t: t2
  } = useTranslation(structureLocaleNamespace), currentUser = useCurrentUser(), handle = (0, import_react2.useCallback)(async () => {
  ...
  return (0, import_react2.useMemo)(() => !isPermissionsLoading && !(permissions == null ? void 0 : permissions.granted) ? {
    icon: CopyIcon,
    disabled: true,
    label: t2("action.duplicate.label"),
    title: (0, import_jsx_runtime2.jsx)(InsufficientPermissionsMessage, { context: "duplicate-document", currentUser })
  } : {
    icon: CopyIcon,
    disabled: isDuplicating || !!duplicate.disabled || isPermissionsLoading,
    label: t2(isDuplicating ? "action.duplicate.running.label" : "action.duplicate.label"),
    title: duplicate.disabled ? t2(DISABLED_REASON_KEY$1[duplicate.disabled]) : "",
    onHandle: handle
  }, [currentUser, duplicate.disabled, handle, isDuplicating, isPermissionsLoading, permissions == null ? void 0 : permissions.granted, t2]);
};
DuplicateAction.action = "duplicate";
DuplicateAction.displayName = "DuplicateAction";
var HistoryRestoreAction = (t0) => {
  const $ = (0, import_react_compiler_runtime.c)(27), {
    id,
    type,
    revision,
  ...
  let t22, t3;
  $[4] !== event || $[5] !== id || $[6] !== navigateIntent || $[7] !== type ? (t22 = () => {
    !event || event === prevEvent.current || (event.type === "success" && event.op === "restore" && navigateIntent("edit", {
      id,
      type
    }), prevEvent.current = event);
  }, t3 = [event, id, navigateIntent, type], $[4] = event, $[5] = id, $[6] = navigateIntent, $[7] = type, $[8] = t22, $[9] = t3) : (t22 = $[8], t3 = $[9]), (0, import_react2.useEffect)(t22, t3);
  let t4;
  ...
  bb0: {
    if (isConfirmDialogOpen) {
      let t62;
      $[11] !== t2 ? (t62 = t2("action.restore.confirm.message"), $[11] = t2, $[12] = t62) : t62 = $[12];
      let t7;
...
function AlreadyPublished(t0) {
  ...
  let t3;
  return $[4] !== t22 ? (t3 = (0, import_jsx_runtime2.jsx)("span", { children: t22 }), $[4] = t22, $[5] = t3) : t3 = $[5], t3;
}
var PublishAction = (props) => {
  ...
  let t0;
  $[0] !== (editState == null ? void 0 : editState.draft) || $[1] !== (editState == null ? void 0 : editState.published) ? (t0 = (editState == null ? void 0 : editState.draft) || (editState == null ? void 0 : editState.published) || {}, $[0] = editState == null ? void 0 : editState.draft, $[1] = editState == null ? void 0 : editState.published, $[2] = t0) : t0 = $[2];
  ...
  const hasValidationErrors = t1, [publishScheduled, setPublishScheduled] = (0, import_react2.useState)(false), isSyncing = syncState.isSyncing, isValidating = validationStatus.isValidating;
  let t22;
  $[5] !== id || $[6] !== type ? (t22 = {
    id,
    type,
    permission: "publish"
  }, $[5] = id, $[6] = type, $[7] = t22) : t22 = $[7];
  const [permissions, isPermissionsLoading] = useDocumentPairPermissions(t22), currentUser = useCurrentUser();
  let t3;
  $[8] !== hasValidationErrors || $[9] !== publish.disabled || $[10] !== published || $[11] !== t2 ? (t3 = publish.disabled ? getDisabledReason(publish.disabled, (published || {})._updatedAt, t2) || "" : hasValidationErrors ? t2("action.publish.validation-issues.tooltip") : "", $[8] = hasValidationErrors, $[9] = publish.disabled, $[10] = published, $[11] = t2, $[12] = t3) : t3 = $[12];
  ...
  let t6;
  $[23] !== doPublish || $[24] !== hasValidationErrors || $[25] !== isSyncing || $[26] !== isValidating || $[27] !== publishScheduled || $[28] !== revision || $[29] !== validationStatus.isValidating || $[30] !== validationStatus.revision ? (t6 = [isSyncing, doPublish, hasValidationErrors, publishScheduled, validationStatus.revision, revision, isValidating, validationStatus.isValidating], $[23] = doPublish, $[24] = hasValidationErrors, $[25] = isSyncing, $[26] = isValidating, $[27] = publishScheduled, $[28] = revision, $[29] = validationStatus.isValidating, $[30] = validationStatus.revision, $[31] = t6) : t6 = $[31], (0, import_react2.useEffect)(t5, t6);
  let t7;
  ...
  let t8;
  $[35] !== changesOpen || $[36] !== hasDraft || $[37] !== publishState ? (t8 = [changesOpen, publishState, hasDraft], $[35] = changesOpen, $[36] = hasDraft, $[37] = publishState, $[38] = t8) : t8 = $[38], (0, import_react2.useEffect)(t7, t8);
  const telemetry = useTelemetry();
  let t9;
  $[39] !== doPublish || $[40] !== (draft == null ? void 0 : draft._createdAt) || $[41] !== published || $[42] !== revision || $[43] !== syncState.isSyncing || $[44] !== telemetry || $[45] !== validationStatus.isValidating || $[46] !== validationStatus.revision ? (t9 = () => {
    telemetry.log(DocumentPublished, {
      publishedImmediately: !(draft == null ? void 0 : draft._createdAt),
  ...
  }, $[39] = doPublish, $[40] = draft == null ? void 0 : draft._createdAt, $[41] = published, $[42] = revision, $[43] = syncState.isSyncing, $[44] = telemetry, $[45] = validationStatus.isValidating, $[46] = validationStatus.revision, $[47] = t9) : t9 = $[47];
  const handle = t9;
  let t10;
  bb0: {
    if (release) {
    ...
    if (isPublishedId(value._id) && draft !== null) {
      let t112;
      $[48] !== t2 ? (t112 = t2("action.publish.label"), $[48] = t2, $[49] = t112) : t112 = $[49];
      const t122 = published == null ? void 0 : published._updatedAt;
      let t132;
      $[50] !== t2 || $[51] !== t122 ? (t132 = getDisabledReason("ALREADY_PUBLISHED", t122, t2), $[50] = t2, $[51] = t122, $[52] = t132) : t132 = $[52];
      let t142;
    ...
    if (!isPermissionsLoading && !(permissions == null ? void 0 : permissions.granted)) {
      let t112;
      $[56] !== t2 ? (t112 = t2("action.publish.label"), $[56] = t2, $[57] = t112) : t112 = $[57];
      let t122;
      $[58] !== currentUser ? (t122 = (0, import_jsx_runtime2.jsx)(InsufficientPermissionsMessage, { context: "publish-document", currentUser }), $[58] = currentUser, $[59] = t122) : t122 = $[59];
      let t132;
    ...
    const disabled = !!(publishScheduled || ((_a = editState == null ? void 0 : editState.transactionSyncLock) == null ? void 0 : _a.enabled) || publishState === "publishing" || publishState === "published" || hasValidationErrors || publish.disabled), t11 = disabled || isPermissionsLoading;
    let t12;
    $[63] !== publishScheduled || $[64] !== publishState || $[65] !== t2 ? (t12 = t2(publishState === "published" ? "action.publish.published.label" : publishScheduled || publishState === "publishing" ? "action.publish.running.label" : "action.publish.draft.label"), $[63] = publishScheduled, $[64] = publishState, $[65] = t2, $[66] = t12) : t12 = $[66];
    let t13;
    $[67] !== publishScheduled || $[68] !== publishState || $[69] !== t2 || $[70] !== title ? (t13 = publishScheduled ? t2("action.publish.waiting") : publishState === "published" || publishState === "publishing" ? null : title, $[67] = publishScheduled, $[68] = publishState, $[69] = t2, $[70] = title, $[71] = t13) : t13 = $[71];
...
var UnpublishAction = ({
  ...
  const {
    unpublish
  } = useDocumentOperation(id, type), [isConfirmDialogOpen, setConfirmDialogOpen] = (0, import_react2.useState)(false), [permissions, isPermissionsLoading] = useDocumentPairPermissions({
    id,
    type,
    ...
    t: t2
  } = useTranslation(structureLocaleNamespace), isDraft = (displayed == null ? void 0 : displayed._id) && isDraftId(displayed == null ? void 0 : displayed._id), handleCancel = (0, import_react2.useCallback)(() => {
    setConfirmDialogOpen(false), onComplete();
  ...
  return (0, import_react2.useMemo)(() => release || isDraft || liveEdit ? null : !isPermissionsLoading && !(permissions == null ? void 0 : permissions.granted) ? {
    tone: "critical",
    icon: UnpublishIcon,
    label: "Unpublish",
    ...
    dialog
  }, [release, isDraft, liveEdit, isPermissionsLoading, permissions == null ? void 0 : permissions.granted, unpublish.disabled, t2, dialog, currentUser]);
};
...
var DocumentStatusBarActionsInner = (0, import_react2.memo)(function(props) {
  ...
  const tooltipContent = t0, showFirstActionButton = selectedReleaseId ? firstActionState && !isSanityDefinedAction(firstActionState) : firstActionState && !(editState == null ? void 0 : editState.liveEdit);
  let t1, t2;
  ...
  let t4;
  $[15] !== disabled || $[16] !== firstActionState || $[17] !== showFirstActionButton || $[18] !== tooltipContent ? (t4 = showFirstActionButton && (0, import_jsx_runtime2.jsx)(LayerProvider, { zOffset: 200, children: (0, import_jsx_runtime2.jsx)(Tooltip, { disabled: !tooltipContent, content: tooltipContent, placement: "top", children: (0, import_jsx_runtime2.jsx)(Stack, { children: (0, import_jsx_runtime2.jsx)(Button2, { "data-testid": `action-${toLowerCaseNoSpaces(firstActionState.label)}`, disabled: disabled || !!firstActionState.disabled, icon: firstActionState.icon, onClick: firstActionState.onHandle, ref: setButtonElement, text: firstActionState.label, tone: firstActionState.tone || "primary" }) }) }) }), $[15] = disabled, $[16] = firstActionState, $[17] = showFirstActionButton, $[18] = tooltipContent, $[19] = t4) : t4 = $[19];
  let t5;
  $[20] !== disabled || $[21] !== menuActionStates || $[22] !== showMenu || $[23] !== sideMenuItems ? (t5 = showMenu && menuActionStates.length > 0 && (0, import_jsx_runtime2.jsx)(ActionMenuButton, { actionStates: sideMenuItems, disabled }), $[20] = disabled, $[21] = menuActionStates, $[22] = showMenu, $[23] = sideMenuItems, $[24] = t5) : t5 = $[24];
  let t6;
  $[25] !== buttonElement || $[26] !== firstActionState ? (t6 = firstActionState && firstActionState.dialog && (0, import_jsx_runtime2.jsx)(ActionStateDialog, { dialog: firstActionState.dialog, referenceElement: buttonElement }), $[25] = buttonElement, $[26] = firstActionState, $[27] = t6) : t6 = $[27];
  let t7;
  return $[28] !== t3 || $[29] !== t4 || $[30] !== t5 || $[31] !== t6 ? (t7 = (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", gap: 1, children: [
    t3,
    t4,
    t5,
    t6
...
var DocumentStatusBarActions = (0, import_react2.memo)(function() {
  ...
  if (actions.length === 0 || !actionProps)
    return null;
  let t6;
  return $[11] !== actionProps || $[12] !== actions || $[13] !== renderDocumentStatusBarActions ? (t6 = (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { actions, actionProps, group: "default", children: renderDocumentStatusBarActions }), $[11] = actionProps, $[12] = actions, $[13] = renderDocumentStatusBarActions, $[14] = t6) : t6 = $[14], t6;
});
var HistoryStatusBarActions = (0, import_react2.memo)(function() {
  const $ = (0, import_react_compiler_runtime.c)(15), {
    ...
    revisionId: revision,
    isInitialValueLoading
  } = useDocumentPane(), disabled = ((editState == null ? void 0 : editState.draft) || (editState == null ? void 0 : editState.published) || {})._rev === revision;
  let t0, t1;
  ...
  $[8] !== connectionState || $[9] !== disabled ? (t5 = (t62) => {
    ...
    return (0, import_jsx_runtime2.jsx)(DocumentStatusBarActionsInner, { disabled: connectionState !== "connected" || !!disabled, showMenu: false, states });
  }, $[8] = connectionState, $[9] = disabled, $[10] = t5) : t5 = $[10];
  const renderDocumentStatusBarActions = t5;
  if (!actionProps)
    return null;
  let t6;
  return $[11] !== actionProps || $[12] !== historyActions || $[13] !== renderDocumentStatusBarActions ? (t6 = (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { actions: historyActions, actionProps, group: "default", children: renderDocumentStatusBarActions }), $[11] = actionProps, $[12] = historyActions, $[13] = renderDocumentStatusBarActions, $[14] = t6) : t6 = $[14], t6;
});
...
function useChipScrollPosition(containerRef) {
  const $ = (0, import_react_compiler_runtime.c)(4), [showGradient, setShowGradient] = (0, import_react2.useState)(false);
  let t0;
  $[0] !== containerRef.current ? (t0 = () => {
    ...
    return () => {
      intersectionObserver_0 == null ? void 0 : intersectionObserver_0.disconnect(), mutationObserver_0 == null ? void 0 : mutationObserver_0.disconnect();
    };
  }, $[0] = containerRef.current, $[1] = t0) : t0 = $[1];
  let t1;
  return $[2] !== containerRef ? (t1 = [containerRef], $[2] = containerRef, $[3] = t1) : t1 = $[3], (0, import_react2.useEffect)(t0, t1), showGradient;
}
...
var DocumentPerspectiveList = (0, import_react2.memo)(function() {
  ...
  const {
    ...
    documentId
  }), workspace = useWorkspace(), handlePerspectiveChange = (0, import_react2.useCallback)((perspective) => () => {
    perspective === "published" && (params == null ? void 0 : params.historyVersion) && setParams({
      ...params,
      rev: (params == null ? void 0 : params.historyEvent) || void 0,
      since: void 0,
      historyVersion: void 0
    }), setPerspective(perspective);
  }, [setPerspective, setParams, params]), schemaType = schema.get(documentType), isLiveEdit = schemaType ? isLiveEditEnabled(schemaType) : false, isPublishedChipDisabled = (0, import_react2.useMemo)(() => isLiveEdit && !selectedReleaseId ? false : !(editState == null ? void 0 : editState.published), [isLiveEdit, selectedReleaseId, editState == null ? void 0 : editState.published]), getReleaseChipState = (0, import_react2.useCallback)((release) => {
    if (!(params == null ? void 0 : params.historyVersion)) return {
      selected: getReleaseIdFromReleaseDocumentId(release._id) === getVersionFromId((displayed == null ? void 0 : displayed._id) || "")
    };
  ...
  }, [displayed == null ? void 0 : displayed._id, params == null ? void 0 : params.historyVersion]), isPublishSelected = (0, import_react2.useMemo)(() => {
    var _a2;
    return !!(isLiveEdit && !((_a2 = editState == null ? void 0 : editState.draft) == null ? void 0 : _a2._id) && !selectedReleaseId || isPublishedId((displayed == null ? void 0 : displayed._id) || "") && isPublishedPerspective(selectedPerspectiveName || ""));
  }, [displayed == null ? void 0 : displayed._id, (_a = editState == null ? void 0 : editState.draft) == null ? void 0 : _a._id, isLiveEdit, selectedPerspectiveName, selectedReleaseId]), isDraftSelected = (0, import_react2.useMemo)(() => {
    const displayedId = (displayed == null ? void 0 : displayed._id) || "";
    return isPublishSelected || (params == null ? void 0 : params.historyVersion) || selectedPerspectiveName || isVersionId(displayedId) ? false : isDraftId(displayedId) ? true : !(isPublishedId(displayedId) && (editState == null ? void 0 : editState.published) && isPublishedPerspective(selectedPerspectiveName || ""));
  }, [displayed == null ? void 0 : displayed._id, editState == null ? void 0 : editState.published, isPublishSelected, params == null ? void 0 : params.historyVersion, selectedPerspectiveName]), isDraftDisabled = (0, import_react2.useMemo)(() => onlyHasVersions || isCreatingDocument && selectedReleaseId ? true : !(editState == null ? void 0 : editState.draft) && !isLiveEdit ? false : !!(isCreatingDocument && selectedReleaseId || isLiveEdit), [editState == null ? void 0 : editState.draft, isCreatingDocument, isLiveEdit, onlyHasVersions, selectedReleaseId]), isDraftModelEnabled = (_b = workspace.document.drafts) == null ? void 0 : _b.enabled;
  return (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    (0, import_jsx_runtime2.jsx)(VersionChip$1, { tooltipContent: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (editState == null ? void 0 : editState.published) && ((_c = editState == null ? void 0 : editState.published) == null ? void 0 : _c._updatedAt) ? (0, import_jsx_runtime2.jsx)(Translate, { t: t2, i18nKey: "release.chip.tooltip.published-date", values: {
      date: dateTimeFormat.format(new Date(editState == null ? void 0 : editState.published._updatedAt))
    } }) : (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: t2("release.chip.tooltip.not-published") }) }), disabled: isPublishedChipDisabled, onClick: handlePerspectiveChange("published"), selected: isPublishSelected, text: t2("release.chip.published"), tone: "positive", contextValues: {
      documentId: ((_d = editState == null ? void 0 : editState.published) == null ? void 0 : _d._id) || (editState == null ? void 0 : editState.id) || "",
      menuReleaseId: ((_e = editState == null ? void 0 : editState.published) == null ? void 0 : _e._id) || (editState == null ? void 0 : editState.id) || "",
      releases: filteredReleases.notCurrentReleases,
      releasesLoading: loading,
      documentType,
      fromRelease: "published",
      isVersion: false,
      disabled: !(editState == null ? void 0 : editState.published)
    } }),
    isDraftModelEnabled && (0, import_jsx_runtime2.jsx)(VersionChip$1, { tooltipContent: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (editState == null ? void 0 : editState.draft) ? (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: (editState == null ? void 0 : editState.draft._updatedAt) ? (0, import_jsx_runtime2.jsx)(Translate, { t: t2, i18nKey: "release.chip.tooltip.edited-date", values: {
      date: dateTimeFormat.format(new Date(editState == null ? void 0 : editState.draft._updatedAt))
    } }) : (0, import_jsx_runtime2.jsx)(Translate, { t: t2, i18nKey: "release.chip.tooltip.created-date", values: {
      date: dateTimeFormat.format(new Date(editState == null ? void 0 : editState.draft._createdAt))
    } }) }) : (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: t2(isLiveEdit ? "release.chip.tooltip.draft-disabled.live-edit" : "release.chip.tooltip.no-edits") }) }), selected: isDraftSelected, disabled: isDraftDisabled, text: t2("release.chip.draft"), tone: (editState == null ? void 0 : editState.draft) ? "caution" : "neutral", onClick: handlePerspectiveChange("drafts"), contextValues: {
      documentId: ((_f = editState == null ? void 0 : editState.draft) == null ? void 0 : _f._id) || ((_g = editState == null ? void 0 : editState.published) == null ? void 0 : _g._id) || (editState == null ? void 0 : editState.id) || "",
      menuReleaseId: ((_h = editState == null ? void 0 : editState.draft) == null ? void 0 : _h._id) || ((_i = editState == null ? void 0 : editState.published) == null ? void 0 : _i._id) || (editState == null ? void 0 : editState.id) || "",
      releases: filteredReleases.notCurrentReleases,
      releasesLoading: loading,
      documentType,
      fromRelease: "draft",
      isVersion: false,
      disabled: !(editState == null ? void 0 : editState.draft)
    } }),
    filteredReleases.inCreation && (0, import_jsx_runtime2.jsx)(VersionChip$1, { tooltipContent: (0, import_jsx_runtime2.jsx)(TooltipContent$1, { release: filteredReleases.inCreation }), selected: true, onClick: () => {
    }, locked: false, tone: getReleaseTone(filteredReleases.inCreation), text: filteredReleases.inCreation.metadata.title || t2("release.placeholder-untitled-release"), contextValues: {
      disabled: true,
      // disable the chip context menu, this one is in creation
      documentId: (displayed == null ? void 0 : displayed._id) || "",
    ...
    displayed && ((_j = filteredReleases.currentReleases) == null ? void 0 : _j.map((release_0) => (0, import_jsx_runtime2.jsx)(VersionChip$1, { tooltipContent: (0, import_jsx_runtime2.jsx)(TooltipContent$1, { release: release_0 }), ...getReleaseChipState(release_0), onClick: handlePerspectiveChange(getReleaseIdFromReleaseDocumentId(release_0._id)), text: release_0.metadata.title || t2("release.placeholder-untitled-release"), tone: getReleaseTone(release_0), locked: isReleaseScheduledOrScheduling(release_0), contextValues: {
      documentId: (displayed == null ? void 0 : displayed._id) || "",
...
var DocumentPanelHeader = (0, import_react2.memo)((0, import_react2.forwardRef)(function(_props, ref) {
  const {
  ...
  } = useFieldActions(), [referenceElement, setReferenceElement] = (0, import_react2.useState)(null), scrollContainerRef = (0, import_react2.useRef)(null), showGradient = useChipScrollPosition(scrollContainerRef), actions = (0, import_react2.useMemo)(() => (allActions ?? []).filter((action) => !isRestoreAction(action)), [allActions]), menuNodes = (0, import_react2.useMemo)(() => resolveMenuNodes({
    actionHandler: onMenuAction,
    fieldActions,
    menuItems,
    menuItemGroups
  }), [onMenuAction, fieldActions, menuItemGroups, menuItems]), menuButtonNodes = (0, import_react2.useMemo)(() => menuNodes.filter(isMenuNodeButton), [menuNodes]), contextMenuNodes = (0, import_react2.useMemo)(() => menuNodes.filter(isNotMenuNodeButton), [menuNodes]), {
    collapsed,
    isLast
    ...
    t: t2
  } = useTranslation(structureLocaleNamespace), renderPaneActions = (0, import_react2.useCallback)(({
    states
  }) => (0, import_jsx_runtime2.jsx)(DocumentPanelHeaderActionDialogDeferred, { contextMenuNodes, setReferenceElement, referenceElement, states }), [contextMenuNodes, referenceElement]), title = (0, import_react2.useMemo)(() => (0, import_jsx_runtime2.jsx)(DocumentHeaderTitle, {}), []), backButton = (0, import_react2.useMemo)(() => showBackButton && (0, import_jsx_runtime2.jsx)(Button2, { as: BackLink2, "data-as": "a", icon: ArrowLeftIcon, mode: "bleed", tooltipProps: {
    content: t2("pane-header.back-button.text")
  } }), [BackLink2, showBackButton, t2]), renderedActions = (0, import_react2.useMemo)(() => (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", gap: 1, children: [
    unstable_languageFilter.length > 0 && (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: unstable_languageFilter.map((LanguageFilterComponent, idx) => (0, import_jsx_runtime2.jsx)(
    ...
    menuButtonNodes.map((item) => (0, import_jsx_runtime2.jsx)(PaneHeaderActionButton, { node: item }, item.key)),
    editState && (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { actions, actionProps: {
      ...editState,
      initialValueResolved: !isInitialValueLoading
    }, group: "paneActions", children: renderPaneActions }),
    showSplitPaneButton && (0, import_jsx_runtime2.jsx)(Button2, { "aria-label": t2("buttons.split-pane-button.aria-label"), icon: SplitVerticalIcon, mode: "bleed", onClick: onPaneSplit, tooltipProps: {
      content: t2("buttons.split-pane-button.tooltip")
    } }, "split-pane-button"),
    showSplitPaneCloseButton && (0, import_jsx_runtime2.jsx)(Button2, { icon: CloseIcon, mode: "bleed", onClick: onPaneClose, tooltipProps: {
      content: t2("buttons.split-pane-close-button.title")
    } }, "close-view-button"),
    showPaneGroupCloseButton && (0, import_jsx_runtime2.jsx)(Button2, { icon: CloseIcon, mode: "bleed", tooltipProps: {
      content: t2("buttons.split-pane-close-group-button.title")
    }, as: BackLink2 }, "close-view-button")
  ] }), [BackLink2, actions, editState, isInitialValueLoading, menuButtonNodes, onPaneClose, onPaneSplit, renderPaneActions, schemaType, showPaneGroupCloseButton, showSplitPaneButton, showSplitPaneCloseButton, t2, unstable_languageFilter]);
  return (0, import_jsx_runtime2.jsx)(TooltipDelayGroupProvider, { children: collapsed ? (0, import_jsx_runtime2.jsx)(PaneHeader$1, { border: true, ref, loading: connectionState === "connecting" && !(editState == null ? void 0 : editState.draft) && !(editState == null ? void 0 : editState.published), title, tabIndex, backButton }) : (0, import_jsx_runtime2.jsx)(Card, { hidden: collapsed, style: {
    lineHeight: 0
    ...
    (0, import_jsx_runtime2.jsx)(Box, { flex: "none", paddingRight: 3, children: renderedActions })
  ] }) }) });
}));
var DocumentPanelHeaderActionDialogDeferred = (0, import_react2.memo)(function(props) {
  ...
  let t0;
  return $[0] !== contextMenuNodes || $[1] !== referenceElement || $[2] !== setReferenceElement || $[3] !== states ? (t0 = (0, import_jsx_runtime2.jsx)(DocumentPanelHeaderActionDialog, { setReferenceElement, referenceElement, contextMenuNodes, states }), $[0] = contextMenuNodes, $[1] = referenceElement, $[2] = setReferenceElement, $[3] = states, $[4] = t0) : t0 = $[4], t0;
});
...
var DocumentBadgesDeferred = (0, import_react2.memo)(function(props) {
  const $ = (0, import_react_compiler_runtime.c)(2), states = (0, import_react2.useDeferredValue)(props.states);
  let t0;
...
var UserLine = (t0) => {
  ...
  let t2;
  $[3] !== loading || $[4] !== user ? (t2 = (0, import_jsx_runtime2.jsx)(Box, { children: loading || !(user == null ? void 0 : user.displayName) ? (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(NameSkeleton, { animated: true }) }) : (0, import_jsx_runtime2.jsx)(Text, { muted: true, size: 1, children: user.displayName }) }), $[3] = loading, $[4] = user, $[5] = t2) : t2 = $[5];
  let t3;
...
function TimelineItem(t0) {
  const $ = (0, import_react_compiler_runtime.c)(55), {
    chunk,
    isSelected,
    onSelect,
    collaborators,
  ...
  let t10;
  $[17] !== authorUserIds ? (t10 = (0, import_jsx_runtime2.jsx)(UserAvatarStack, { maxLength: 3, userIds: authorUserIds, size: 2 }), $[17] = authorUserIds, $[18] = t10) : t10 = $[18];
  const t11 = TIMELINE_ITEM_EVENT_TONE[type];
  let t12;
  $[19] !== IconComponent ? (t12 = IconComponent && (0, import_jsx_runtime2.jsx)(IconComponent, {}), $[19] = IconComponent, $[20] = t12) : t12 = $[20];
  let t13;
  $[21] !== t12 ? (t13 = (0, import_jsx_runtime2.jsx)(Text, { size: 0, children: t12 }), $[21] = t12, $[22] = t13) : t13 = $[22];
  let t14;
  $[23] !== t11 || $[24] !== t13 ? (t14 = (0, import_jsx_runtime2.jsx)(IconBox, { align: "center", justify: "center", $color: t11, children: t13 }), $[23] = t11, $[24] = t13, $[25] = t14) : t14 = $[25];
  let t15;
  $[26] !== t10 || $[27] !== t14 ? (t15 = (0, import_jsx_runtime2.jsxs)("div", { style: t9, children: [
    t10,
    t14
  ] }), $[26] = t10, $[27] = t14, $[28] = t15) : t15 = $[28];
  let t16;
  $[29] !== t2 || $[30] !== type ? (t16 = t2(TIMELINE_ITEM_I18N_KEY_MAPPING2[type]) || (0, import_jsx_runtime2.jsx)("code", { children: type }), $[29] = t2, $[30] = type, $[31] = t16) : t16 = $[31];
  let t17;
  $[32] !== t16 ? (t17 = (0, import_jsx_runtime2.jsx)(Text, { size: 1, weight: "medium", children: t16 }), $[32] = t16, $[33] = t17) : t17 = $[33];
  let t18;
  $[34] !== formattedTimestamp || $[35] !== timestamp || $[36] !== updatedTimeAgo ? (t18 = (0, import_jsx_runtime2.jsx)(Text, { as: "time", size: 1, muted: true, dateTime: timestamp, title: formattedTimestamp, children: updatedTimeAgo }), $[34] = formattedTimestamp, $[35] = timestamp, $[36] = updatedTimeAgo, $[37] = t18) : t18 = $[37];
  let t19;
  $[38] !== t17 || $[39] !== t18 ? (t19 = (0, import_jsx_runtime2.jsxs)(Stack, { space: 2, children: [
    t17,
    t18
  ] }), $[38] = t17, $[39] = t18, $[40] = t19) : t19 = $[40];
  let t20;
  $[41] !== collaboratorsUsersIds ? (t20 = collaboratorsUsersIds.length > 0 && (0, import_jsx_runtime2.jsx)(Flex, { flex: 1, justify: "flex-end", align: "center", children: (0, import_jsx_runtime2.jsx)(Tooltip, { placement: "top", content: (0, import_jsx_runtime2.jsx)(TooltipContent, { collaborators: collaboratorsUsersIds }), portal: true, children: (0, import_jsx_runtime2.jsx)(Box, { paddingLeft: 2, paddingY: 2, children: (0, import_jsx_runtime2.jsx)(UserAvatarStack, { maxLength: 3, userIds: collaboratorsUsersIds, size: 0, withTooltip: false }) }) }) }), $[41] = collaboratorsUsersIds, $[42] = t20) : t20 = $[42];
  let t21;
  $[43] !== t15 || $[44] !== t19 || $[45] !== t20 ? (t21 = (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", gap: 3, children: [
    t15,
    t19,
    t20
  ] }), $[43] = t15, $[44] = t19, $[45] = t20, $[46] = t21) : t21 = $[46];
  let t222;
  $[47] !== chunk.id || $[48] !== handleClick || $[49] !== isSelected || $[50] !== t21 ? (t222 = (0, import_jsx_runtime2.jsx)(Card, { as: "button", onClick: handleClick, padding: 2, pressed: isSelected, radius: 2, "data-ui": "timelineItem", "data-testid": "timeline-item-button", "data-chunk-id": chunk.id, children: t21 }), $[47] = chunk.id, $[48] = handleClick, $[49] = isSelected, $[50] = t21, $[51] = t222) : t222 = $[51];
  let t23;
  return $[52] !== optionsMenu || $[53] !== t222 ? (t23 = (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", gap: 1, children: [
    t222,
    optionsMenu
  ] }), $[52] = optionsMenu, $[53] = t222, $[54] = t23) : t23 = $[54], t23;
}
...
function addChunksMetadata(chunks) {
  ...
  for (const chunk of chunks) {
    ...
    if (isNonPublishChunk(chunk)) {
      ...
      if (chunk.type === "editDraft" && (previousPublish == null ? void 0 : previousPublish.type) === "publish") {
...
var Timeline = ({
  ...
  const [mounted, setMounted] = (0, import_react2.useState)(false), {
    t: t2
  } = useTranslation("studio"), selectedChunkId = selectedChunk == null ? void 0 : selectedChunk.id, chunksWithMetadata = (0, import_react2.useMemo)(() => addChunksMetadata(chunks), [chunks]), [expandedParents, setExpandedParents] = (0, import_react2.useState)(() => {
    if (selectedChunkId) {
  ...
  const filteredChunks = (0, import_react2.useMemo)(() => chunksWithMetadata.filter((chunk_1) => isPublishChunk(chunk_1) || !chunk_1.parentId ? true : expandedParents.has(chunk_1.parentId)), [chunksWithMetadata, expandedParents]);
  (0, import_react2.useEffect)(() => {
    filteredChunks.length < 16 && hasMoreChunks && onLoadMore();
  }, [filteredChunks, hasMoreChunks, onLoadMore]);
  const handleExpandParent = (0, import_react2.useCallback)((parentId_0) => () => setExpandedParents((prev_0) => {
    const next_0 = new Set(prev_0);
    return prev_0.has(parentId_0) ? next_0.delete(parentId_0) : next_0.add(parentId_0), next_0;
  }), []), selectedIndex = (0, import_react2.useMemo)(() => selectedChunkId ? filteredChunks.findIndex((chunk_2) => chunk_2.id === selectedChunkId) : -1, [selectedChunkId, filteredChunks]), handleSelectChunk = (0, import_react2.useCallback)((chunk_3) => {
  ...
  }, [chunks, onSelect]), renderItem = (0, import_react2.useCallback)((chunk_4, {
    activeIndex
  }) => (0, import_jsx_runtime2.jsxs)(Box, { paddingBottom: 1, paddingTop: activeIndex === 0 ? 1 : 0, paddingRight: 1, paddingLeft: isNonPublishChunk(chunk_4) && chunk_4.parentId ? 4 : 1, children: [
  ...
  return (0, import_react2.useEffect)(() => setMounted(true), []), (0, import_jsx_runtime2.jsxs)(
    Root$2,
    {
      $visible: !selectedIndex || mounted,
      "data-ui": "timeline",
      children: [
        filteredChunks.length === 0 && (0, import_jsx_runtime2.jsxs)(StackWrapper, { padding: 3, space: 3, children: [
...
function TimelineError(t0) {
  ...
  let t1;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t1 = (0, import_jsx_runtime2.jsx)(TextWithTone, { tone: "critical", children: (0, import_jsx_runtime2.jsx)(ErrorOutlineIcon, {}) }), $[0] = t1) : t1 = $[0];
  let t22;
...
function TimelineMenu({
  ...
  const {
    ...
    t: t2
  } = useTranslation("studio"), handleOpen = (0, import_react2.useCallback)(() => {
    setOpen(true);
  }, []), handleClose = (0, import_react2.useCallback)(() => {
    setOpen(false);
  }, []), handleGlobalKeyDown = (0, import_react2.useCallback)((event) => {
    open && (event.key === "Escape" || event.key === "Tab") && (handleClose(), button == null ? void 0 : button.focus());
  ...
  const selectRev = (0, import_react2.useCallback)((revChunk) => {
    try {
      const [sinceId, revId] = (timelineStore == null ? void 0 : timelineStore.findRangeForRev(revChunk)) || [null, null];
  ...
  }, [setTimelineRange, t2, timelineStore, toast]), selectSince = (0, import_react2.useCallback)((sinceChunk) => {
    try {
      const [sinceId_0, revId_0] = (timelineStore == null ? void 0 : timelineStore.findRangeForSince(sinceChunk)) || [null, null];
  ...
  }, [setTimelineRange, t2, timelineStore, toast]), handleLoadMore = (0, import_react2.useCallback)(() => {
    loading || (timelineStore == null ? void 0 : timelineStore.loadMore());
  }, [loading, timelineStore]), content = (0, import_react2.useMemo)(() => {
    if (timelineError) return (0, import_jsx_runtime2.jsx)(TimelineError, {});
    if (mode === "rev")
      return (0, import_jsx_runtime2.jsx)(Timeline, { chunks, hasMoreChunks, lastChunk: realRevChunk, onLoadMore: handleLoadMore, onSelect: selectRev });
    const filteredChunks = realRevChunk ? chunks.filter((c2) => c2.index < realRevChunk.index) : chunks;
    return (0, import_jsx_runtime2.jsx)(Timeline, { chunks: filteredChunks, hasMoreChunks, lastChunk: sinceTime, onLoadMore: handleLoadMore, onSelect: selectSince });
  ...
  }) : t2("timeline.latest-revision"), sinceLabel = chunk ? t2("timeline.since", {
    timestamp: new Date(chunk == null ? void 0 : chunk.endTimestamp),
    formatParams: formatParams2
  }) : t2("timeline.since-version-missing"), buttonLabel = mode === "rev" ? revLabel : sinceLabel;
  return (0, import_jsx_runtime2.jsx)(PortalProvider, { __unstable_elements: {
    [TIMELINE_MENU_PORTAL$1]: popoverRef
  }, children: (0, import_jsx_runtime2.jsx)(Root$1, { "data-testid": "timeline-menu", constrainSize: true, content: open && content, "data-ui": "versionMenu", open, placement, matchReferenceWidth: true, portal: true, ref: setPopoverRef, children: (0, import_jsx_runtime2.jsx)(Flex, { width: "fill", children: (0, import_jsx_runtime2.jsx)(Button2, { "data-testid": open ? "timeline-menu-close-button" : "timeline-menu-open-button", disabled: !ready, mode: "ghost", onClick: open ? handleClose : handleOpen, ref: setButton, selected: open, width: "fill", tooltipProps: null, justify: "space-between", style: {
    maxWidth: "100%"
  }, iconRight: ChevronDownIcon, text: ready ? buttonLabel : t2("timeline.loading-history") }) }) }) });
}
...
var ButtonSkeleton = () => {
  const $ = (0, import_react_compiler_runtime.c)(2);
  let t0;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = (0, import_jsx_runtime2.jsx)("div", { style: {
    margin: -5
  }, children: (0, import_jsx_runtime2.jsx)(AvatarSkeleton$1, { $size: 0, animated: true }) }), $[0] = t0) : t0 = $[0];
  let t1;
  return $[1] === Symbol.for("react.memo_cache_sentinel") ? (t1 = (0, import_jsx_runtime2.jsxs)(Flex, { align: "center", gap: 3, paddingLeft: 1, paddingRight: 2, paddingY: 2, children: [
    t0,
...
var DocumentStatusButton = (t0) => {
  ...
  let t22, t3, t4;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t22 = {
    opacity: 1
  }, t3 = {
    opacity: 0
  }, t4 = {
  ...
  const t5 = (inspector == null ? void 0 : inspector.name) === HISTORY_INSPECTOR_NAME ? onHistoryClose : onHistoryOpen;
  let t6;
...
var FallbackStatus = () => {
  ...
  const {
    ...
    selectedPerspective
  } = usePerspective(), status = (0, import_react2.useMemo)(() => {
    var _a2, _b2, _c2, _d2, _e2, _f, _g;
    return isPublishedPerspective(selectedPerspective) && ((_a2 = editState == null ? void 0 : editState.published) == null ? void 0 : _a2._updatedAt) ? {
      translationKey: TIMELINE_ITEM_I18N_KEY_MAPPING.published.createDocumentVersion,
      timestamp: editState.published._updatedAt
    } : ((_b2 = editState == null ? void 0 : editState.version) == null ? void 0 : _b2._updatedAt) ? {
      translationKey: ((_c2 = editState == null ? void 0 : editState.version) == null ? void 0 : _c2._updatedAt) === ((_d2 = editState == null ? void 0 : editState.version) == null ? void 0 : _d2._createdAt) ? TIMELINE_ITEM_I18N_KEY_MAPPING.version.createDocumentVersion : TIMELINE_ITEM_I18N_KEY_MAPPING.version.editDocumentVersion,
      timestamp: editState.version._updatedAt
    } : ((_e2 = editState == null ? void 0 : editState.draft) == null ? void 0 : _e2._updatedAt) ? {
      translationKey: ((_f = editState == null ? void 0 : editState.draft) == null ? void 0 : _f._updatedAt) === ((_g = editState == null ? void 0 : editState.draft) == null ? void 0 : _g._createdAt) ? TIMELINE_ITEM_I18N_KEY_MAPPING.draft.createDocumentVersion : TIMELINE_ITEM_I18N_KEY_MAPPING.draft.editDocumentVersion,
      timestamp: editState.draft._updatedAt
    } : null;
  }, [selectedPerspective, (_a = editState == null ? void 0 : editState.published) == null ? void 0 : _a._updatedAt, (_b = editState == null ? void 0 : editState.version) == null ? void 0 : _b._updatedAt, (_c = editState == null ? void 0 : editState.version) == null ? void 0 : _c._createdAt, (_d = editState == null ? void 0 : editState.draft) == null ? void 0 : _d._updatedAt, (_e = editState == null ? void 0 : editState.draft) == null ? void 0 : _e._createdAt]);
  return status ? (0, import_jsx_runtime2.jsx)(DocumentStatusButton, { author: "", translationKey: status.translationKey, timestamp: status.timestamp }) : null;
};
var EventsStatus = () => {
  const $ = (0, import_react_compiler_runtime.c)(6), {
    events,
    loading
  } = useEvents(), event = events == null ? void 0 : events[0];
  if (!event && loading) {
    let t02;
    return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime2.jsx)(ButtonSkeleton, {}), $[0] = t02) : t02 = $[0], t02;
  }
  if (!event) {
    let t02;
    return $[1] === Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime2.jsx)(FallbackStatus, {}), $[1] = t02) : t02 = $[1], t02;
  }
  const t0 = TIMELINE_ITEM_I18N_KEY_MAPPING[event.documentVariantType][event.type];
  let t1;
  return $[2] !== event.author || $[3] !== event.timestamp || $[4] !== t0 ? (t1 = (0, import_jsx_runtime2.jsx)(DocumentStatusButton, { author: event.author, translationKey: t0, timestamp: event.timestamp }), $[2] = event.author, $[3] = event.timestamp, $[4] = t0, $[5] = t1) : t1 = $[5], t1;
};
var TimelineStatus = () => {
  const $ = (0, import_react_compiler_runtime.c)(8), {
    timelineStore
  } = useDocumentPane(), chunks = useTimelineSelector(timelineStore, _temp$9), loading = useTimelineSelector(timelineStore, _temp2$2), event = chunks == null ? void 0 : chunks[0];
  if (!event && loading) {
    let t02;
    return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t02 = (0, import_jsx_runtime2.jsx)(ButtonSkeleton, {}), $[0] = t02) : t02 = $[0], t02;
  }
  ...
  let t2;
  return $[4] !== author || $[5] !== event.endTimestamp || $[6] !== t1 ? (t2 = (0, import_jsx_runtime2.jsx)(DocumentStatusButton, { author, translationKey: t1, timestamp: event.endTimestamp }), $[4] = author, $[5] = event.endTimestamp, $[6] = t1, $[7] = t2) : t2 = $[7], t2;
};
...
function DocumentStatusLine() {
  ...
  const $ = (0, import_react_compiler_runtime.c)(18), {
    ...
    editState,
    value
  } = useDocumentPane(), [status, setStatus] = (0, import_react2.useState)(null), eventsEnabled = (_b = (_a = useSource().beta) == null ? void 0 : _a.eventsAPI) == null ? void 0 : _b.documents, syncState = useSyncState(documentId, documentType, editState == null ? void 0 : editState.release), lastUpdated = value == null ? void 0 : value._updatedAt;
  let t0;
...
function RevisionStatusLine() {
  const $ = (0, import_react_compiler_runtime.c)(12), {
    ...
    t: t2
  } = useTranslation(), date = (displayed == null ? void 0 : displayed._updatedAt) || (displayed == null ? void 0 : displayed._createdAt);
  let t0;
  $[0] !== date || $[1] !== t2 ? (t0 = date ? (0, import_jsx_runtime2.jsx)(Translate, { t: t2, i18nKey: "document-status.revision-from", values: {
    date: format(new Date(date), "MMM d, yyyy '@' pp")
  } }) : null, $[0] = date, $[1] = t2, $[2] = t0) : t0 = $[2];
  let t1;
  $[3] !== t0 ? (t1 = {
    name: "revision",
    text: t0,
  ...
  const message = t1;
  let t22;
  $[5] === Symbol.for("react.memo_cache_sentinel") ? (t22 = (0, import_jsx_runtime2.jsx)(Box, { flex: "none", children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(RestoreIcon, {}) }) }), $[5] = t22) : t22 = $[5];
  let t3;
  $[6] !== message || $[7] !== revisionNotFound || $[8] !== t2 ? (t3 = revisionNotFound ? (0, import_jsx_runtime2.jsx)(Translate, { t: t2, i18nKey: "document-status.revision-not-found" }) : message.text, $[6] = message, $[7] = revisionNotFound, $[8] = t2, $[9] = t3) : t3 = $[9];
  let t4;
  return $[10] !== t3 ? (t4 = (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: (0, import_jsx_runtime2.jsxs)(Flex, { flex: 1, gap: 3, padding: 2, children: [
    t22,
    (0, import_jsx_runtime2.jsx)(Box, { flex: 1, children: (0, import_jsx_runtime2.jsx)(StatusText, { size: 1, textOverflow: "ellipsis", children: t3 }) })
...
function DocumentStatusBar(props) {
  ...
  const $ = (0, import_react_compiler_runtime.c)(22), {
    ...
    title
  } = useDocumentTitle(), CreateLinkedActions = (_a = useSanityCreateConfig().components) == null ? void 0 : _a.documentLinkedActions, showingRevision = !!params.rev, [collapsed, setCollapsed] = (0, import_react2.useState)(null), [rootElement, setRootElement] = (0, import_react2.useState)(null);
  let t1;
  ...
  let t3;
  bb0: {
    const isReady = !!((editState == null ? void 0 : editState.ready) && typeof collapsed == "boolean");
    if (selectedPerspective) {
      if (isPublishedPerspective(selectedPerspective)) {
        t3 = isReady && !!(editState == null ? void 0 : editState.published);
        break bb0;
      }
      if (isReleaseDocument(selectedPerspective)) {
        t3 = isReady && !!(editState == null ? void 0 : editState.version);
        break bb0;
      }
    }
    t3 = isReady;
  ...
  if (createLinkMetadata && isSanityCreateLinked(createLinkMetadata) && CreateLinkedActions) {
    ...
    let t42;
    $[8] === Symbol.for("react.memo_cache_sentinel") ? (t42 = (0, import_jsx_runtime2.jsx)(HistoryStatusBarActions, {}), $[8] = t42) : t42 = $[8], actions = t42;
  } else {
    let t42;
    $[9] === Symbol.for("react.memo_cache_sentinel") ? (t42 = (0, import_jsx_runtime2.jsx)(DocumentStatusBarActions, {}), $[9] = t42) : t42 = $[9], actions = t42;
  }
...
var DocumentActionShortcuts = (0, import_react2.memo)((props) => {
  ...
  const as = t0 === void 0 ? "div" : t0, {
    ...
    isInitialValueLoading,
    revisionId
  } = useDocumentPane(), [activeIndex, setActiveIndex] = (0, import_react2.useState)(-1);
  let t1;
  ...
  if (!actionProps || !actions)
    return null;
  let t5;
  return $[16] !== actionProps || $[17] !== actions || $[18] !== renderDocumentActionShortcuts ? (t5 = (0, import_jsx_runtime2.jsx)(RenderActionCollectionState, { actionProps, actions, children: renderDocumentActionShortcuts }), $[16] = actionProps, $[17] = actions, $[18] = renderDocumentActionShortcuts, $[19] = t5) : t5 = $[19], t5;
});
...
function getCompareVersionsItem({
  ...
  const disabled = typeof (documentIdStack == null ? void 0 : documentIdStack.previousId) > "u" && {
...
function DocumentLayoutFooter(t0) {
  ...
  let t4;
  $[4] !== createLinkMetadata || $[5] !== setActionsBoxElement ? (t4 = (0, import_jsx_runtime2.jsx)(TooltipDelayGroupProvider, { children: (0, import_jsx_runtime2.jsx)(DocumentStatusBar, { actionsBoxRef: setActionsBoxElement, createLinkMetadata }) }), $[4] = createLinkMetadata, $[5] = setActionsBoxElement, $[6] = t4) : t4 = $[6];
  let t5;
  $[7] !== setFooterElement || $[8] !== t4 ? (t5 = (0, import_jsx_runtime2.jsx)(PaneFooter, { ref: setFooterElement, padding: 1, children: t4 }), $[7] = setFooterElement, $[8] = t4, $[9] = t5) : t5 = $[9];
  let t6;
  $[10] !== t5 || $[11] !== zOffsets.portal ? (t6 = (0, import_jsx_runtime2.jsx)(DialogProvider, { position: DIALOG_PROVIDER_POSITION$1, zOffset: zOffsets.portal, children: t5 }), $[10] = t5, $[11] = zOffsets.portal, $[12] = t6) : t6 = $[12];
  let t7;
  return $[13] !== portalElements || $[14] !== t6 ? (t7 = (0, import_jsx_runtime2.jsx)(PortalProvider, { __unstable_elements: portalElements, children: t6 }), $[13] = portalElements, $[14] = t6, $[15] = t7) : t7 = $[15], t7;
}
var EMPTY_ARRAY = [];
...
function DocumentLayout() {
  ...
  const [inspectorMenuItems, setInspectorMenuItems] = (0, import_react2.useState)([]), [rootFieldActionNodes, setRootFieldActionNodes] = (0, import_react2.useState)([]), footerRect = useElementRect(footerElement), headerRect = useElementRect(headerElement), footerHeight = footerRect == null ? void 0 : footerRect.height, headerHeight = headerRect == null ? void 0 : headerRect.height, currentMinWidth = DOCUMENT_PANEL_INITIAL_MIN_WIDTH + (inspector ? DOCUMENT_INSPECTOR_MIN_WIDTH : 0), minWidth = DOCUMENT_PANEL_MIN_WIDTH + (inspector ? DOCUMENT_INSPECTOR_MIN_WIDTH : 0), currentInspector = (0, import_react2.useMemo)(() => inspectors2 == null ? void 0 : inspectors2.find((i) => i.name === (inspector == null ? void 0 : inspector.name)), [inspectors2, inspector == null ? void 0 : inspector.name]), documentIdStack = useDocumentIdStack({
    displayed,
    documentId,
    editState
  }), hasValue = !!value, menuItems = (0, import_react2.useMemo)(() => getMenuItems({
    currentInspector,
    features,
    hasValue,
    inspectorMenuItems,
    ...
    documentIdStack,
    t: t2
  }), [currentInspector, documentIdStack, features, hasValue, inspectorMenuItems, inspectors2, previewUrl, t2]), handleKeyUp = (0, import_react2.useCallback)((event) => {
    for (const item of menuItems)
      if (item.shortcut && isHotkey(item.shortcut, event)) {
        event.preventDefault(), event.stopPropagation(), onMenuAction(item);
        return;
      }
  }, [onMenuAction, menuItems]), onConnectorSetFocus = (0, import_react2.useCallback)((path) => {
    onPathOpen(path), onFocus(path);
  }, [onPathOpen, onFocus]);
  return schemaType ? (0, import_jsx_runtime2.jsxs)(GetFormValueProvider, { value, children: [
    inspectors2.length > 0 && (0, import_jsx_runtime2.jsx)(DocumentInspectorMenuItemsResolver, { documentId, documentType, inspectors: inspectors2, onMenuItems: setInspectorMenuItems }),
    fieldActions.length > 0 && schemaType && (0, import_jsx_runtime2.jsx)(FieldActionsResolver, { actions: fieldActions, documentId, documentType, onActions: setRootFieldActionNodes, path: EMPTY_ARRAY, schemaType }),
    (0, import_jsx_runtime2.jsx)(FieldActionsProvider, { actions: rootFieldActionNodes, path: EMPTY_ARRAY, children: (0, import_jsx_runtime2.jsxs)(DocumentActionShortcuts, { actionsBoxElement, as: Pane, currentMinWidth, "data-testid": "document-pane", flex: 2.5, id: paneKey, minWidth, onKeyUp: handleKeyUp, rootRef: setRootElement, children: [
      (0, import_jsx_runtime2.jsx)(DocumentPanelHeader, { ref: setHeaderElement, menuItems }),
      (0, import_jsx_runtime2.jsx)(DialogProvider, { position: DIALOG_PROVIDER_POSITION, zOffset: zOffsets.paneDialog, children: (0, import_jsx_runtime2.jsx)(Flex, { direction: "column", flex: 1, height: layoutCollapsed ? void 0 : "fill", children: (0, import_jsx_runtime2.jsx)(StyledChangeConnectorRoot, { "data-testid": "change-connector-root", isReviewChangesOpen: changesOpen && (paneParams == null ? void 0 : paneParams.changesInspectorTab) === "review", onOpenReviewChanges: onHistoryOpen, onSetFocus: onConnectorSetFocus, children: (0, import_jsx_runtime2.jsx)(DocumentPanel, { footerHeight: footerHeight || null, headerHeight: headerHeight || null, isInspectOpen: inspectOpen, rootElement, setDocumentPanelPortalElement, footer: (0, import_jsx_runtime2.jsx)(DocumentLayoutFooter, { documentPanelPortalElement, setFooterElement, setActionsBoxElement }) }) }) }) }),
      (0, import_jsx_runtime2.jsx)(DocumentOperationResults, {})
    ] }) })
  ] }) : (0, import_jsx_runtime2.jsx)(DocumentLayoutError, { currentMinWidth, documentType, minWidth, paneKey, value });
}
...
function useDocumentPaneInspector({
  ...
  const {
    features
  } = useStructureTool(), inspectorsResolver = useSource().document.inspectors, inspectors2 = (0, import_react2.useMemo)(() => inspectorsResolver({
    documentId,
    documentType
  }), [documentId, documentType, inspectorsResolver]), [inspectorName, setInspectorName] = (0, import_react2.useState)(() => params.inspect || null), inspectParamRef = (0, import_react2.useRef)(params.inspect);
  (0, import_react2.useEffect)(() => {
    inspectParamRef.current !== params.inspect && (inspectParamRef.current = params.inspect, setInspectorName(params.inspect || null));
  }, [params.inspect]);
  const currentInspector = (0, import_react2.useMemo)(() => inspectors2 == null ? void 0 : inspectors2.find((i) => i.name === inspectorName), [inspectors2, inspectorName]), historyInspector = (0, import_react2.useMemo)(() => inspectors2.find((i_0) => i_0.name === HISTORY_INSPECTOR_NAME), [inspectors2]), changesOpen = (currentInspector == null ? void 0 : currentInspector.name) === HISTORY_INSPECTOR_NAME, closeInspector = (0, import_react2.useCallback)((closeInspectorName) => {
    var _a, _b;
    ...
    if (currentInspector) {
      if (inspector) {
        const result = ((_a = inspector.onClose) == null ? void 0 : _a.call(inspector, {
          params
        })) ?? {
          params
        };
      ...
      if (currentInspector) {
        const result_0 = ((_b = currentInspector.onClose) == null ? void 0 : _b.call(currentInspector, {
          params
        })) ?? {
          params
        };
  ...
  }, [currentInspector, inspectors2, params, setParams]), openInspector = (0, import_react2.useCallback)((nextInspectorName, paneParams) => {
    var _a, _b;
    ...
    currentInspector && (currentParams = (((_a = nextInspector.onClose) == null ? void 0 : _a.call(nextInspector, {
      params: currentParams
    })) ?? {
      params: currentParams
    }).params);
    const result_1 = ((_b = nextInspector.onOpen) == null ? void 0 : _b.call(nextInspector, {
      params: currentParams
    })) ?? {
      params: currentParams
    };
  ...
  }, [currentInspector, inspectors2, params, setParams]), handleHistoryClose = (0, import_react2.useCallback)(() => {
    historyInspector && closeInspector(historyInspector.name);
  }, [closeInspector, historyInspector]), handleHistoryOpen = (0, import_react2.useCallback)(() => {
    features.reviewChanges && historyInspector && openInspector(historyInspector.name, {
      changesInspectorTab: "review"
    });
  }, [features.reviewChanges, openInspector, historyInspector]), inspectOpen = params.inspect === "on", toggleLegacyInspect = (0, import_react2.useCallback)((toggle = !inspectOpen) => {
    setParams(toggle ? {
      ...params,
      inspect: "on"
    } : (0, import_omit.default)(params, "inspect"));
  }, [inspectOpen, params, setParams]), handleLegacyInspectClose = (0, import_react2.useCallback)(() => toggleLegacyInspect(false), [toggleLegacyInspect]), handleInspectorAction = (0, import_react2.useCallback)((item) => {
...
function usePreviewUrl(value) {
  ...
  $[1] !== value ? (t2 = () => {
    subject.next(value);
  }, t3 = [subject, value], $[1] = value, $[2] = t2, $[3] = t3) : (t2 = $[2], t3 = $[3]), (0, import_react2.useEffect)(t2, t3);
  let t4, t5;
  return $[4] !== resolveProductionUrl ? (t5 = subject.asObservable().pipe(distinctUntilChanged(), debounceTime(500), switchMap((document2) => isSanityDocument2(document2) ? from(resolveProductionUrl({
    document: document2
...
var DocumentPaneProvider = (0, import_react2.memo)((props) => {
  const {
    ...
    selectedReleaseId,
    selectedPerspectiveName
  } = (0, import_react2.useMemo)(() => forcedVersion || {
  ...
  }), [isDeleting, setIsDeleting] = (0, import_react2.useState)(false), getIsDeleted = (0, import_react2.useCallback)((editState) => timelineReady ? !(editState == null ? void 0 : editState.draft) && !(editState == null ? void 0 : editState.published) && !(editState == null ? void 0 : editState.version) && !isPristine : false, [timelineReady, isPristine]), getComparisonValue = (0, import_react2.useCallback)((editState_0) => changesOpen ? sinceDocument || (editState_0 == null ? void 0 : editState_0.published) : (editState_0 == null ? void 0 : editState_0.published) || null, [changesOpen, sinceDocument]), schemaType = schema.get(documentType), getIsReadOnly = (0, import_react2.useCallback)((editState_1) => {
  ...
  }, [getIsDeleted, isDeleting, isDraftModelEnabled, params.rev, perspective.selectedPerspective, schemaType]), getDisplayed = (0, import_react2.useCallback)((value) => onOlderRevision ? revisionDocument || {
    _id: value._id,
    _type: value._type
    ...
    selectedPerspectiveName,
    initialFocusPath: params.path ? fromString(params.path) : EMPTY_ARRAY$B,
    readOnly: getIsReadOnly,
    onFocusPath,
    getFormDocumentValue: getDisplayed
  }), getDocumentVersionType = (0, import_react2.useCallback)(() => {
    let version;
    switch (true) {
      case !!params.rev:
        version = "revision";
    ...
    return version;
  }, [params.rev, selectedReleaseId, value_0._id, selectedPerspectiveName, draftsEnabled]), actionsPerspective = (0, import_react2.useMemo)(() => getDocumentVersionType(), [getDocumentVersionType]), documentActionsProps = (0, import_react2.useMemo)(() => ({
    schemaType: documentType,
    documentId,
    versionType: actionsPerspective,
    releaseId: selectedReleaseId
  }), [documentType, documentId, actionsPerspective, selectedReleaseId]), actions = (0, import_react2.useMemo)(() => documentActions2(documentActionsProps), [documentActions2, documentActionsProps]), badges = (0, import_react2.useMemo)(() => documentBadges2({
    schemaType: documentType,
    documentId
  }), [documentBadges2, documentId, documentType]), languageFilter = (0, import_react2.useMemo)(() => languageFilterResolver({
    schemaType: documentType,
    documentId
  }), [documentId, documentType, languageFilterResolver]), views2 = useUnique(viewsProp), activeViewId = params.view || views2[0] && views2[0].id || null, previewUrl = usePreviewUrl(value_0), {
    t: t2
  } = useTranslation(structureLocaleNamespace), fieldActions = (0, import_react2.useMemo)(() => schemaType ? fieldActionsResolver({
    documentId,
    documentType,
    schemaType
  }) : [], [documentId, documentType, fieldActionsResolver, schemaType]), ready = formReady && (!params.rev || timelineReady || !!timelineError), displayed = (0, import_react2.useMemo)(() => getDisplayed(value_0), [getDisplayed, value_0]), {
    previousId
  } = useDocumentIdStack({
    displayed,
    documentId,
    editState: editState_2
  }), setTimelineRange = (0, import_react2.useCallback)((newSince, newRev) => {
    setPaneParams({
      ...params,
      since: newSince,
      rev: newRev || void 0
    });
  }, [params, setPaneParams]), handlePaneClose = (0, import_react2.useCallback)(() => paneRouter.closeCurrent(), [paneRouter]), handlePaneSplit = (0, import_react2.useCallback)(() => paneRouter.duplicateCurrent(), [paneRouter]), handleMenuAction = (0, import_react2.useCallback)(async (item) => {
    ...
    if (item.action === "copy-document-url" && navigator) {
      ...
      return await navigator.clipboard.writeText(copyUrl), pushToast({
        ...
        status: "info",
        title: t2("panes.document-operation-results.operation-success_copy-url")
      }), true;
    }
  ...
  }, [previewUrl, previousId, telemetry, buildStudioUrl, pushToast, t2, documentId, documentType, handleHistoryOpen, handleInspectorAction, diffViewRouter, value_0._id]);
  (0, import_react2.useEffect)(() => {
    setDocumentMeta({
      documentId,
      documentType,
  ...
  const compareValue = (0, import_react2.useMemo)(() => getComparisonValue(editState_2), [editState_2, getComparisonValue]), isDeleted_0 = (0, import_react2.useMemo)(() => getIsDeleted(editState_2), [editState_2, getIsDeleted]), revisionNotFound = onOlderRevision && !revisionDocument, documentPane = (0, import_react2.useMemo)(() => ({
    actions,
    activeViewId,
    badges,
    changesOpen,
  ...
  return (0, import_react2.useEffect)(() => {
    ...
    if (ready && params.path) {
      const {
        path,
        ...restParams
      } = params, pathFromUrl = resolveKeyedPath((_a = formStateRef.current) == null ? void 0 : _a.value, fromString(path));
      onProgrammaticFocus(pathFromUrl), paneRouter.setParams(restParams);
    }
  }, [formStateRef, onProgrammaticFocus, paneRouter, params, ready]), (0, import_jsx_runtime2.jsx)(DocumentPaneContext.Provider, { value: documentPane, children });
});
...
var DocumentEventsPane = (props) => {
  ...
  const $ = (0, import_react_compiler_runtime.c)(37), {
    params: t0
  } = usePaneRouter(), params = t0 === void 0 ? EMPTY_PARAMS$2 : t0, options = usePaneOptions(props.pane.options, params), schema = useSchema(), documentType = options.type, liveEdit = !!((_a = schema.get(options.type)) == null ? void 0 : _a.liveEdit), {
    selectedPerspectiveName,
    selectedReleaseId,
    selectedPerspective
  } = usePerspective(), {
  ...
  const editState = useEditState(t1, documentType, "default", selectedReleaseId), showingPublishedOnDraft = liveEdit && selectedPerspective === "drafts" && !(editState == null ? void 0 : editState.draft), {
    rev,
    since
  ...
  let t4;
  const t5 = eventsStore.error, t6 = ((_b = eventsStore.revision) == null ? void 0 : _b.revisionId) || null, t7 = !!(rev && !((_c = eventsStore.revision) == null ? void 0 : _c.loading)), t8 = ((_d = eventsStore.revision) == null ? void 0 : _d.document) || null, t9 = ((_e = eventsStore.sinceRevision) == null ? void 0 : _e.document) || null, t10 = !eventsStore.loading, t11 = eventsStore.events.length === 0;
  let t12;
  $[19] !== eventsStore.events ? (t12 = ((_f = eventsStore.events.find(_temp$6)) == null ? void 0 : _f.id) || null, $[19] = eventsStore.events, $[20] = t12) : t12 = $[20];
  let t13;
...
var DocumentPaneWithLegacyTimelineStore = (props) => {
  ...
  let t2;
  const t3 = (revTime == null ? void 0 : revTime.id) || null, t4 = timelineDisplayed, t5 = sinceAttributes, t6 = !!isPristine;
  let t7;
  ...
  let t8;
  return $[17] !== historyStoreProps || $[18] !== props ? (t8 = (0, import_jsx_runtime2.jsx)(DocumentPaneProvider, { ...props, historyStore: historyStoreProps }), $[17] = historyStoreProps, $[18] = props, $[19] = t8) : t8 = $[19], t8;
};
...
var DocumentPaneProviderWrapper = (0, import_react2.memo)((props) => {
  var _a, _b;
  const $ = (0, import_react_compiler_runtime.c)(4);
  if ((_b = (_a = useSource().beta) == null ? void 0 : _a.eventsAPI) == null ? void 0 : _b.documents) {
    let t02;
    return $[0] !== props ? (t02 = (0, import_jsx_runtime2.jsx)(DocumentEventsPane, { ...props }), $[0] = props, $[1] = t02) : t02 = $[1], t02;
  }
  let t0;
  return $[2] !== props ? (t0 = (0, import_jsx_runtime2.jsx)(DocumentPaneWithLegacyTimelineStore, { ...props }), $[2] = props, $[3] = t0) : t0 = $[3], t0;
});
...
function useResetHistoryParams() {
  ...
  let t4, t5;
  $[8] === Symbol.for("react.memo_cache_sentinel") ? (t4 = () => (isMounted.current = true, () => {
...
function DocumentPaneInner(props) {
  ...
  let t5;
  $[11] !== groupIndex || $[12] !== routerPanesState ? (t5 = ((_a = routerPanesState[groupIndex + 1]) == null ? void 0 : _a[0].params) || {}, $[11] = groupIndex, $[12] = routerPanesState, $[13] = t5) : t5 = $[13];
  ...
  if (options.type === "*" && !isLoaded) {
    let t822;
    $[18] !== t8 ? (t822 = t8("panes.document-pane.document-not-found.loading"), $[18] = t8, $[19] = t822) : t822 = $[19];
    let t92;
    return $[20] !== paneKey || $[21] !== t822 ? (t92 = (0, import_jsx_runtime2.jsx)(LoadingPane, { flex: 2.5, minWidth: 320, paneKey, title: t822 }), $[20] = paneKey, $[21] = t822, $[22] = t92) : t92 = $[22], t92;
  }
  if (!documentType) {
    let t822;
    $[23] !== t8 ? (t822 = t8("panes.document-pane.document-not-found.title"), $[23] = t8, $[24] = t822) : t822 = $[24];
    let t92;
    $[25] !== options.id ? (t92 = {
      id: options.id
    ...
    let t112;
    $[28] !== t8 || $[29] !== t92 ? (t112 = (0, import_jsx_runtime2.jsx)(Stack, { space: 4, children: (0, import_jsx_runtime2.jsx)(Text, { as: "p", children: (0, import_jsx_runtime2.jsx)(Translate, { t: t8, i18nKey: "panes.document-pane.document-not-found.text", values: t92, components: t102 }) }) }), $[28] = t8, $[29] = t92, $[30] = t112) : t112 = $[30];
    let t122;
    return $[31] !== paneKey || $[32] !== t112 || $[33] !== t822 ? (t122 = (0, import_jsx_runtime2.jsx)(ErrorPane, { flex: 2.5, minWidth: 320, paneKey, title: t822, children: t112 }), $[31] = paneKey, $[32] = t112, $[33] = t822, $[34] = t122) : t122 = $[34], t122;
  }
  const t82 = `${documentType}-${options.id}-${selectedPerspectiveName || ""}`;
  let t9;
  $[35] !== DocumentLayout2 || $[36] !== options.id || $[37] !== options.type ? (t9 = (0, import_jsx_runtime2.jsx)(DocumentLayout2, { documentId: options.id, documentType: options.type }), $[35] = DocumentLayout2, $[36] = options.id, $[37] = options.type, $[38] = t9) : t9 = $[38];
  let t10;
  $[39] !== options.id || $[40] !== options.type || $[41] !== t9 ? (t10 = (0, import_jsx_runtime2.jsx)(CommentsWrapper, { documentId: options.id, documentType: options.type, children: t9 }), $[39] = options.id, $[40] = options.type, $[41] = t9, $[42] = t10) : t10 = $[42];
  let t11;
  $[43] !== options.id || $[44] !== options.type || $[45] !== t10 ? (t11 = (0, import_jsx_runtime2.jsx)(DiffViewDocumentLayout, { documentId: options.id, documentType: options.type, children: t10 }), $[43] = options.id, $[44] = options.type, $[45] = t10, $[46] = t11) : t11 = $[46];
  let t12;
  $[47] !== ReferenceChildLink2 || $[48] !== activePath || $[49] !== handleEditReference || $[50] !== t11 || $[51] !== templatePermissions ? (t12 = (0, import_jsx_runtime2.jsx)(ReferenceInputOptionsProvider, { EditReferenceLinkComponent: ReferenceChildLink2, onEditReference: handleEditReference, initialValueTemplateItems: templatePermissions, activePath, children: t11 }), $[47] = ReferenceChildLink2, $[48] = activePath, $[49] = handleEditReference, $[50] = t11, $[51] = templatePermissions, $[52] = t12) : t12 = $[52];
  let t13;
  return $[53] !== providerProps || $[54] !== t12 || $[55] !== t82 ? (t13 = (0, import_jsx_runtime2.jsx)(DocumentPaneProviderWrapper, { ...providerProps, children: t12 }, t82), $[53] = providerProps, $[54] = t12, $[55] = t82, $[56] = t13) : t13 = $[56], t13;
}
function _temp$4(t0) {
  const {
    children
...
function usePaneOptions(options, t0) {
  ...
  bb0: {
    ...
    const documentType = t3 == null ? void 0 : t3.schemaType;
    if (!documentType) {
      t2 = options;
      break bb0;
    }
...
function listenSearchQuery(options) {
  const {
    ...
    maxFieldDepth,
    searchStrategy
  } = options, sortBy = sort.by, extendedProjection = sort == null ? void 0 : sort.extendedProjection, events$ = defer(() => client.listen(`*[${groqFilter}]`, params, {
  ...
  return merge(welcome$, mutationAndReconnect$.pipe(throttleTime(1e3, asyncScheduler, {
    ...
    documents: event.type === "result" ? event.documents : (acc == null ? void 0 : acc.documents) || []
...
function useDocumentList(opts) {
  const {
    ...
    strategy: searchStrategy
  } = useWorkspace().search, schema = useSchema(), maxFieldDepth = useSearchMaxFieldDepth(), typeNameFromFilter = (0, import_react2.useMemo)(() => findStaticTypesInFilter(searchFilter, paramsProp), [searchFilter, paramsProp]), [[onRetry$, onRetry]] = (0, import_react2.useState)(() => observableCallback()), [[onFetchFullList$, onLoadFullList]] = (0, import_react2.useState)(() => observableCallback()), queryResults$ = (0, import_react2.useMemo)(() => {
    const listenSearchQueryArgs = {
      ...
      filter(([, result]) => (result == null ? void 0 : result.documents.length) === PARTIAL_PAGE_LIMIT),
...
var DocumentListPane = (0, import_react2.memo)(function(props) {
  const {
    ...
    apiVersion,
    filter: filter2
  } = options, params = useShallowUnique(options.params || EMPTY_RECORD), typeName = (0, import_react2.useMemo)(() => {
  ...
  }, [filter2, params]), showIcons = (displayOptions == null ? void 0 : displayOptions.showIcons) !== false, {
    t: t2
  } = useTranslation(structureLocaleNamespace), {
    title
  } = useI18nText(pane2), [searchQuery, setSearchQuery] = (0, import_react2.useState)(""), [searchInputValue, setSearchInputValue] = (0, import_react2.useState)(""), [searchInputElement, setSearchInputElement] = (0, import_react2.useState)(null), sortWithOrderingFn = typeName && sortOrderRaw ? applyOrderingFunctions(sortOrderRaw, schema.get(typeName)) : sortOrderRaw, sortOrder = useUnique(sortWithOrderingFn), {
    error,
    isLoadingFullList,
    ...
    sortOrder
  }), isLoading = documentListIsLoading || releases.loading, handleQueryChange = useObservableEvent((event$) => event$.pipe(map((event) => event.target.value), tap(setSearchInputValue), debounce((value) => value === "" ? of("") : timer(300)), tap(setSearchQuery))), handleClearSearch = (0, import_react2.useCallback)(() => {
    setSearchQuery(""), setSearchInputValue("");
  }, []), handleSearchKeyDown = (0, import_react2.useCallback)((event_0) => {
    event_0.key === "Escape" && handleClearSearch();
  }, [handleClearSearch]), [enableSearchSpinner, setEnableSearchSpinner] = (0, import_react2.useState)();
  (0, import_react2.useEffect)(() => {
    !enableSearchSpinner && !isLoading && setEnableSearchSpinner(paneKey);
  }, [enableSearchSpinner, isLoading, paneKey]), (0, import_react2.useEffect)(() => {
    handleClearSearch(), setEnableSearchSpinner();
  }, [paneKey, handleClearSearch]);
  const loadingVariant = (0, import_react2.useMemo)(() => connected && isLoading && enableSearchSpinner === paneKey ? "spinner" : connected && fromCache ? "subtle" : "initial", [connected, enableSearchSpinner, fromCache, isLoading, paneKey]), textInputIcon = (0, import_react2.useMemo)(() => loadingVariant === "spinner" ? AnimatedSpinnerIcon : searchInputValue && loadingVariant === "subtle" ? SubtleSpinnerIcon : SearchIcon, [loadingVariant, searchInputValue]);
  return useReconnectingToast(!connected), (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    (0, import_jsx_runtime2.jsx)(Box, { paddingX: 3, paddingBottom: 3, children: (0, import_jsx_runtime2.jsx)(TextInput, { "aria-label": t2("panes.document-list-pane.search-input.aria-label"), autoComplete: "off", border: false, clearButton: !!searchQuery, fontSize: [2, 2, 1], icon: textInputIcon, iconRight: !connected || loadingVariant === "subtle" && !searchInputValue ? DelayedSubtleSpinnerIcon : null, onChange: handleQueryChange, onClear: handleClearSearch, onKeyDown: handleSearchKeyDown, padding: 2, placeholder: t2("panes.document-list-pane.search-input.placeholder"), radius: 2, ref: setSearchInputElement, spellCheck: false, value: searchInputValue }) }),
...
var PaneHeader = (0, import_react2.memo)((t0) => {
  ...
  let t11;
  $[13] !== actionHandlers || $[14] !== initialValueTemplates || $[15] !== menuItemGroups || $[16] !== menuItems ? (t11 = (0, import_jsx_runtime2.jsx)(PaneHeaderActions, { initialValueTemplateItems: initialValueTemplates, actionHandlers, menuItemGroups, menuItems }), $[13] = actionHandlers, $[14] = initialValueTemplates, $[15] = menuItemGroups, $[16] = menuItems, $[17] = t11) : t11 = $[17];
  let t12;
  $[18] !== features.backButton || $[19] !== index ? (t12 = features.backButton && index > 0 && (0, import_jsx_runtime2.jsx)(Button2, { as: BackLink, "data-as": "a", icon: ArrowLeftIcon, mode: "bleed", tooltipProps: {
    content: "Back"
  } }), $[18] = features.backButton, $[19] = index, $[20] = t12) : t12 = $[20];
  let t13;
  return $[21] !== contentAfter || $[22] !== t11 || $[23] !== t12 || $[24] !== tabIndex || $[25] !== title ? (t13 = (0, import_jsx_runtime2.jsx)(TooltipDelayGroupProvider, { children: (0, import_jsx_runtime2.jsx)(PaneHeader$1, { actions: t11, backButton: t12, contentAfter, tabIndex, title }) }), $[21] = contentAfter, $[22] = t11, $[23] = t12, $[24] = tabIndex, $[25] = title, $[26] = t13) : t13 = $[26], t13;
});
...
function DocumentSheetListProvider({
  ...
  const [selectedAnchorCellDetails, setSelectedAnchorCellDetails] = (0, import_react2.useState)(null), [selectedRangeCellIndexes, setSelectedRangeCellIndexes] = (0, import_react2.useState)([]), clearAndSetFocusSelection = (0, import_react2.useCallback)((nextAnchorDetails = null) => {
  ...
  }, [selectedAnchorCellDetails]), resetFocusSelection = (0, import_react2.useCallback)(() => clearAndSetFocusSelection(), [clearAndSetFocusSelection]), changeSelectionColumn = (0, import_react2.useCallback)((direction) => {
  ...
  }, [clearAndSetFocusSelection, selectedAnchorCellDetails, table]), changeSelectionRange = (0, import_react2.useCallback)((direction_0) => {
  ...
  }, [selectedAnchorCellDetails]), setSelectedAnchorCell = (0, import_react2.useCallback)((colId, rowIndex) => {
    clearAndSetFocusSelection({
      colId,
      rowIndex,
      state: "selected"
    });
  }, [clearAndSetFocusSelection]), handleEscapePress = (0, import_react2.useCallback)(() => {
  ...
  }, [clearAndSetFocusSelection, selectedAnchorCellDetails, selectedRangeCellIndexes.length]), handleUpDownKey = (0, import_react2.useCallback)((isShiftKey, key) => {
    if (!selectedAnchorCellDetails) return;
  ...
  }, [changeSelectionRange, selectedAnchorCellDetails, setSelectedAnchorCell]), handleAnchorKeydown = (0, import_react2.useCallback)((event) => {
    if (!selectedAnchorCellDetails) return;
    const {
      key: key_0,
      shiftKey
  ...
  }, [selectedAnchorCellDetails, handleEscapePress, handleUpDownKey, changeSelectionColumn]), handleAnchorClick = (0, import_react2.useCallback)((event_0) => {
    var _a;
    selectedAnchorCellDetails && (((_a = document.getElementById(`cell-${selectedAnchorCellDetails.colId}-${selectedAnchorCellDetails.rowIndex}`)) == null ? void 0 : _a.contains(event_0.target)) || resetFocusSelection());
  }, [resetFocusSelection, selectedAnchorCellDetails]);
  (0, import_react2.useEffect)(() => (selectedAnchorCellDetails && (document.addEventListener("keydown", handleAnchorKeydown), document.addEventListener("click", handleAnchorClick)), () => {
  ...
  const focusAnchorCell = (0, import_react2.useCallback)(() => setSelectedAnchorCellDetails((anchorCellDetails) => anchorCellDetails ? {
    ...anchorCellDetails,
    state: "focused"
  } : null), []), getStateByCellId = (0, import_react2.useCallback)((colId_0, rowIndex_0) => (selectedAnchorCellDetails == null ? void 0 : selectedAnchorCellDetails.colId) !== colId_0 ? null : selectedAnchorCellDetails.rowIndex === rowIndex_0 ? selectedAnchorCellDetails.state === "focused" ? "focused" : "selectedAnchor" : selectedRangeCellIndexes.includes(rowIndex_0) ? "selectedRange" : null, [selectedAnchorCellDetails, selectedRangeCellIndexes]), submitFocusedCell = (0, import_react2.useCallback)(() => {
  ...
  }, [clearAndSetFocusSelection, selectedAnchorCellDetails]), value = (0, import_react2.useMemo)(() => ({
    focusAnchorCell,
    resetFocusSelection,
  ...
  return (0, import_jsx_runtime2.jsx)(DocumentSheetListContext.Provider, { value, children });
}
var DataCell = dt.td`
  display: flex;
  overflow: hidden;
...
function SheetListCellInner(props) {
  const {
    ...
    var _a;
    (_a = inputRef.current) == null ? void 0 : _a.focus(), inputRef.current instanceof HTMLInputElement && inputRef.current.select();
    ...
    isDirty && (patchDocument == null ? void 0 : patchDocument(row.id, column.id, renderValue), setIsDirty(false)), resetFocusSelection();
  }, handlePaste = (0, import_react2.useCallback)((event_2) => {
    var _a;
    const clipboardData = (_a = event_2.clipboardData) == null ? void 0 : _a.getData("Text");
    (typeof clipboardData == "string" || typeof clipboardData == "number") && (setRenderValue(clipboardData), patchDocument == null ? void 0 : patchDocument(row.id, column.id, clipboardData));
  }, [column.id, patchDocument, row.id]), handleCopy = (0, import_react2.useCallback)(() => {
...
function SheetListCell(cell) {
  ...
  }, width: cell.column.getSize(), children: flexRender(cell.column.columnDef.cell, (_a = cell.getContext) == null ? void 0 : _a.call(cell)) }, cell.row.original._id + cell.id);
}
...
var PreviewCell = (props) => {
  ...
  const displayValue = (snapshot == null ? void 0 : snapshot.title) ?? "Untitled";
  ...
  return (0, import_jsx_runtime2.jsx)(MenuButton, { button: (0, import_jsx_runtime2.jsx)(Button2, { mode: "bleed", text: t2("sheet-list.edit-columns") }), id: "columns-control", menu: (0, import_jsx_runtime2.jsx)(Menu, { padding: 3, paddingTop: 4, style: {
    ...
    (0, import_jsx_runtime2.jsx)(Flex, { style: {
      ...
      return (0, import_jsx_runtime2.jsxs)(Flex, { marginY: 2, align: "center", children: [
        (0, import_jsx_runtime2.jsx)(Checkbox, { readOnly: getColumnVisibilityDisabled(column_2), checked: column_2.getIsVisible(), onChange: handleColumnOnChange(column_2), id: `col-visibility-${column_2.id}`, style: {
          display: "block"
        } }),
        (0, import_jsx_runtime2.jsx)(Box, { flex: 1, paddingLeft: 3, children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)("label", { htmlFor: `col-visibility-${column_2.id}`, children: (_a = column_2.columnDef.header) == null ? void 0 : _a.toString() }) }) })
      ] }, column_2.id);
    }) }) }),
...
function DocumentSheetListFilter() {
  ...
  let t1;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t1 = (0, import_jsx_runtime2.jsx)(SearchHeader, {}), $[0] = t1) : t1 = $[0];
  let t2;
...
function DocumentSheetListPaneInner({
  ...
  const renderRow = (0, import_react2.useCallback)((row_0) => (0, import_jsx_runtime2.jsx)(Box, { as: "tr", paddingY: 2, style: {
    display: "flex",
    width: "100%"
  }, children: row_0.getVisibleCells().map((cell) => (0, import_react2.createElement)(SheetListCell, { ...cell, key: row_0.original._id + cell.id })) }, row_0.original._id + row_0.id), []), rowsCount = `Total: ${totalRows} rows, showing ${rows.length} rows`;
...
function DocumentSheetListPane(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(SearchProvider, { children: (0, import_jsx_runtime2.jsx)(DocumentSheetListPaneInner, { ...props, documentSchemaType: schemaType }) });
}
var addSelectedStateToMenuItems = (options) => {
  ...
  return menuItems == null ? void 0 : menuItems.map((item) => {
    var _a, _b, _c, _d;
    return ((_a = item.params) == null ? void 0 : _a.layout) ? {
      ...item,
      selected: layout === ((_b = item.params) == null ? void 0 : _b.layout)
    } : ((_c = item == null ? void 0 : item.params) == null ? void 0 : _c.by) ? {
      ...item,
      selected: (0, import_isEqual.default)(sortOrderRaw == null ? void 0 : sortOrderRaw.by, ((_d = item == null ? void 0 : item.params) == null ? void 0 : _d.by) || EMPTY_ARRAY$B)
    } : {
      ...item,
      selected: false
    };
...
var PaneContainer = (0, import_react2.memo)(function(props) {
  ...
  bb0: {
    ...
    if ((staticTypes == null ? void 0 : staticTypes.length) === 1) {
      t3 = staticTypes[0];
      break bb0;
    }
    t3 = null;
  ...
  let t4, t5;
  $[3] !== defaultOrdering ? (t5 = (defaultOrdering == null ? void 0 : defaultOrdering.length) > 0 ? {
    by: defaultOrdering
  ...
  let t8;
  $[9] !== isSheetListLayout || $[10] !== layout || $[11] !== props || $[12] !== sortOrderRaw ? (t8 = isSheetListLayout ? (0, import_react2.createElement)(DocumentSheetListPane, { ...props, key: props.pane.id }) : (0, import_jsx_runtime2.jsx)(DocumentListPane, { ...props, sortOrder: sortOrderRaw, layout }), $[9] = isSheetListLayout, $[10] = layout, $[11] = props, $[12] = sortOrderRaw, $[13] = t8) : t8 = $[13];
  ...
  let t12;
  $[18] !== index || $[19] !== initialValueTemplates || $[20] !== menuItemGroups || $[21] !== menuItemsWithSelectedState || $[22] !== setLayout || $[23] !== setSortOrder || $[24] !== title ? (t12 = (0, import_jsx_runtime2.jsx)(PaneHeader, { index, initialValueTemplates, menuItemGroups, menuItems: menuItemsWithSelectedState, setLayout, setSortOrder, title }), $[18] = index, $[19] = initialValueTemplates, $[20] = menuItemGroups, $[21] = menuItemsWithSelectedState, $[22] = setLayout, $[23] = setSortOrder, $[24] = title, $[25] = t12) : t12 = $[25];
  let t13;
  $[26] !== isSelected || $[27] !== paneKey || $[28] !== paneLayout || $[29] !== t10 || $[30] !== t11 || $[31] !== t12 ? (t13 = (0, import_jsx_runtime2.jsxs)(Pane, { "data-ui": "DocumentListPane", id: paneKey, minWidth: 320, ...t10, selected: isSelected, children: [
    t11,
    t12,
    paneLayout
  ] }), $[26] = isSelected, $[27] = paneKey, $[28] = paneLayout, $[29] = t10, $[30] = t11, $[31] = t12, $[32] = t13) : t13 = $[32];
  let t14;
  return $[33] !== t13 || $[34] !== t9 ? (t14 = (0, import_jsx_runtime2.jsx)(SourceProvider, { name: t9, children: t13 }), $[33] = t13, $[34] = t9, $[35] = t14) : t14 = $[35], t14;
});
...
function getIntentState(intent, params, routerState, payload) {
  var _a;
  const panes = (routerState == null ? void 0 : routerState.panes) || [], activePanes = state.activePanes || [], editDocumentId = params.id || v4_default();
  for (let i = activePanes.length - 1; i >= 0; i--) {
    const pane2 = activePanes[i];
    if (typeof pane2 == "object" && (((_a = pane2.canHandleIntent) == null ? void 0 : _a.call(pane2, intent, params, {
      pane: pane2,
      index: i
...
function ChangesInspector(t0) {
  ...
  if (selectedReleaseId) {
    let t32;
    return $[6] === Symbol.for("react.memo_cache_sentinel") ? (t32 = (0, import_jsx_runtime2.jsx)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", children: (0, import_jsx_runtime2.jsx)(Card, { flex: 1, padding: 2, paddingTop: 0, children: (0, import_jsx_runtime2.jsx)(TimelineError, { versionError: true }) }) }), $[6] = t32) : t32 = $[6], t32;
  }
  let t3;
  $[7] !== structureT ? (t3 = structureT("changes.from.label"), $[7] = structureT, $[8] = t3) : t3 = $[8];
  let t4;
  $[9] !== t3 ? (t4 = (0, import_jsx_runtime2.jsx)(Text, { size: 1, muted: true, children: t3 }), $[9] = t3, $[10] = t4) : t4 = $[10];
  let t5;
  $[11] !== sinceTime ? (t5 = (0, import_jsx_runtime2.jsx)(TimelineMenu, { mode: "since", chunk: sinceTime, placement: "bottom-start" }), $[11] = sinceTime, $[12] = t5) : t5 = $[12];
  let t6;
  $[13] !== structureT ? (t6 = structureT("changes.to.label"), $[13] = structureT, $[14] = t6) : t6 = $[14];
  let t7;
  $[15] !== t6 ? (t7 = (0, import_jsx_runtime2.jsx)(Text, { size: 1, muted: true, children: t6 }), $[15] = t6, $[16] = t7) : t7 = $[16];
  let t8;
  $[17] !== rev ? (t8 = (0, import_jsx_runtime2.jsx)(TimelineMenu, { chunk: rev, mode: "rev", placement: "bottom-end" }), $[17] = rev, $[18] = t8) : t8 = $[18];
  let t9;
  $[19] !== t4 || $[20] !== t5 || $[21] !== t7 || $[22] !== t8 ? (t9 = (0, import_jsx_runtime2.jsx)(Box, { padding: 3, children: (0, import_jsx_runtime2.jsxs)(Grid$1, { paddingX: 2, paddingBottom: 2, children: [
    t4,
    t5,
    t7,
    t8
  ...
  let t10;
  $[24] !== diff || $[25] !== documentContext || $[26] !== loading || $[27] !== schemaType || $[28] !== showChanges || $[29] !== timelineError ? (t10 = showChanges && (0, import_jsx_runtime2.jsx)(Content$1, { diff, documentContext, error: timelineError, loading, schemaType }), $[24] = diff, $[25] = documentContext, $[26] = loading, $[27] = schemaType, $[28] = showChanges, $[29] = timelineError, $[30] = t10) : t10 = $[30];
  let t11;
  $[31] !== t10 ? (t11 = (0, import_jsx_runtime2.jsx)(Scroller$3, { "data-ui": "Scroller", ref: setScrollRef, children: (0, import_jsx_runtime2.jsx)(Box, { flex: 1, paddingX: 3, height: "fill", children: t10 }) }), $[31] = t10, $[32] = t11) : t11 = $[32];
  let t12;
  $[33] !== scrollRef || $[34] !== t11 ? (t12 = (0, import_jsx_runtime2.jsx)(Card, { flex: 1, paddingX: 2, paddingY: 2, children: (0, import_jsx_runtime2.jsx)(BoundaryElementProvider, { element: scrollRef, children: t11 }) }), $[33] = scrollRef, $[34] = t11, $[35] = t12) : t12 = $[35];
  let t13;
  return $[36] !== t12 || $[37] !== t9 ? (t13 = (0, import_jsx_runtime2.jsxs)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", overflow: "hidden", children: [
    t9,
    t12
...
function Content$1(t0) {
  ...
  if (error) {
    let t12;
    return $[0] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime2.jsx)(NoChanges, {}), $[0] = t12) : t12 = $[0], t12;
  }
  if (loading) {
    let t12;
    return $[1] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime2.jsx)(LoadingBlock, { showText: true }), $[1] = t12) : t12 = $[1], t12;
  }
  if (!diff) {
    let t12;
    return $[2] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime2.jsx)(NoChanges, {}), $[2] = t12) : t12 = $[2], t12;
  }
  let t1;
...
function PublishedEventMenu(t0) {
  ...
  let t22;
  $[6] !== event.versionRevisionId || $[7] !== params || $[8] !== setParams || $[9] !== setPerspective ? (t22 = () => {
    setParams({
      ...params,
  ...
  }, $[6] = event.versionRevisionId, $[7] = params, $[8] = setParams, $[9] = setPerspective, $[10] = t22) : t22 = $[10];
  const handleOpenDraftDocument = t22;
  let t3;
  ...
  let t5;
  $[13] !== t2 ? (t5 = t2("timeline-item.menu-button.aria-label"), $[13] = t2, $[14] = t5) : t5 = $[14];
  let t6;
  $[15] !== event.release || $[16] !== isMenuDisabled || $[17] !== t2 ? (t6 = isMenuDisabled ? t2("timeline-item.not-found-release.tooltip", {
    releaseId: ((_a = event.release) == null ? void 0 : _a._id) ? getReleaseIdFromReleaseDocumentId(event.release._id) : void 0
  }) : t2("timeline-item.menu-button.tooltip"), $[15] = event.release, $[16] = isMenuDisabled, $[17] = t2, $[18] = t6) : t6 = $[18];
  let t7;
  $[19] !== t6 ? (t7 = {
    content: t6
  }, $[19] = t6, $[20] = t7) : t7 = $[20];
  let t8;
  $[21] !== isMenuDisabled || $[22] !== t5 || $[23] !== t7 ? (t8 = (0, import_jsx_runtime2.jsx)(ContextMenuButton, { "aria-label": t5, tooltipProps: t7, disabled: isMenuDisabled }), $[21] = isMenuDisabled, $[22] = t5, $[23] = t7, $[24] = t8) : t8 = $[24];
  let t9;
  $[25] !== VersionBadge || $[26] !== event.release || $[27] !== event.versionRevisionId || $[28] !== handleOpenDraftDocument || $[29] !== handleOpenReleaseDocument || $[30] !== t2 || $[31] !== tCore ? (t9 = (0, import_jsx_runtime2.jsx)(Menu, { padding: 1, children: event.release ? (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    (0, import_jsx_runtime2.jsx)(IntentLink, { intent: RELEASES_INTENT, params: {
      ...
      releaseTitle: ((_b = event.release.metadata) == null ? void 0 : _b.title) || tCore("release.placeholder-untitled-release")
    }, t: t2 }) }) }) }) }),
    (0, import_jsx_runtime2.jsx)(MenuItem, { onClick: handleOpenReleaseDocument, children: (0, import_jsx_runtime2.jsx)(Flex, { align: "center", justify: "flex-start", children: (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: (0, import_jsx_runtime2.jsx)(Translate, { components: {
      ...
      releaseTitle: ((_c = event.release.metadata) == null ? void 0 : _c.title) || tCore("release.placeholder-untitled-release")
    }, t: t2 }) }) }) })
  ...
  }, i18nKey: "events.open.draft", t: t2 }) }) }) }) }), $[25] = VersionBadge, $[26] = event.release, $[27] = event.versionRevisionId, $[28] = handleOpenDraftDocument, $[29] = handleOpenReleaseDocument, $[30] = t2, $[31] = tCore, $[32] = t9) : t9 = $[32];
  const t10 = ((_d = portalContext.elements) == null ? void 0 : _d[TIMELINE_MENU_PORTAL$1]) ? TIMELINE_MENU_PORTAL$1 : true;
  let t11;
  ...
  let t13;
  return $[36] !== t12 || $[37] !== t4 || $[38] !== t8 || $[39] !== t9 ? (t13 = (0, import_jsx_runtime2.jsx)(MenuButton, { id: t4, button: t8, menu: t9, popover: t12 }), $[36] = t12, $[37] = t4, $[38] = t8, $[39] = t9, $[40] = t13) : t13 = $[40], t13;
}
function _temp$1(t0) {
  const {
    children: children_2
...
var EventsTimeline = ({
  ...
  const [mounted, setMounted] = (0, import_react2.useState)(false), {
    t: t2
  } = useTranslation("studio"), [expandedParents, setExpandedParents] = (0, import_react2.useState)(() => {
    if (selectedEventId) {
    ...
    return /* @__PURE__ */ new Set();
  }), [expandingParents, setExpandingParents] = (0, import_react2.useState)(/* @__PURE__ */ new Set()), events = (0, import_react2.useMemo)(() => allEvents.filter((event_0) => isCreateDocumentVersionEvent(event_0) && event_0.parentId ? allEvents[allEvents.length - 1].id === event_0.id ? true : expandedParents.has(event_0.parentId) : isEditDocumentVersionEvent(event_0) && event_0.parentId ? expandedParents.has(event_0.parentId) : true), [expandedParents, allEvents]), handleExpandParent = (0, import_react2.useCallback)((event_1) => async () => {
  ...
  }, [fetchEventChildren, setExpandingParents]), handleSelectChunk = (0, import_react2.useCallback)((event_2) => {
    onSelect(event_2);
  }, [onSelect]), renderOptionsMenu = (0, import_react2.useCallback)((event_3) => {
  ...
  }, [expandedParents, handleExpandParent]), renderItem = (0, import_react2.useCallback)((event_4, {
    activeIndex
  }) => {
...
function EventsTimelineMenu({
  ...
  const {
    ...
    setOpen(false);
  }, []), handleGlobalKeyDown = (0, import_react2.useCallback)((e2) => {
    open && (e2.key === "Escape" || e2.key === "Tab") && (handleClose(), button == null ? void 0 : button.focus());
  }, [button, handleClose, open]);
  useGlobalKeyDown(handleGlobalKeyDown), useClickOutsideEvent(open && handleClose, () => [button, popoverRef]);
  const selectRev = (0, import_react2.useCallback)((revEvent) => {
    try {
      ...
      const [since, rev] = findRangeForRevision(revEvent == null ? void 0 : revEvent.id);
  ...
  }, [t2, toast, setTimelineRange, findRangeForRevision, handleClose]), selectSince = (0, import_react2.useCallback)((sinceEvent) => {
    try {
  ...
  }, [findRangeForSince, setTimelineRange, toast, t2, handleClose]), handleLoadMore = (0, import_react2.useCallback)(() => {
    !loading && nextCursor && loadMoreEvents();
  }, [loading, loadMoreEvents, nextCursor]), content = (0, import_react2.useMemo)(() => eventsError ? (0, import_jsx_runtime2.jsx)(TimelineError, {}) : (0, import_jsx_runtime2.jsx)(EventsTimeline, { events, fetchEventChildren: expandEvent, hasMoreEvents: !!nextCursor, selectedEventId: event == null ? void 0 : event.id, onLoadMore: handleLoadMore, onSelect: mode === "rev" ? selectRev : selectSince }), [eventsError, mode, expandEvent, events, nextCursor, event == null ? void 0 : event.id, handleLoadMore, selectSince, selectRev]), revLabel = event ? t2(TIMELINE_ITEM_I18N_KEY_MAPPING[event.documentVariantType][event.type], {
    context: "timestamp",
    timestamp: new Date(event.timestamp),
    formatParams
  }) : t2("timeline.latest-revision"), sinceLabel = event ? t2(TIMELINE_ITEM_I18N_KEY_MAPPING[event.documentVariantType][event.type], {
    context: "timestamp",
    timestamp: new Date(event.timestamp),
    formatParams
  }) : events.length > 0 ? t2("timeline.since-version-missing") : t2("timeline.no-previous-events"), buttonLabel = mode === "rev" ? revLabel : sinceLabel;
  return (0, import_jsx_runtime2.jsx)(PortalProvider, { __unstable_elements: {
    [TIMELINE_MENU_PORTAL]: popoverRef
  }, children: (0, import_jsx_runtime2.jsx)(Root, { "data-testid": "timeline-menu", constrainSize: true, content: open && content, "data-ui": "versionMenu", open, placement, matchReferenceWidth: true, portal: true, ref: setPopoverRef, children: (0, import_jsx_runtime2.jsx)(Flex, { width: "fill", children: (0, import_jsx_runtime2.jsx)(Button2, { "data-testid": open ? "timeline-menu-close-button" : "timeline-menu-open-button", disabled: loading || !events.length, mode: "ghost", onClick: open ? handleClose : handleOpen, ref: setButton, selected: open, width: "fill", tooltipProps: null, justify: "space-between", style: {
    maxWidth: "100%"
  }, iconRight: ChevronDownIcon, text: loading ? t2("timeline.loading-history") : buttonLabel }) }) }) });
}
...
var CompareWithPublishedView = () => {
  ...
  let t0, t1;
  $[0] !== (editState == null ? void 0 : editState.published) ? (t1 = (editState == null ? void 0 : editState.published) ?? {}, $[0] = editState == null ? void 0 : editState.published, $[1] = t1) : t1 = $[1];
  let t22;
  if ($[2] !== displayed || $[3] !== t1) {
    let t32;
    $[5] !== displayed ? (t32 = displayed ?? {}, $[5] = displayed, $[6] = t32) : t32 = $[6], t22 = diffInput(wrap(t1, {
      author: ""
    }), wrap(t32, {
      author: ""
    })), $[2] = displayed, $[3] = t1, $[4] = t22;
  } else
    t22 = $[4];
  t0 = t22;
  const rootDiff = t0;
  if (selectedReleaseId && !(editState == null ? void 0 : editState.version) || selectedPerspective === "drafts" && !(editState == null ? void 0 : editState.draft) || selectedPerspectiveName === "published" || !(displayed == null ? void 0 : displayed._rev))
    return null;
  let t3;
  $[7] !== t2 ? (t3 = t2("events.compare-with-published.title"), $[7] = t2, $[8] = t3) : t3 = $[8];
  let t4;
  $[9] !== t3 ? (t4 = (0, import_jsx_runtime2.jsx)(Text, { size: 1, weight: "medium", children: t3 }), $[9] = t3, $[10] = t4) : t4 = $[10];
  let t5;
  $[11] !== selectedPerspective ? (t5 = isReleaseDocument(selectedPerspective) ? (_a = selectedPerspective.metadata) == null ? void 0 : _a.title : "draft", $[11] = selectedPerspective, $[12] = t5) : t5 = $[12];
  let t6;
  $[13] !== t5 ? (t6 = {
    version: t5
  }, $[13] = t5, $[14] = t6) : t6 = $[14];
  let t7;
  $[15] !== t2 || $[16] !== t6 ? (t7 = (0, import_jsx_runtime2.jsx)(Text, { size: 1, muted: true, children: (0, import_jsx_runtime2.jsx)(Translate, { i18nKey: "events.compare-with-published.description", t: t2, values: t6 }) }), $[15] = t2, $[16] = t6, $[17] = t7) : t7 = $[17];
  let t8;
  $[18] !== t4 || $[19] !== t7 ? (t8 = (0, import_jsx_runtime2.jsx)(Card, { borderBottom: true, paddingBottom: 3, children: (0, import_jsx_runtime2.jsxs)(Stack, { space: 3, paddingTop: 1, children: [
    t4,
    t7
  ...
  let t10;
  $[26] !== rootDiff || $[27] !== schemaType ? (t10 = (0, import_jsx_runtime2.jsx)(Box, { paddingY: 1, children: (0, import_jsx_runtime2.jsx)(ChangeList, { diff: rootDiff, schemaType }) }), $[26] = rootDiff, $[27] = schemaType, $[28] = t10) : t10 = $[28];
  let t11;
  $[29] !== t10 || $[30] !== t9 ? (t11 = (0, import_jsx_runtime2.jsx)(DocumentChangeContext.Provider, { value: t9, children: t10 }), $[29] = t10, $[30] = t9, $[31] = t11) : t11 = $[31];
  let t12;
  return $[32] !== t11 || $[33] !== t8 ? (t12 = (0, import_jsx_runtime2.jsxs)(Stack, { space: 2, marginBottom: 3, children: [
    t8,
    t11
...
function EventsInspector({
  ...
  const {
    ...
    sinceRevision,
    getChangesList
  } = useEvents(), isComparingCurrent = !(revision == null ? void 0 : revision.revisionId), changesList$ = (0, import_react2.useMemo)(() => getChangesList(), [getChangesList]), {
    diff,
    loading: diffLoading,
    error: diffError
  } = useObservable(changesList$, DIFF_INITIAL_VALUE), {
    t: t2
  } = useTranslation("studio"), documentContext = (0, import_react2.useMemo)(() => ({
    documentId,
    schemaType,
    FieldWrapper: (props) => props.path.length > 0 ? (0, import_jsx_runtime2.jsx)(ChangeFieldWrapper, { ...props }) : props.children,
    rootDiff: diff,
    isComparingCurrent: isComparingCurrent && !(formState == null ? void 0 : formState.readOnly),
    value,
    showFromValue: true
  }), [diff, documentId, isComparingCurrent, formState == null ? void 0 : formState.readOnly, schemaType, value]), [sinceEvent, toEvent] = (0, import_react2.useMemo)(() => events ? [events.find((e2) => e2.id === (sinceRevision == null ? void 0 : sinceRevision.revisionId)) || null, events.find((e_0) => e_0.id === (revision == null ? void 0 : revision.revisionId)) || events[0]] : [null, null], [events, revision == null ? void 0 : revision.revisionId, sinceRevision == null ? void 0 : sinceRevision.revisionId]), sinceEvents = (0, import_react2.useMemo)(() => toEvent ? events.slice(events.indexOf(toEvent) + 1).map((event) => "parentId" in toEvent && "parentId" in event && event.parentId === toEvent.parentId || "parentId" in event && toEvent.id === event.parentId ? {
    ...event,
    parentId: void 0
  } : event) : events.slice(1), [events, toEvent]);
  return events.length ? (0, import_jsx_runtime2.jsxs)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", overflow: "hidden", children: [
    (0, import_jsx_runtime2.jsxs)(Box, { padding: 3, style: {
      position: "relative"
    }, children: [
      (0, import_jsx_runtime2.jsxs)(Grid2, { paddingX: 2, paddingBottom: 2, children: [
        (0, import_jsx_runtime2.jsx)(Text, { size: 1, muted: true, children: t2("changes.inspector.from-label") }),
        (0, import_jsx_runtime2.jsx)(EventsTimelineMenu, { event: sinceEvent || null, events: sinceEvents, mode: "since", placement: "bottom-start" }),
        (0, import_jsx_runtime2.jsx)(Text, { size: 1, muted: true, children: t2("changes.inspector.to-label") }),
        (0, import_jsx_runtime2.jsx)(EventsTimelineMenu, { event: toEvent || null, events, mode: "rev", placement: "bottom-end" })
      ] }),
      diffLoading && (0, import_jsx_runtime2.jsx)(motion.div, { animate: {
        opacity: 1
      }, initial: {
        opacity: 0
      }, transition: {
    ...
    (0, import_jsx_runtime2.jsx)(Card, { flex: 1, paddingX: 2, paddingY: 2, children: (0, import_jsx_runtime2.jsx)(BoundaryElementProvider, { element: scrollRef, children: (0, import_jsx_runtime2.jsx)(Scroller$2, { "data-ui": "Scroller", ref: setScrollRef, children: (0, import_jsx_runtime2.jsx)(Box, { flex: 1, paddingX: 3, height: "fill", children: showChanges && (0, import_jsx_runtime2.jsx)(Content, { documentContext, error: timelineError || diffError, loading: (revision == null ? void 0 : revision.loading) || (sinceRevision == null ? void 0 : sinceRevision.loading) || false, schemaType, sameRevisionSelected: (sinceEvent == null ? void 0 : sinceEvent.id) === (toEvent == null ? void 0 : toEvent.id), sinceEvent }) }) }) }) })
  ] }) : (0, import_jsx_runtime2.jsx)(Box, { paddingX: 2, children: (0, import_jsx_runtime2.jsxs)(Stack, { padding: 3, space: 3, children: [
    (0, import_jsx_runtime2.jsx)(Text, { size: 1, weight: "medium", children: t2("timeline.error.no-document-history-title") }),
    (0, import_jsx_runtime2.jsx)(Text, { muted: true, size: 1, children: t2("timeline.error.no-document-history-description") })
  ] }) });
}
function Content(t0) {
  ...
  if (error) {
    let t12;
    $[0] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime2.jsx)(CompareWithPublishedView, {}), $[0] = t12) : t12 = $[0];
    let t22;
    $[1] !== error || $[2] !== (sinceEvent == null ? void 0 : sinceEvent.type) ? (t22 = (sinceEvent == null ? void 0 : sinceEvent.type) !== "historyCleared" && (0, import_jsx_runtime2.jsx)(ChangesError, { error }), $[1] = error, $[2] = sinceEvent == null ? void 0 : sinceEvent.type, $[3] = t22) : t22 = $[3];
    let t3;
  ...
  if (loading) {
    let t12;
    return $[6] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime2.jsx)(LoadingBlock, { showText: true }), $[6] = t12) : t12 = $[6], t12;
  }
  if (sameRevisionSelected) {
    let t12;
    return $[7] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime2.jsx)(SameRevisionSelected, {}), $[7] = t12) : t12 = $[7], t12;
  }
  if (!documentContext.rootDiff) {
    let t12;
    return $[8] === Symbol.for("react.memo_cache_sentinel") ? (t12 = (0, import_jsx_runtime2.jsx)(motion.div, { animate: {
      opacity: 1
    }, initial: {
      opacity: 0
    }, transition: {
...
function EventsSelector({
  ...
  var _a;
  const [scrollRef, setScrollRef] = (0, import_react2.useState)(null), [listHeight, setListHeight] = (0, import_react2.useState)(0), {
    setTimelineRange
  } = useDocumentPane(), getScrollerRef = (0, import_react2.useCallback)((el) => {
    ...
    t: t2
  } = useTranslation("studio"), toast = useToast(), selectRev = (0, import_react2.useCallback)((event) => {
    try {
  ...
  }, [t2, toast, setTimelineRange, findRangeForRevision]), initialLoad = loading && !events.length;
  return (0, import_jsx_runtime2.jsx)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", children: (0, import_jsx_runtime2.jsx)(Card, { flex: 1, padding: 2, paddingTop: 0, children: error ? (0, import_jsx_runtime2.jsx)(TimelineError, {}) : (0, import_jsx_runtime2.jsx)(BoundaryElementProvider, { element: scrollRef, children: (0, import_jsx_runtime2.jsxs)(Scroller$1, { "data-ui": "Scroller", ref: getScrollerRef, children: [
    ...
    showList && !initialLoad ? (0, import_jsx_runtime2.jsx)(
      EventsTimeline,
      {
        events,
        fetchEventChildren: expandEvent,
        hasMoreEvents: !!nextCursor,
        selectedEventId: (revision == null ? void 0 : revision.revisionId) || ((_a = events[0]) == null ? void 0 : _a.id),
...
function HistorySelector({
  ...
  const {
    ...
    selectedReleaseId
  } = usePerspective(), [scrollRef, setScrollRef] = (0, import_react2.useState)(null), [listHeight, setListHeight] = (0, import_react2.useState)(0), getScrollerRef = (0, import_react2.useCallback)((el) => {
    (el == null ? void 0 : el.clientHeight) && (setListHeight(el.clientHeight - 1), setScrollRef(el));
    ...
    t: t2
  } = useTranslation("studio"), toast = useToast(), selectRev = (0, import_react2.useCallback)((revChunk) => {
    try {
      const [sinceId, revId] = (timelineStore == null ? void 0 : timelineStore.findRangeForRev(revChunk)) || [null, null];
      setTimelineRange(sinceId, revId);
    } catch (err) {
  ...
  return (0, import_jsx_runtime2.jsx)(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", children: (0, import_jsx_runtime2.jsx)(Card, { flex: 1, padding: 2, paddingTop: 0, children: timelineError || selectedReleaseId ? (0, import_jsx_runtime2.jsx)(TimelineError, { versionError: !!selectedReleaseId }) : (0, import_jsx_runtime2.jsx)(BoundaryElementProvider, { element: scrollRef, children: (0, import_jsx_runtime2.jsx)(Scroller, { "data-ui": "Scroller", ref: getScrollerRef, children: listHeight && // This forces the list to unmount and remount, which is needed to reset the scroll position
  showList ? (0, import_jsx_runtime2.jsx)(Timeline, { chunks, hasMoreChunks, lastChunk: realRevChunk, onLoadMore: handleLoadMore, onSelect: selectRev, listMaxHeight: `${listHeight}px` }) : null }) }) }) });
}
...
function ChangesTabs(props) {
  ...
  const $ = (0, import_react_compiler_runtime.c)(72), {
    params,
    setParams
  } = usePaneRouter(), source = useSource(), [parentRef, setParentRef] = (0, import_react2.useState)(null), {
    t: t2
  } = useTranslation(structureLocaleNamespace), isReady = (params == null ? void 0 : params.inspect) === HISTORY_INSPECTOR_NAME, {
    selectedPerspective
  } = usePerspective();
  let t0;
  $[0] !== params ? (t0 = isValidTab(params == null ? void 0 : params.changesInspectorTab) ? params.changesInspectorTab : TABS[0], $[0] = params, $[1] = t0) : t0 = $[1];
  const paneRouterTab = t0;
  let t1;
  $[2] !== params || $[3] !== setParams ? (t1 = (tab) => setParams({
    ...params,
    changesInspectorTab: tab,
    since: tab === "history" ? void 0 : params == null ? void 0 : params.since
  ...
  let t20;
  $[42] === Symbol.for("react.memo_cache_sentinel") ? (t20 = (0, import_jsx_runtime2.jsx)(Text, { size: 0, muted: true, children: (0, import_jsx_runtime2.jsx)(InfoOutlineIcon, { fontSize: 1 }) }), $[42] = t20) : t20 = $[42];
  let t21;
  ...
  let t26;
  $[54] !== paneRouterTab || $[55] !== ((_b = (_a = source.beta) == null ? void 0 : _a.eventsAPI) == null ? void 0 : _b.documents) ? (t26 = ((_d = (_c = source.beta) == null ? void 0 : _c.eventsAPI) == null ? void 0 : _d.documents) ? (0, import_jsx_runtime2.jsx)(EventsSelector, { showList: paneRouterTab === "history" }) : (0, import_jsx_runtime2.jsx)(HistorySelector, { showList: paneRouterTab === "history" }), $[54] = paneRouterTab, $[55] = (_f = (_e = source.beta) == null ? void 0 : _e.eventsAPI) == null ? void 0 : _f.documents, $[56] = t26) : t26 = $[56];
  let t27;
  ...
  let t29;
  $[60] !== paneRouterTab || $[61] !== ((_h = (_g = source.beta) == null ? void 0 : _g.eventsAPI) == null ? void 0 : _h.documents) ? (t29 = ((_j = (_i = source.beta) == null ? void 0 : _i.eventsAPI) == null ? void 0 : _j.documents) ? (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: paneRouterTab === "review" ? (0, import_jsx_runtime2.jsx)(EventsInspector, { showChanges: paneRouterTab === "review" }) : null }) : (0, import_jsx_runtime2.jsx)(ChangesInspector, { showChanges: paneRouterTab === "review" }), $[60] = paneRouterTab, $[61] = (_l = (_k = source.beta) == null ? void 0 : _k.eventsAPI) == null ? void 0 : _l.documents, $[62] = t29) : t29 = $[62];
  let t30;
...
function getPathTitles(options) {
  ...
  for (const segment of path) {
    ...
    if (typeof segment == "number") {
      ...
      v = v == null ? void 0 : v[segment];
      const itemType = s2.of.find((ofType) => typeof v == "string" ? ofType.jsonType === "string" : typeof v == "number" ? ofType.jsonType === "number" : typeof v == "boolean" ? ofType.jsonType === "boolean" : isRecord$4(v) ? ofType.name === (v == null ? void 0 : v._type) : false);
      if (!itemType)
    ...
    if (isRecord$4(segment) && segment._key) {
      ...
      if (s2.jsonType !== "array")
        throw new Error(`Parent type is not an array schema type, cannot get path segment: .${segment}`);
      if (v = (v ?? []).find((i) => isRecord$4(i) && i._key === segment._key), !isRecord$4(v))
        throw new Error(`Array item not found: [_key == ${segment._key}]`);
      const ofType = s2.of.find((i) => isRecord$4(v) && i.name === (v == null ? void 0 : v._type));
      if (!ofType)
...
function DocumentNodePathBreadcrumbs(props) {
  const {
    ...
    schemaType,
    value
  } = props, pathTitles = (0, import_react2.useMemo)(() => {
    try {
  ...
  return (pathTitles == null ? void 0 : pathTitles.length) ? (0, import_jsx_runtime2.jsx)(Text, { size: 1, children: pathTitles.map((t2, i) => (0, import_jsx_runtime2.jsxs)(import_react2.Fragment, { children: [
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index3-KIK4GCJV.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-XGNYEMSI.js.map
